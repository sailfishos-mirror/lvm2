 ...
 * Falls back to synchronous single-slot mode when max_inflight == 1.
 *
...
/*
 * Set caller-owned async context for async deactivation.
 ...
 * removes are deferred to that context for async execution.
 */
