 ...
 * dm_async_submit() -> dm_task_prepare(), and dm_task_handle_completion()
 ...
 * passed to dm_async_submit().
 * Pass results to dm_task_handle_completion() which takes ownership of dmt.
