...
#define print_log(level, file, line, dm_errno, format, args...) print_log(format, args)
#define dm_log(level, file, line, format, args...) dm_log(format, args)
#define dm_log_with_errno(level, file, line, dm_errno, format, args...) \
    dm_log_with_errno(format, args)
