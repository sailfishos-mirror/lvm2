...
class TestDbusService(unittest.TestCase):
	def setUp(self):
		self.pvs = []
		# Max acceptable changes in consistency check - default 0 (strict)
		# Tests with async monitoring properties (cache, thin, vdo) can increase this
		self._max_acceptable_changes = 0
