...
eval "$(lvs -S 'name=~_pmspare' -a --config 'report/mark_hidden_devices=0' -o name --noheadings --nameprefixes $vg)"
...
test "0" = "$(lvs -S 'name=~_pmspare' -a -o name --noheadings --nameprefixes $vg | wc -l)"
