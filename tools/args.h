...
arg(fs_ARG, '\0', "fs", string_VAL, 0, 0,
    ...
    "\\fBchecksize\\fP: Only applies to reducing size; does nothing for extend.\n"
    ...
    "\\fBresize\\fP: Resize the fs using the fs-specific resize command.\n"
    "This may include mounting, unmounting, or running fsck. See --fsmode to\n"
...
arg(fsmode_ARG, '\0', "fsmode", string_VAL, 0, 0,
    "Specify the fs mounting behavior for fs resize.\n"
...
arg(nofsck_ARG, 'n', "nofsck", 0, 0, 0,
    "Do not perform fsck as a part of resizing the file system with --resizefs.\n")
