...
" [ --commandprofile String, --config String, --debug, --driverloaded Bool, --help, --profile String, --quiet, --verbose, --version, --yes, --atversion String, --configtype String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions ]"
" [ String ... ]";
...
" [ String|PV ... ]";
commands[105].required_opt_args[0].opt = cache_ARG;
