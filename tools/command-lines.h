...
commands[22].desc = "DESC: Convert LV to type raid.  DESC: Change LV raid type.";
...
commands[26].usage = "lvconvert --mirrors ll0 LV_mirror_raid"
...
commands[46].optional_opt_args[11].opt = chunksize_ARG;
commands[46].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[46].optional_opt_args[12].opt = addtag_ARG;
commands[46].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[46].optional_opt_args[13].opt = alloc_ARG;
commands[46].optional_opt_args[13].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[46].optional_opt_args[14].opt = autobackup_ARG;
commands[46].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[15].opt = activate_ARG;
commands[46].optional_opt_args[15].def.val_bits = val_enum_to_bit(activation_VAL);
commands[46].optional_opt_args[16].opt = contiguous_ARG;
commands[46].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[17].opt = ignoreactivationskip_ARG;
commands[46].optional_opt_args[18].opt = ignoremonitoring_ARG;
commands[46].optional_opt_args[19].opt = major_ARG;
commands[46].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[46].optional_opt_args[20].opt = metadataprofile_ARG;
commands[46].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
commands[46].optional_opt_args[21].opt = minor_ARG;
commands[46].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[46].optional_opt_args[22].opt = monitor_ARG;
commands[46].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[23].opt = name_ARG;
commands[46].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[46].optional_opt_args[24].opt = nosync_ARG;
commands[46].optional_opt_args[25].opt = noudevsync_ARG;
commands[46].optional_opt_args[26].opt = permission_ARG;
commands[46].optional_opt_args[26].def.val_bits = val_enum_to_bit(permission_VAL);
commands[46].optional_opt_args[27].opt = persistent_ARG;
commands[46].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[28].opt = readahead_ARG;
commands[46].optional_opt_args[28].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[46].optional_opt_args[29].opt = reportformat_ARG;
commands[46].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[46].optional_opt_args[30].opt = setactivationskip_ARG;
commands[46].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[31].opt = test_ARG;
commands[46].optional_opt_args[32].opt = wipesignatures_ARG;
commands[46].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[46].optional_opt_args[33].opt = zero_ARG;
commands[46].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[48].desc = "DESC: Create a striped COW snapshot LV from an origin LV.";
commands[48].usage = "lvcreate --type snapshot --stripes Number --size Number[m|unit] LV"
...
commands[49].command_line_id = "lvcreate_striped_cow_snapshot";
commands[49].command_line_enum = lvcreate_striped_cow_snapshot_CMD;
commands[49].fn = lvcreate;
commands[49].ro_count = 3;
commands[49].rp_count = 1;
commands[49].oo_count = 36;
commands[49].op_count = 1;
commands[49].desc = "DESC: Create a striped COW snapshot LV from an origin LV  DESC: (infers --type snapshot).";
commands[49].usage = "lvcreate --snapshot --stripes Number --size Number[m|unit] LV"
" [ --type snapshot, --stripes Number, --stripesize Number[k|unit], --chunksize Number[k|unit], --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[49].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[49].required_opt_args[0].opt = snapshot_ARG;
commands[49].required_opt_args[1].opt = stripes_ARG;
commands[49].required_opt_args[1].def.val_bits = val_enum_to_bit(number_VAL);
commands[49].required_opt_args[2].opt = size_ARG;
commands[49].required_opt_args[2].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[49].required_pos_args[0].pos = 1;
commands[49].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[49].optional_opt_args[11].opt = stripes_ARG;
commands[49].optional_opt_args[11].def.val_bits = val_enum_to_bit(number_VAL);
commands[49].optional_opt_args[12].opt = stripesize_ARG;
commands[49].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[49].optional_opt_args[13].opt = chunksize_ARG;
commands[49].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[49].optional_opt_args[14].opt = addtag_ARG;
commands[49].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[49].optional_opt_args[15].opt = alloc_ARG;
commands[49].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[49].optional_opt_args[16].opt = autobackup_ARG;
commands[49].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[17].opt = activate_ARG;
commands[49].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[49].optional_opt_args[18].opt = contiguous_ARG;
commands[49].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[49].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[49].optional_opt_args[21].opt = major_ARG;
commands[49].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[49].optional_opt_args[22].opt = metadataprofile_ARG;
commands[49].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[49].optional_opt_args[23].opt = minor_ARG;
commands[49].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[49].optional_opt_args[24].opt = monitor_ARG;
commands[49].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[25].opt = name_ARG;
commands[49].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[49].optional_opt_args[26].opt = nosync_ARG;
commands[49].optional_opt_args[27].opt = noudevsync_ARG;
commands[49].optional_opt_args[28].opt = permission_ARG;
commands[49].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[49].optional_opt_args[29].opt = persistent_ARG;
commands[49].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[30].opt = readahead_ARG;
commands[49].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[49].optional_opt_args[31].opt = reportformat_ARG;
commands[49].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[49].optional_opt_args[32].opt = setactivationskip_ARG;
commands[49].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[33].opt = test_ARG;
commands[49].optional_opt_args[34].opt = wipesignatures_ARG;
commands[49].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[49].optional_opt_args[35].opt = zero_ARG;
...
commands[50].desc = "DESC: Create a sparse COW snapshot LV of a virtual origin LV.";
commands[50].usage = "lvcreate --type snapshot --size Number[m|unit] --virtualsize Number[m|unit] VG"
" [ --snapshot, --chunksize Number[k|unit], --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[50].required_opt_args[0].def.str = "snapshot";
...
commands[50].optional_opt_args[10].opt = snapshot_ARG;
...
commands[51].command_line_id = "lvcreate_cow_snapshot_with_virtual_origin";
commands[51].command_line_enum = lvcreate_cow_snapshot_with_virtual_origin_CMD;
commands[51].fn = lvcreate;
commands[51].ro_count = 3;
commands[51].rp_count = 1;
commands[51].oo_count = 34;
commands[51].op_count = 1;
commands[51].desc = "DESC: Create a sparse COW snapshot LV of a virtual origin LV  DESC: (infers --type snapshot).";
commands[51].usage = "lvcreate --snapshot --size Number[m|unit] --virtualsize Number[m|unit] VG"
" [ --type snapshot, --chunksize Number[k|unit], --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[51].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[51].required_opt_args[0].opt = snapshot_ARG;
commands[51].required_opt_args[1].opt = size_ARG;
commands[51].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[51].required_opt_args[2].opt = virtualsize_ARG;
commands[51].required_opt_args[2].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[51].optional_opt_args[10].def.str = "snapshot";
commands[51].optional_opt_args[11].opt = chunksize_ARG;
commands[51].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[51].optional_opt_args[12].opt = addtag_ARG;
commands[51].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[51].optional_opt_args[13].opt = alloc_ARG;
commands[51].optional_opt_args[13].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[51].optional_opt_args[14].opt = autobackup_ARG;
commands[51].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[15].opt = activate_ARG;
commands[51].optional_opt_args[15].def.val_bits = val_enum_to_bit(activation_VAL);
commands[51].optional_opt_args[16].opt = contiguous_ARG;
commands[51].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[17].opt = ignoreactivationskip_ARG;
commands[51].optional_opt_args[18].opt = ignoremonitoring_ARG;
commands[51].optional_opt_args[19].opt = major_ARG;
commands[51].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[51].optional_opt_args[20].opt = metadataprofile_ARG;
commands[51].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[21].opt = minor_ARG;
commands[51].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[51].optional_opt_args[22].opt = monitor_ARG;
commands[51].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[23].opt = name_ARG;
commands[51].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[24].opt = nosync_ARG;
commands[51].optional_opt_args[25].opt = noudevsync_ARG;
commands[51].optional_opt_args[26].opt = permission_ARG;
commands[51].optional_opt_args[26].def.val_bits = val_enum_to_bit(permission_VAL);
commands[51].optional_opt_args[27].opt = persistent_ARG;
commands[51].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[28].opt = readahead_ARG;
commands[51].optional_opt_args[28].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[51].optional_opt_args[29].opt = reportformat_ARG;
commands[51].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[30].opt = setactivationskip_ARG;
commands[51].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[31].opt = test_ARG;
commands[51].optional_opt_args[32].opt = wipesignatures_ARG;
commands[51].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[33].opt = zero_ARG;
...
commands[52].desc = "DESC: Create a thin pool.";
commands[52].usage = "lvcreate --type thin-pool --size Number[m|unit] VG"
...
commands[52].required_opt_args[0].def.str = "thin-pool";
...
commands[52].optional_opt_args[10].opt = thinpool_ARG;
commands[52].optional_opt_args[10].def.val_bits = val_enum_to_bit(lv_VAL);
commands[52].optional_opt_args[10].def.flags = ARG_DEF_FLAG_NEW;
...
commands[53].oo_count = 41;
commands[53].op_count = 1;
commands[53].desc = "DESC: Create a thin pool (variant, infers --type thin-pool).";
commands[53].usage = "lvcreate --thin --size Number[m|unit] VG"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[53].required_opt_args[0].opt = thin_ARG;
...
commands[53].optional_opt_args[10].opt = type_ARG;
commands[53].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[53].optional_opt_args[10].def.str = "thin-pool";
commands[53].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[53].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[53].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[53].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[13].opt = chunksize_ARG;
commands[53].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[53].optional_opt_args[14].opt = discards_ARG;
commands[53].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[53].optional_opt_args[15].opt = errorwhenfull_ARG;
commands[53].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[16].opt = mirrors_ARG;
commands[53].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[53].optional_opt_args[16].def.num = 0;
...
commands[53].optional_opt_args[39].opt = stripes_ARG;
commands[53].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[53].optional_opt_args[40].opt = stripesize_ARG;
commands[53].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[54].oo_count = 42;
commands[54].op_count = 1;
commands[54].desc = "DESC: Create a thin pool named by the --thinpool arg  DESC: (variant, infers --type thin-pool).";
commands[54].usage = "lvcreate --size Number[m|unit] --thinpool LV_new VG"
" [ --thin, --type thin-pool, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors ll0, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n, --stripes Number, --stripesize Number[k|unit] ]"
" [ PV ... ]";
...
commands[54].optional_opt_args[17].opt = mirrors_ARG;
commands[54].optional_opt_args[17].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[54].optional_opt_args[17].def.num = 0;
commands[54].optional_opt_args[18].opt = addtag_ARG;
commands[54].optional_opt_args[18].def.val_bits = val_enum_to_bit(tag_VAL);
commands[54].optional_opt_args[19].opt = alloc_ARG;
commands[54].optional_opt_args[19].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[54].optional_opt_args[20].opt = autobackup_ARG;
commands[54].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[21].opt = activate_ARG;
commands[54].optional_opt_args[21].def.val_bits = val_enum_to_bit(activation_VAL);
commands[54].optional_opt_args[22].opt = contiguous_ARG;
commands[54].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[23].opt = ignoreactivationskip_ARG;
commands[54].optional_opt_args[24].opt = ignoremonitoring_ARG;
commands[54].optional_opt_args[25].opt = major_ARG;
commands[54].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[54].optional_opt_args[26].opt = metadataprofile_ARG;
commands[54].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[27].opt = minor_ARG;
commands[54].optional_opt_args[27].def.val_bits = val_enum_to_bit(number_VAL);
commands[54].optional_opt_args[28].opt = monitor_ARG;
commands[54].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[29].opt = name_ARG;
commands[54].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[30].opt = nosync_ARG;
commands[54].optional_opt_args[31].opt = noudevsync_ARG;
commands[54].optional_opt_args[32].opt = permission_ARG;
commands[54].optional_opt_args[32].def.val_bits = val_enum_to_bit(permission_VAL);
commands[54].optional_opt_args[33].opt = persistent_ARG;
commands[54].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[34].opt = readahead_ARG;
commands[54].optional_opt_args[34].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[54].optional_opt_args[35].opt = reportformat_ARG;
commands[54].optional_opt_args[35].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[36].opt = setactivationskip_ARG;
commands[54].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[37].opt = test_ARG;
commands[54].optional_opt_args[38].opt = wipesignatures_ARG;
commands[54].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[39].opt = zero_ARG;
commands[54].optional_opt_args[39].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[40].opt = stripes_ARG;
commands[54].optional_opt_args[40].def.val_bits = val_enum_to_bit(number_VAL);
commands[54].optional_opt_args[41].opt = stripesize_ARG;
commands[54].optional_opt_args[41].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[56].ro_count = 2;
commands[56].rp_count = 1;
commands[56].oo_count = 39;
commands[56].op_count = 1;
commands[56].desc = "DESC: Create a cache pool (variant, infers --type cache-pool).";
commands[56].usage = "lvcreate --cache --size Number[m|unit] VG"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[56].required_opt_args[0].opt = cache_ARG;
...
commands[56].optional_opt_args[10].def.str = "cache-pool";
...
commands[56].optional_opt_args[14].opt = cachemode_ARG;
commands[56].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[56].optional_opt_args[15].opt = cachepolicy_ARG;
commands[56].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[56].optional_opt_args[16].opt = cachesettings_ARG;
commands[56].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[57].oo_count = 38;
commands[57].op_count = 1;
commands[57].desc = "DESC: Create a cache pool named by the --cachepool arg  DESC: (variant, uses --cachepool in place of --name).";
commands[57].usage = "lvcreate --type cache-pool --size Number[m|unit] --cachepool LV_new VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[57].optional_opt_args[13].opt = cachemode_ARG;
commands[57].optional_opt_args[13].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[57].optional_opt_args[14].opt = cachepolicy_ARG;
commands[57].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[15].opt = cachesettings_ARG;
commands[57].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[16].opt = addtag_ARG;
commands[57].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[57].optional_opt_args[17].opt = alloc_ARG;
commands[57].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[57].optional_opt_args[18].opt = autobackup_ARG;
commands[57].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[19].opt = activate_ARG;
commands[57].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[57].optional_opt_args[20].opt = contiguous_ARG;
commands[57].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[57].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[57].optional_opt_args[23].opt = major_ARG;
commands[57].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[57].optional_opt_args[24].opt = metadataprofile_ARG;
commands[57].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[25].opt = minor_ARG;
commands[57].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[57].optional_opt_args[26].opt = monitor_ARG;
commands[57].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[27].opt = name_ARG;
commands[57].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[28].opt = nosync_ARG;
commands[57].optional_opt_args[29].opt = noudevsync_ARG;
commands[57].optional_opt_args[30].opt = permission_ARG;
commands[57].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[57].optional_opt_args[31].opt = persistent_ARG;
commands[57].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[32].opt = readahead_ARG;
commands[57].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[57].optional_opt_args[33].opt = reportformat_ARG;
commands[57].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[34].opt = setactivationskip_ARG;
commands[57].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[35].opt = test_ARG;
commands[57].optional_opt_args[36].opt = wipesignatures_ARG;
commands[57].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[37].opt = zero_ARG;
...
commands[58].oo_count = 39;
commands[58].op_count = 1;
commands[58].desc = "DESC: Create a thin LV in a thin pool.";
commands[58].usage = "lvcreate --type thin --virtualsize Number[m|unit] --thinpool LV_thinpool"
...
commands[58].required_opt_args[2].opt = thinpool_ARG;
commands[58].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[58].required_opt_args[2].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[58].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[58].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[58].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[58].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[13].opt = chunksize_ARG;
commands[58].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[58].optional_opt_args[14].opt = discards_ARG;
commands[58].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[58].optional_opt_args[15].opt = errorwhenfull_ARG;
commands[58].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[16].opt = mirrors_ARG;
commands[58].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[58].optional_opt_args[16].def.num = 0;
commands[58].optional_opt_args[17].opt = addtag_ARG;
commands[58].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[58].optional_opt_args[18].opt = alloc_ARG;
commands[58].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[58].optional_opt_args[19].opt = autobackup_ARG;
commands[58].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[20].opt = activate_ARG;
commands[58].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[58].optional_opt_args[21].opt = contiguous_ARG;
commands[58].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[58].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[58].optional_opt_args[24].opt = major_ARG;
commands[58].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[58].optional_opt_args[25].opt = metadataprofile_ARG;
commands[58].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[26].opt = minor_ARG;
commands[58].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[58].optional_opt_args[27].opt = monitor_ARG;
commands[58].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[28].opt = name_ARG;
commands[58].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[29].opt = nosync_ARG;
commands[58].optional_opt_args[30].opt = noudevsync_ARG;
commands[58].optional_opt_args[31].opt = permission_ARG;
commands[58].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[58].optional_opt_args[32].opt = persistent_ARG;
commands[58].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[33].opt = readahead_ARG;
commands[58].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[58].optional_opt_args[34].opt = reportformat_ARG;
commands[58].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[35].opt = setactivationskip_ARG;
commands[58].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[36].opt = test_ARG;
commands[58].optional_opt_args[37].opt = wipesignatures_ARG;
commands[58].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[38].opt = zero_ARG;
commands[58].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[59].oo_count = 36;
commands[59].op_count = 0;
commands[59].desc = "DESC: Create a thin LV in a thin pool named in arg pos 1  DESC: (variant, also see --thinpool).";
commands[59].usage = "lvcreate --type thin --virtualsize Number[m|unit] LV_thinpool"
...
commands[59].optional_opt_args[11].opt = discards_ARG;
commands[59].optional_opt_args[11].def.val_bits = val_enum_to_bit(discards_VAL);
commands[59].optional_opt_args[12].opt = errorwhenfull_ARG;
commands[59].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[13].opt = mirrors_ARG;
commands[59].optional_opt_args[13].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[59].optional_opt_args[13].def.num = 0;
commands[59].optional_opt_args[14].opt = addtag_ARG;
commands[59].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[59].optional_opt_args[15].opt = alloc_ARG;
commands[59].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[59].optional_opt_args[16].opt = autobackup_ARG;
commands[59].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[17].opt = activate_ARG;
commands[59].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[59].optional_opt_args[18].opt = contiguous_ARG;
commands[59].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[59].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[59].optional_opt_args[21].opt = major_ARG;
commands[59].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[59].optional_opt_args[22].opt = metadataprofile_ARG;
commands[59].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[59].optional_opt_args[23].opt = minor_ARG;
commands[59].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[59].optional_opt_args[24].opt = monitor_ARG;
commands[59].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[25].opt = name_ARG;
commands[59].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[59].optional_opt_args[26].opt = nosync_ARG;
commands[59].optional_opt_args[27].opt = noudevsync_ARG;
commands[59].optional_opt_args[28].opt = permission_ARG;
commands[59].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[59].optional_opt_args[29].opt = persistent_ARG;
commands[59].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[30].opt = readahead_ARG;
commands[59].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[59].optional_opt_args[31].opt = reportformat_ARG;
commands[59].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[59].optional_opt_args[32].opt = setactivationskip_ARG;
commands[59].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[33].opt = test_ARG;
commands[59].optional_opt_args[34].opt = wipesignatures_ARG;
commands[59].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[35].opt = zero_ARG;
...
commands[60].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[61].desc = "DESC: Create a thin LV in the thin pool named in arg pos 1  DESC: (variant, infers --type thin, also see --thinpool).";
...
commands[61].optional_opt_args[14].opt = mirrors_ARG;
commands[61].optional_opt_args[14].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[61].optional_opt_args[14].def.num = 0;
...
commands[66].optional_opt_args[13].opt = mirrors_ARG;
commands[66].optional_opt_args[13].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[66].optional_opt_args[13].def.num = 0;
commands[66].optional_opt_args[14].opt = addtag_ARG;
commands[66].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[66].optional_opt_args[15].opt = alloc_ARG;
commands[66].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[66].optional_opt_args[16].opt = autobackup_ARG;
commands[66].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[17].opt = activate_ARG;
commands[66].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[66].optional_opt_args[18].opt = contiguous_ARG;
commands[66].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[66].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[66].optional_opt_args[21].opt = major_ARG;
commands[66].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[66].optional_opt_args[22].opt = metadataprofile_ARG;
commands[66].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[23].opt = minor_ARG;
commands[66].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[66].optional_opt_args[24].opt = monitor_ARG;
commands[66].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[25].opt = name_ARG;
commands[66].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[26].opt = nosync_ARG;
commands[66].optional_opt_args[27].opt = noudevsync_ARG;
commands[66].optional_opt_args[28].opt = permission_ARG;
commands[66].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[66].optional_opt_args[29].opt = persistent_ARG;
commands[66].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[30].opt = readahead_ARG;
commands[66].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[66].optional_opt_args[31].opt = reportformat_ARG;
commands[66].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[32].opt = setactivationskip_ARG;
commands[66].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[33].opt = test_ARG;
commands[66].optional_opt_args[34].opt = wipesignatures_ARG;
commands[66].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[35].opt = zero_ARG;
...
commands[70].optional_opt_args[16].opt = mirrors_ARG;
commands[70].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[70].optional_opt_args[16].def.num = 0;
commands[70].optional_opt_args[17].opt = addtag_ARG;
commands[70].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[70].optional_opt_args[18].opt = alloc_ARG;
commands[70].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[70].optional_opt_args[19].opt = autobackup_ARG;
commands[70].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[20].opt = activate_ARG;
commands[70].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[70].optional_opt_args[21].opt = contiguous_ARG;
commands[70].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[70].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[70].optional_opt_args[24].opt = major_ARG;
commands[70].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[25].opt = metadataprofile_ARG;
commands[70].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[26].opt = minor_ARG;
commands[70].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[27].opt = monitor_ARG;
commands[70].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[28].opt = name_ARG;
commands[70].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[29].opt = nosync_ARG;
commands[70].optional_opt_args[30].opt = noudevsync_ARG;
commands[70].optional_opt_args[31].opt = permission_ARG;
commands[70].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[70].optional_opt_args[32].opt = persistent_ARG;
commands[70].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[33].opt = readahead_ARG;
commands[70].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[70].optional_opt_args[34].opt = reportformat_ARG;
commands[70].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[35].opt = setactivationskip_ARG;
commands[70].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[36].opt = test_ARG;
commands[70].optional_opt_args[37].opt = wipesignatures_ARG;
commands[70].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[38].opt = zero_ARG;
commands[70].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[39].opt = stripes_ARG;
commands[70].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[40].opt = stripesize_ARG;
commands[70].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[71].optional_opt_args[15].opt = mirrors_ARG;
commands[71].optional_opt_args[15].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[71].optional_opt_args[15].def.num = 0;
...
commands[71].optional_opt_args[38].opt = stripes_ARG;
commands[71].optional_opt_args[38].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[39].opt = stripesize_ARG;
commands[71].optional_opt_args[39].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[72].optional_opt_args[19].opt = mirrors_ARG;
commands[72].optional_opt_args[19].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[72].optional_opt_args[19].def.num = 0;
...
commands[72].optional_opt_args[42].opt = stripes_ARG;
commands[72].optional_opt_args[42].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[43].opt = stripesize_ARG;
commands[72].optional_opt_args[43].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[73].ro_count = 3;
commands[73].rp_count = 1;
commands[73].oo_count = 41;
commands[73].op_count = 1;
commands[73].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: by the --cachepool arg.";
commands[73].usage = "lvcreate --type cache --size Number[m|unit] --cachepool LV_cachepool VG"
...
commands[73].required_opt_args[2].opt = cachepool_ARG;
commands[73].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[73].required_opt_args[2].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[74].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: by the --cachepool arg (variant, infers --type cache).";
commands[74].usage = "lvcreate --size Number[m|unit] --cachepool LV_cachepool VG"
...
commands[74].required_opt_args[1].opt = cachepool_ARG;
commands[74].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[74].required_opt_args[1].def.lv_types = ARG_DEF_LV_CACHEPOOL;
commands[74].required_pos_args[0].pos = 1;
commands[74].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[74].optional_opt_args[10].opt = type_ARG;
commands[74].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[74].optional_opt_args[10].def.str = "cache";
commands[74].optional_opt_args[11].opt = cache_ARG;
commands[74].optional_opt_args[12].opt = cachemode_ARG;
commands[74].optional_opt_args[12].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[74].optional_opt_args[13].opt = cachepolicy_ARG;
commands[74].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[14].opt = cachesettings_ARG;
commands[74].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[15].opt = addtag_ARG;
commands[74].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[74].optional_opt_args[16].opt = alloc_ARG;
commands[74].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[74].optional_opt_args[17].opt = autobackup_ARG;
commands[74].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[18].opt = activate_ARG;
commands[74].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[74].optional_opt_args[19].opt = contiguous_ARG;
commands[74].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[74].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[74].optional_opt_args[22].opt = major_ARG;
commands[74].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[23].opt = metadataprofile_ARG;
commands[74].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[24].opt = minor_ARG;
commands[74].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[25].opt = monitor_ARG;
commands[74].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[26].opt = name_ARG;
commands[74].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[27].opt = nosync_ARG;
commands[74].optional_opt_args[28].opt = noudevsync_ARG;
commands[74].optional_opt_args[29].opt = permission_ARG;
commands[74].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[74].optional_opt_args[30].opt = persistent_ARG;
commands[74].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[31].opt = readahead_ARG;
commands[74].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[74].optional_opt_args[32].opt = reportformat_ARG;
commands[74].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[33].opt = setactivationskip_ARG;
commands[74].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[34].opt = test_ARG;
commands[74].optional_opt_args[35].opt = wipesignatures_ARG;
commands[74].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[36].opt = zero_ARG;
commands[74].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[37].opt = stripes_ARG;
commands[74].optional_opt_args[37].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[38].opt = stripesize_ARG;
commands[74].optional_opt_args[38].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[75].oo_count = 41;
commands[75].op_count = 1;
commands[75].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: by in arg pos 1 (variant, also use --cachepool).";
commands[75].usage = "lvcreate --type cache --size Number[m|unit] LV_cachepool"
" [ --cache, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n, --stripes Number, --stripesize Number[k|unit] ]"
" [ PV ... ]";
commands[75].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[75].required_opt_args[0].opt = type_ARG;
commands[75].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[75].required_opt_args[0].def.str = "cache";
...
commands[75].required_pos_args[0].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[75].optional_opt_args[10].opt = cache_ARG;
commands[75].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[75].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[75].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[75].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[13].opt = chunksize_ARG;
commands[75].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[75].optional_opt_args[14].opt = cachemode_ARG;
commands[75].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[75].optional_opt_args[15].opt = cachepolicy_ARG;
commands[75].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[16].opt = cachesettings_ARG;
commands[75].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[17].opt = addtag_ARG;
commands[75].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[75].optional_opt_args[18].opt = alloc_ARG;
commands[75].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[75].optional_opt_args[19].opt = autobackup_ARG;
commands[75].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[20].opt = activate_ARG;
commands[75].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[75].optional_opt_args[21].opt = contiguous_ARG;
commands[75].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[75].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[75].optional_opt_args[24].opt = major_ARG;
commands[75].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[75].optional_opt_args[25].opt = metadataprofile_ARG;
commands[75].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[26].opt = minor_ARG;
commands[75].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[75].optional_opt_args[27].opt = monitor_ARG;
commands[75].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[28].opt = name_ARG;
commands[75].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[29].opt = nosync_ARG;
commands[75].optional_opt_args[30].opt = noudevsync_ARG;
commands[75].optional_opt_args[31].opt = permission_ARG;
commands[75].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[75].optional_opt_args[32].opt = persistent_ARG;
commands[75].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[33].opt = readahead_ARG;
commands[75].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[75].optional_opt_args[34].opt = reportformat_ARG;
commands[75].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[35].opt = setactivationskip_ARG;
commands[75].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[36].opt = test_ARG;
commands[75].optional_opt_args[37].opt = wipesignatures_ARG;
commands[75].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[38].opt = zero_ARG;
commands[75].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[39].opt = stripes_ARG;
commands[75].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[75].optional_opt_args[40].opt = stripesize_ARG;
commands[75].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[76].name = "lvcreate";
commands[76].command_line_id = "lvcreate_cache_vol_with_new_origin_or_convert_to_cache_vol_with_cachepool";
commands[76].command_line_enum = lvcreate_cache_vol_with_new_origin_or_convert_to_cache_vol_with_cachepool_CMD;
commands[76].fn = lvcreate;
commands[76].ro_count = 2;
commands[76].rp_count = 1;
commands[76].oo_count = 37;
commands[76].op_count = 1;
commands[76].desc = "DESC: When LV is a cache pool, create a cache LV,  DESC: first creating a new origin LV, then combining it with  DESC: the existing cache pool named in arg pos 1  DESC: (variant, infers --type cache, also use --cachepool).  DESC: When LV is not a cache pool, convert the specified LV  DESC: to type cache after creating a new cache pool LV to use  DESC: (use lvconvert).";
commands[76].usage = "lvcreate --cache --size Number[m|unit] LV"
" [ --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n, --stripes Number, --stripesize Number[k|unit] ]"
" [ PV ... ]";
commands[76].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[76].required_opt_args[0].opt = cache_ARG;
commands[76].required_opt_args[1].opt = size_ARG;
commands[76].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[76].optional_opt_args[10].opt = cachemode_ARG;
commands[76].optional_opt_args[10].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[76].optional_opt_args[11].opt = cachepolicy_ARG;
commands[76].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[76].optional_opt_args[12].opt = cachesettings_ARG;
commands[76].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[76].optional_opt_args[13].opt = addtag_ARG;
commands[76].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[76].optional_opt_args[14].opt = alloc_ARG;
commands[76].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[76].optional_opt_args[15].opt = autobackup_ARG;
commands[76].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[16].opt = activate_ARG;
commands[76].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[76].optional_opt_args[17].opt = contiguous_ARG;
commands[76].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[76].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[76].optional_opt_args[20].opt = major_ARG;
commands[76].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[76].optional_opt_args[21].opt = metadataprofile_ARG;
commands[76].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[76].optional_opt_args[22].opt = minor_ARG;
commands[76].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[76].optional_opt_args[23].opt = monitor_ARG;
commands[76].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[24].opt = name_ARG;
commands[76].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[76].optional_opt_args[25].opt = nosync_ARG;
commands[76].optional_opt_args[26].opt = noudevsync_ARG;
commands[76].optional_opt_args[27].opt = permission_ARG;
commands[76].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[76].optional_opt_args[28].opt = persistent_ARG;
commands[76].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[29].opt = readahead_ARG;
commands[76].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[76].optional_opt_args[30].opt = reportformat_ARG;
commands[76].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[76].optional_opt_args[31].opt = setactivationskip_ARG;
commands[76].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[32].opt = test_ARG;
commands[76].optional_opt_args[33].opt = wipesignatures_ARG;
commands[76].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[34].opt = zero_ARG;
commands[76].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[76].optional_opt_args[35].opt = stripes_ARG;
commands[76].optional_opt_args[35].def.val_bits = val_enum_to_bit(number_VAL);
commands[76].optional_opt_args[36].opt = stripesize_ARG;
commands[76].optional_opt_args[36].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[77].name = "lvdisplay";
commands[77].command_line_id = "lvdisplay_general";
commands[77].command_line_enum = lvdisplay_general_CMD;
commands[77].fn = lvdisplay;
commands[77].ro_count = 0;
commands[77].rp_count = 0;
commands[77].oo_count = 35;
commands[77].op_count = 1;
commands[77].desc = "";
commands[77].usage = "lvdisplay"
...
commands[77].optional_opt_args[10].opt = aligned_ARG;
commands[77].optional_opt_args[11].opt = all_ARG;
commands[77].optional_opt_args[12].opt = binary_ARG;
commands[77].optional_opt_args[13].opt = colon_ARG;
commands[77].optional_opt_args[14].opt = columns_ARG;
commands[77].optional_opt_args[15].opt = configreport_ARG;
commands[77].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[16].opt = foreign_ARG;
commands[77].optional_opt_args[17].opt = history_ARG;
commands[77].optional_opt_args[18].opt = ignorelockingfailure_ARG;
commands[77].optional_opt_args[19].opt = ignoreskippedcluster_ARG;
commands[77].optional_opt_args[20].opt = logonly_ARG;
commands[77].optional_opt_args[21].opt = maps_ARG;
commands[77].optional_opt_args[22].opt = noheadings_ARG;
commands[77].optional_opt_args[23].opt = nosuffix_ARG;
commands[77].optional_opt_args[24].opt = options_ARG;
commands[77].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[25].opt = sort_ARG;
commands[77].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[26].opt = partial_ARG;
commands[77].optional_opt_args[27].opt = readonly_ARG;
commands[77].optional_opt_args[28].opt = reportformat_ARG;
commands[77].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[29].opt = segments_ARG;
commands[77].optional_opt_args[30].opt = select_ARG;
commands[77].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[31].opt = separator_ARG;
commands[77].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[77].optional_opt_args[32].opt = shared_ARG;
commands[77].optional_opt_args[33].opt = unbuffered_ARG;
commands[77].optional_opt_args[34].opt = units_ARG;
commands[77].optional_opt_args[34].def.val_bits = val_enum_to_bit(units_VAL);
commands[77].optional_pos_args[0].pos = 1;
commands[77].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL);
commands[77].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[78].name = "lvextend";
commands[78].command_line_id = "lvextend_by_size";
commands[78].command_line_enum = lvextend_by_size_CMD;
commands[78].fn = lvextend;
commands[78].ro_count = 1;
commands[78].rp_count = 1;
commands[78].oo_count = 23;
commands[78].op_count = 1;
commands[78].desc = "";
commands[78].usage = "lvextend --size Number[m|unit] LV"
...
commands[78].optional_opt_args[22].opt = poolmetadatasize_ARG;
commands[78].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[79].command_line_id = "lvextend_by_pv";
commands[79].command_line_enum = lvextend_by_pv_CMD;
commands[79].fn = lvextend;
commands[79].ro_count = 0;
commands[79].rp_count = 2;
commands[79].oo_count = 22;
commands[79].op_count = 0;
commands[79].desc = "";
commands[79].usage = "lvextend LV PV ..."
...
commands[79].optional_opt_args[19].opt = stripes_ARG;
commands[79].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[79].optional_opt_args[20].opt = stripesize_ARG;
commands[79].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[79].optional_opt_args[21].opt = test_ARG;

commands[80].name = "lvextend";
commands[80].command_line_id = "lvextend_pool_metadata_by_size";
commands[80].command_line_enum = lvextend_pool_metadata_by_size_CMD;
commands[80].fn = lvextend;
commands[80].ro_count = 1;
commands[80].rp_count = 1;
commands[80].oo_count = 21;
commands[80].op_count = 1;
commands[80].desc = "";
commands[80].usage = "lvextend --poolmetadatasize Number[m|unit] LV_thinpool"
...
commands[80].optional_opt_args[18].opt = stripes_ARG;
commands[80].optional_opt_args[18].def.val_bits = val_enum_to_bit(number_VAL);
commands[80].optional_opt_args[19].opt = stripesize_ARG;
commands[80].optional_opt_args[19].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[80].optional_opt_args[20].opt = test_ARG;
...
commands[81].name = "lvextend";
commands[81].command_line_id = "lvextend_by_policy";
commands[81].command_line_enum = lvextend_by_policy_CMD;
commands[81].fn = lvextend;
commands[81].ro_count = 1;
commands[81].rp_count = 1;
commands[81].oo_count = 20;
commands[81].op_count = 0;
commands[81].desc = "";
commands[81].usage = "lvextend --usepolicies LV_snapshot_thinpool"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[81].required_opt_args[0].opt = usepolicies_ARG;
commands[81].required_pos_args[0].pos = 1;
commands[81].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[81].required_pos_args[0].def.lv_types = ARG_DEF_LV_SNAPSHOT | ARG_DEF_LV_THINPOOL;
...
commands[81].optional_opt_args[10].opt = alloc_ARG;
commands[81].optional_opt_args[10].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[81].optional_opt_args[11].opt = autobackup_ARG;
commands[81].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[81].optional_opt_args[12].opt = force_ARG;
commands[81].optional_opt_args[13].opt = mirrors_ARG;
commands[81].optional_opt_args[13].def.val_bits = val_enum_to_bit(numsigned_VAL);
commands[81].optional_opt_args[14].opt = nofsck_ARG;
commands[81].optional_opt_args[15].opt = nosync_ARG;
commands[81].optional_opt_args[16].opt = noudevsync_ARG;
commands[81].optional_opt_args[17].opt = reportformat_ARG;
commands[81].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);
commands[81].optional_opt_args[18].opt = resizefs_ARG;
commands[81].optional_opt_args[19].opt = test_ARG;

commands[82].name = "lvmconfig";
commands[82].command_line_id = "lvmconfig_general";
commands[82].command_line_enum = lvmconfig_general_CMD;
commands[82].fn = lvmconfig;
commands[82].ro_count = 0;
commands[82].rp_count = 0;
commands[82].oo_count = 28;
commands[82].op_count = 0;
commands[82].desc = "";
commands[82].usage = "lvmconfig"
...
commands[82].optional_opt_args[10].opt = atversion_ARG;
commands[82].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[11].opt = configtype_ARG;
commands[82].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[12].opt = file_ARG;
commands[82].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[13].opt = ignoreadvanced_ARG;
commands[82].optional_opt_args[14].opt = ignoreunsupported_ARG;
commands[82].optional_opt_args[15].opt = ignorelocal_ARG;
commands[82].optional_opt_args[16].opt = list_ARG;
commands[82].optional_opt_args[17].opt = mergedconfig_ARG;
commands[82].optional_opt_args[18].opt = metadataprofile_ARG;
commands[82].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[19].opt = sinceversion_ARG;
commands[82].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[20].opt = showdeprecated_ARG;
commands[82].optional_opt_args[21].opt = showunsupported_ARG;
commands[82].optional_opt_args[22].opt = validate_ARG;
commands[82].optional_opt_args[23].opt = withsummary_ARG;
commands[82].optional_opt_args[24].opt = withcomments_ARG;
commands[82].optional_opt_args[25].opt = withspaces_ARG;
commands[82].optional_opt_args[26].opt = unconfigured_ARG;
commands[82].optional_opt_args[27].opt = withversions_ARG;

commands[83].name = "lvreduce";
commands[83].command_line_id = "lvreduce_general";
commands[83].command_line_enum = lvreduce_general_CMD;
...
commands[84].command_line_id = "lvremove_general";
commands[84].command_line_enum = lvremove_general_CMD;
...
commands[85].command_line_id = "lvrename_vg_lv_lv";
commands[85].command_line_enum = lvrename_vg_lv_lv_CMD;
...
commands[86].command_line_id = "lvrename_lv_lv";
commands[86].command_line_enum = lvrename_lv_lv_CMD;
...
commands[87].command_line_id = "lvresize_by_size";
commands[87].command_line_enum = lvresize_by_size_CMD;
commands[87].fn = lvresize;
commands[87].ro_count = 1;
commands[87].rp_count = 1;
commands[87].oo_count = 22;
commands[87].op_count = 1;
commands[87].desc = "DESC: Resize an LV by a specified size.";
...
commands[88].command_line_id = "lvresize_by_pv";
commands[88].command_line_enum = lvresize_by_pv_CMD;
commands[88].fn = lvresize;
commands[88].ro_count = 0;
commands[88].rp_count = 2;
commands[88].oo_count = 21;
commands[88].op_count = 0;
commands[88].desc = "DESC: Resize an LV by a specified PV.";
...
commands[89].command_line_id = "lvresize_pool_metadata_by_size";
commands[89].command_line_enum = lvresize_pool_metadata_by_size_CMD;
commands[89].fn = lvresize;
commands[89].ro_count = 1;
commands[89].rp_count = 1;
commands[89].oo_count = 20;
commands[89].op_count = 1;
commands[89].desc = "DESC: Resize the metadata SubLV of a pool LV.";
...
commands[90].command_line_id = "lvs_general";
commands[90].command_line_enum = lvs_general_CMD;
commands[90].fn = lvs;
...
commands[91].command_line_id = "lvscan_general";
commands[91].command_line_enum = lvscan_general_CMD;
...
commands[92].command_line_id = "pvchange_properties_all";
commands[92].command_line_enum = pvchange_properties_all_CMD;
...
commands[93].command_line_id = "pvchange_properties_some";
commands[93].command_line_enum = pvchange_properties_some_CMD;
...
commands[94].command_line_id = "pvresize_general";
commands[94].command_line_enum = pvresize_general_CMD;
...
commands[95].command_line_id = "pvck_general";
commands[95].command_line_enum = pvck_general_CMD;
commands[95].fn = pvck;
...
commands[96].command_line_id = "pvcreate_general";
commands[96].command_line_enum = pvcreate_general_CMD;
commands[96].fn = pvcreate;
commands[96].ro_count = 0;
commands[96].rp_count = 1;
commands[96].oo_count = 27;
...
commands[96].optional_opt_args[18].opt = metadatacopies_ARG;
commands[96].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[96].optional_opt_args[19].opt = metadatasize_ARG;
commands[96].optional_opt_args[19].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[96].optional_opt_args[20].opt = metadataignore_ARG;
commands[96].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[96].optional_opt_args[21].opt = norestorefile_ARG;
commands[96].optional_opt_args[22].opt = physicalvolumesize_ARG;
commands[96].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[96].optional_opt_args[23].opt = reportformat_ARG;
commands[96].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[96].optional_opt_args[24].opt = restorefile_ARG;
commands[96].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[96].optional_opt_args[25].opt = uuidstr_ARG;
commands[96].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[96].optional_opt_args[26].opt = zero_ARG;
commands[96].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);

commands[97].name = "pvdisplay";
commands[97].command_line_id = "pvdisplay_general";
commands[97].command_line_enum = pvdisplay_general_CMD;
commands[97].fn = pvdisplay;
commands[97].ro_count = 0;
commands[97].rp_count = 0;
commands[97].oo_count = 33;
commands[97].op_count = 1;
commands[97].desc = "";
commands[97].usage = "pvdisplay"
...
commands[97].optional_opt_args[10].opt = aligned_ARG;
commands[97].optional_opt_args[11].opt = all_ARG;
commands[97].optional_opt_args[12].opt = binary_ARG;
commands[97].optional_opt_args[13].opt = colon_ARG;
commands[97].optional_opt_args[14].opt = columns_ARG;
commands[97].optional_opt_args[15].opt = configreport_ARG;
commands[97].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[16].opt = foreign_ARG;
commands[97].optional_opt_args[17].opt = ignorelockingfailure_ARG;
commands[97].optional_opt_args[18].opt = ignoreskippedcluster_ARG;
commands[97].optional_opt_args[19].opt = logonly_ARG;
commands[97].optional_opt_args[20].opt = maps_ARG;
commands[97].optional_opt_args[21].opt = noheadings_ARG;
commands[97].optional_opt_args[22].opt = nosuffix_ARG;
commands[97].optional_opt_args[23].opt = options_ARG;
commands[97].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[24].opt = readonly_ARG;
commands[97].optional_opt_args[25].opt = reportformat_ARG;
commands[97].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[26].opt = select_ARG;
commands[97].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[27].opt = separator_ARG;
commands[97].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[28].opt = shared_ARG;
commands[97].optional_opt_args[29].opt = short_ARG;
commands[97].optional_opt_args[30].opt = sort_ARG;
commands[97].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[97].optional_opt_args[31].opt = unbuffered_ARG;
commands[97].optional_opt_args[32].opt = units_ARG;
commands[97].optional_opt_args[32].def.val_bits = val_enum_to_bit(units_VAL);
commands[97].optional_pos_args[0].pos = 1;
commands[97].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL) | val_enum_to_bit(tag_VAL);
commands[97].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[98].name = "pvmove";
commands[98].command_line_id = "pvmove_one";
commands[98].command_line_enum = pvmove_one_CMD;
commands[98].fn = pvmove;
commands[98].ro_count = 0;
commands[98].rp_count = 1;
commands[98].oo_count = 20;
commands[98].op_count = 1;
commands[98].desc = "";
commands[98].usage = "pvmove PV"
...
commands[98].optional_opt_args[11].opt = alloc_ARG;
commands[98].optional_opt_args[11].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[98].optional_opt_args[12].opt = atomic_ARG;
commands[98].optional_opt_args[13].opt = autobackup_ARG;
commands[98].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[98].optional_opt_args[14].opt = background_ARG;
commands[98].optional_opt_args[15].opt = interval_ARG;
commands[98].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[98].optional_opt_args[16].opt = name_ARG;
commands[98].optional_opt_args[16].def.val_bits = val_enum_to_bit(lv_VAL);
commands[98].optional_opt_args[17].opt = noudevsync_ARG;
commands[98].optional_opt_args[18].opt = reportformat_ARG;
commands[98].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[98].optional_opt_args[19].opt = test_ARG;
commands[98].optional_pos_args[0].pos = 2;
commands[98].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[98].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[99].name = "pvmove";
commands[99].command_line_id = "pvmove_any";
commands[99].command_line_enum = pvmove_any_CMD;
...
commands[99].optional_opt_args[11].opt = background_ARG;
commands[99].optional_opt_args[12].opt = test_ARG;

commands[100].name = "pvremove";
commands[100].command_line_id = "pvremove_general";
commands[100].command_line_enum = pvremove_general_CMD;
commands[100].fn = pvremove;
commands[100].ro_count = 0;
commands[100].rp_count = 1;
commands[100].oo_count = 13;
commands[100].op_count = 0;
commands[100].desc = "";
commands[100].usage = "pvremove PV ..."
" [ --reportformat String ]";
commands[100].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[100].required_pos_args[0].pos = 1;
commands[100].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[100].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[100].optional_opt_args[10].opt = force_ARG;
...
commands[101].name = "pvs";
commands[101].command_line_id = "pvs_general";
commands[101].command_line_enum = pvs_general_CMD;
commands[101].fn = pvs;
commands[101].ro_count = 0;
commands[101].rp_count = 0;
commands[101].oo_count = 36;
commands[101].op_count = 1;
commands[101].desc = "";
commands[101].usage = "pvs"
...
commands[101].optional_opt_args[10].opt = segments_ARG;
commands[101].optional_opt_args[11].opt = aligned_ARG;
commands[101].optional_opt_args[12].opt = all_ARG;
commands[101].optional_opt_args[13].opt = binary_ARG;
commands[101].optional_opt_args[14].opt = configreport_ARG;
commands[101].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[15].opt = foreign_ARG;
commands[101].optional_opt_args[16].opt = ignorelockingfailure_ARG;
commands[101].optional_opt_args[17].opt = ignoreskippedcluster_ARG;
commands[101].optional_opt_args[18].opt = logonly_ARG;
commands[101].optional_opt_args[19].opt = nameprefixes_ARG;
commands[101].optional_opt_args[20].opt = noheadings_ARG;
commands[101].optional_opt_args[21].opt = nolocking_ARG;
commands[101].optional_opt_args[22].opt = nosuffix_ARG;
commands[101].optional_opt_args[23].opt = options_ARG;
commands[101].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[24].opt = partial_ARG;
commands[101].optional_opt_args[25].opt = readonly_ARG;
commands[101].optional_opt_args[26].opt = reportformat_ARG;
commands[101].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[27].opt = rows_ARG;
commands[101].optional_opt_args[28].opt = select_ARG;
commands[101].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[29].opt = separator_ARG;
commands[101].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[30].opt = shared_ARG;
commands[101].optional_opt_args[31].opt = sort_ARG;
commands[101].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[101].optional_opt_args[32].opt = trustcache_ARG;
commands[101].optional_opt_args[33].opt = unbuffered_ARG;
commands[101].optional_opt_args[34].opt = units_ARG;
commands[101].optional_opt_args[34].def.val_bits = val_enum_to_bit(units_VAL);
commands[101].optional_opt_args[35].opt = unquoted_ARG;
commands[101].optional_pos_args[0].pos = 1;
commands[101].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL) | val_enum_to_bit(tag_VAL);
commands[101].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[102].name = "pvscan";
commands[102].command_line_id = "pvscan_show";
commands[102].command_line_enum = pvscan_show_CMD;
...
commands[102].optional_opt_args[12].opt = exported_ARG;
commands[102].optional_opt_args[13].opt = novolumegroup_ARG;
commands[102].optional_opt_args[14].opt = short_ARG;
commands[102].optional_opt_args[15].opt = uuid_ARG;

commands[103].name = "pvscan";
commands[103].command_line_id = "pvscan_cache";
commands[103].command_line_enum = pvscan_cache_CMD;
commands[103].fn = pvscan;
commands[103].ro_count = 1;
commands[103].rp_count = 0;
commands[103].oo_count = 16;
commands[103].op_count = 1;
commands[103].desc = "";
commands[103].usage = "pvscan --cache"
" [ --ignorelockingfailure, --reportformat String, --background, --activate y|n|ay, --major Number, --minor Number ]"
" [ String|PV ... ]";
commands[103].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[103].required_opt_args[0].opt = cache_long_ARG;
...
commands[103].optional_opt_args[10].opt = ignorelockingfailure_ARG;
commands[103].optional_opt_args[11].opt = reportformat_ARG;
commands[103].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[103].optional_opt_args[12].opt = background_ARG;
commands[103].optional_opt_args[13].opt = activate_ARG;
commands[103].optional_opt_args[13].def.val_bits = val_enum_to_bit(activation_VAL);
commands[103].optional_opt_args[14].opt = major_ARG;
commands[103].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[103].optional_opt_args[15].opt = minor_ARG;
commands[103].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[103].optional_pos_args[0].pos = 1;
commands[103].optional_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL) | val_enum_to_bit(pv_VAL);
commands[103].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[104].name = "vgcfgbackup";
commands[104].command_line_id = "vgcfgbackup_general";
commands[104].command_line_enum = vgcfgbackup_general_CMD;
commands[104].fn = vgcfgbackup;
commands[104].ro_count = 0;
commands[104].rp_count = 0;
commands[104].oo_count = 16;
commands[104].op_count = 1;
commands[104].desc = "";
commands[104].usage = "vgcfgbackup"
...
commands[104].optional_opt_args[11].opt = foreign_ARG;
commands[104].optional_opt_args[12].opt = ignorelockingfailure_ARG;
commands[104].optional_opt_args[13].opt = partial_ARG;
commands[104].optional_opt_args[14].opt = readonly_ARG;
commands[104].optional_opt_args[15].opt = reportformat_ARG;
commands[104].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[104].optional_pos_args[0].pos = 1;
commands[104].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[104].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[105].name = "vgcfgrestore";
commands[105].command_line_id = "vgcfgrestore_by_vg";
commands[105].command_line_enum = vgcfgrestore_by_vg_CMD;
commands[105].fn = vgcfgrestore;
commands[105].ro_count = 0;
commands[105].rp_count = 1;
commands[105].oo_count = 15;
commands[105].op_count = 0;
commands[105].desc = "";
commands[105].usage = "vgcfgrestore VG"
" [ --file String, --force, --list, --metadatatype lvm2|lvm1 ]";
commands[105].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[105].required_pos_args[0].pos = 1;
commands[105].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[105].optional_opt_args[10].opt = file_ARG;
commands[105].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[105].optional_opt_args[11].opt = force_long_ARG;
commands[105].optional_opt_args[12].opt = list_ARG;
commands[105].optional_opt_args[13].opt = metadatatype_ARG;
commands[105].optional_opt_args[13].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[105].optional_opt_args[14].opt = test_ARG;

commands[106].name = "vgcfgrestore";
commands[106].command_line_id = "vgcfgrestore_by_file";
commands[106].command_line_enum = vgcfgrestore_by_file_CMD;
commands[106].fn = vgcfgrestore;
commands[106].ro_count = 2;
commands[106].rp_count = 0;
commands[106].oo_count = 10;
commands[106].op_count = 0;
commands[106].desc = "";
commands[106].usage = "vgcfgrestore --list --file String";
commands[106].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[106].required_opt_args[0].opt = list_ARG;
commands[106].required_opt_args[1].opt = file_ARG;
commands[106].required_opt_args[1].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[107].command_line_id = "vgchange_properties";
commands[107].command_line_enum = vgchange_properties_CMD;
commands[107].fn = vgchange;
commands[107].ro_count = 16;
commands[107].rp_count = 0;
commands[107].oo_count = 18;
commands[107].op_count = 1;
commands[107].cmd_flags = CMD_FLAG_ONE_REQUIRED_OPT;
commands[107].desc = "";
commands[107].usage = "vgchange ( --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --profile String, --detachprofile, --metadataprofile String )"
" [ --autobackup y|n, --ignoremonitoring, --ignoreskippedcluster, --reportformat String, --select String ]"
" [ VG|Tag ... ]";
commands[107].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[107].required_opt_args[0].opt = addtag_ARG;
commands[107].required_opt_args[0].def.val_bits = val_enum_to_bit(tag_VAL);
commands[107].required_opt_args[1].opt = deltag_ARG;
commands[107].required_opt_args[1].def.val_bits = val_enum_to_bit(tag_VAL);
commands[107].required_opt_args[2].opt = logicalvolume_ARG;
commands[107].required_opt_args[2].def.val_bits = val_enum_to_bit(number_VAL);
commands[107].required_opt_args[3].opt = maxphysicalvolumes_ARG;
commands[107].required_opt_args[3].def.val_bits = val_enum_to_bit(number_VAL);
commands[107].required_opt_args[4].opt = alloc_ARG;
commands[107].required_opt_args[4].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[107].required_opt_args[5].opt = uuid_ARG;
commands[107].required_opt_args[6].opt = clustered_ARG;
commands[107].required_opt_args[6].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].required_opt_args[7].opt = metadatacopies_ARG;
commands[107].required_opt_args[7].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[107].required_opt_args[8].opt = vgmetadatacopies_ARG;
commands[107].required_opt_args[8].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[107].required_opt_args[9].opt = physicalextentsize_ARG;
commands[107].required_opt_args[9].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[107].required_opt_args[10].opt = resizeable_ARG;
commands[107].required_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].required_opt_args[11].opt = systemid_ARG;
commands[107].required_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].required_opt_args[12].opt = locktype_ARG;
commands[107].required_opt_args[12].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[107].required_opt_args[13].opt = profile_ARG;
commands[107].required_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].required_opt_args[14].opt = detachprofile_ARG;
commands[107].required_opt_args[15].opt = metadataprofile_ARG;
commands[107].required_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[107].optional_opt_args[10].opt = autobackup_ARG;
commands[107].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].optional_opt_args[11].opt = ignoremonitoring_ARG;
commands[107].optional_opt_args[12].opt = ignoreskippedcluster_ARG;
commands[107].optional_opt_args[13].opt = noudevsync_ARG;
commands[107].optional_opt_args[14].opt = reportformat_ARG;
commands[107].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[15].opt = select_ARG;
commands[107].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[16].opt = test_ARG;
commands[107].optional_opt_args[17].opt = force_ARG;
...
commands[108].command_line_id = "vgchange_monitor";
commands[108].command_line_enum = vgchange_monitor_CMD;
commands[108].fn = vgchange;
commands[108].ro_count = 1;
commands[108].rp_count = 0;
commands[108].oo_count = 37;
commands[108].op_count = 1;
commands[108].desc = "";
commands[108].usage = "vgchange --monitor y|n"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[108].required_opt_args[0].opt = monitor_ARG;
...
commands[108].optional_opt_args[10].opt = sysinit_ARG;
commands[108].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[108].optional_opt_args[12].opt = poll_ARG;
commands[108].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[13].opt = addtag_ARG;
commands[108].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[108].optional_opt_args[14].opt = deltag_ARG;
commands[108].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[108].optional_opt_args[15].opt = logicalvolume_ARG;
commands[108].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[108].optional_opt_args[16].opt = maxphysicalvolumes_ARG;
commands[108].optional_opt_args[16].def.val_bits = val_enum_to_bit(number_VAL);
commands[108].optional_opt_args[17].opt = alloc_ARG;
commands[108].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[108].optional_opt_args[18].opt = uuid_ARG;
commands[108].optional_opt_args[19].opt = clustered_ARG;
commands[108].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[20].opt = metadatacopies_ARG;
commands[108].optional_opt_args[20].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[108].optional_opt_args[21].opt = vgmetadatacopies_ARG;
commands[108].optional_opt_args[21].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[108].optional_opt_args[22].opt = physicalextentsize_ARG;
commands[108].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[108].optional_opt_args[23].opt = resizeable_ARG;
commands[108].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[24].opt = systemid_ARG;
commands[108].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[25].opt = locktype_ARG;
commands[108].optional_opt_args[25].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[108].optional_opt_args[26].opt = profile_ARG;
commands[108].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[27].opt = detachprofile_ARG;
commands[108].optional_opt_args[28].opt = metadataprofile_ARG;
commands[108].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[29].opt = autobackup_ARG;
commands[108].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[30].opt = ignoremonitoring_ARG;
commands[108].optional_opt_args[31].opt = ignoreskippedcluster_ARG;
commands[108].optional_opt_args[32].opt = noudevsync_ARG;
commands[108].optional_opt_args[33].opt = reportformat_ARG;
commands[108].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[34].opt = select_ARG;
commands[108].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[35].opt = test_ARG;
commands[108].optional_opt_args[36].opt = force_ARG;
...
commands[109].command_line_id = "vgchange_poll";
commands[109].command_line_enum = vgchange_poll_CMD;
commands[109].fn = vgchange;
commands[109].ro_count = 1;
commands[109].rp_count = 0;
commands[109].oo_count = 35;
commands[109].op_count = 1;
commands[109].desc = "";
commands[109].usage = "vgchange --poll y|n"
" [ --ignorelockingfailure, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, --autobackup y|n, --ignoremonitoring, --ignoreskippedcluster, --reportformat String, --select String ]"
" [ VG|Tag ... ]";
commands[109].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[109].required_opt_args[0].opt = poll_ARG;
commands[109].required_opt_args[0].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[109].optional_opt_args[10].opt = ignorelockingfailure_ARG;
commands[109].optional_opt_args[11].opt = addtag_ARG;
commands[109].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[109].optional_opt_args[12].opt = deltag_ARG;
commands[109].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[109].optional_opt_args[13].opt = logicalvolume_ARG;
commands[109].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[109].optional_opt_args[14].opt = maxphysicalvolumes_ARG;
commands[109].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[109].optional_opt_args[15].opt = alloc_ARG;
commands[109].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[109].optional_opt_args[16].opt = uuid_ARG;
commands[109].optional_opt_args[17].opt = clustered_ARG;
commands[109].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[18].opt = metadatacopies_ARG;
commands[109].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[109].optional_opt_args[19].opt = vgmetadatacopies_ARG;
commands[109].optional_opt_args[19].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[109].optional_opt_args[20].opt = physicalextentsize_ARG;
commands[109].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[109].optional_opt_args[21].opt = resizeable_ARG;
commands[109].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[22].opt = systemid_ARG;
commands[109].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[23].opt = locktype_ARG;
commands[109].optional_opt_args[23].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[109].optional_opt_args[24].opt = profile_ARG;
commands[109].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[25].opt = detachprofile_ARG;
commands[109].optional_opt_args[26].opt = metadataprofile_ARG;
commands[109].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[27].opt = autobackup_ARG;
commands[109].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[28].opt = ignoremonitoring_ARG;
commands[109].optional_opt_args[29].opt = ignoreskippedcluster_ARG;
commands[109].optional_opt_args[30].opt = noudevsync_ARG;
commands[109].optional_opt_args[31].opt = reportformat_ARG;
commands[109].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[32].opt = select_ARG;
commands[109].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[33].opt = test_ARG;
commands[109].optional_opt_args[34].opt = force_ARG;
...
commands[110].command_line_id = "vgchange_activate";
commands[110].command_line_enum = vgchange_activate_CMD;
commands[110].fn = vgchange;
commands[110].ro_count = 1;
commands[110].rp_count = 0;
commands[110].oo_count = 41;
commands[110].op_count = 1;
commands[110].desc = "";
commands[110].usage = "vgchange --activate y|n|ay"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[110].required_opt_args[0].opt = activate_ARG;
commands[110].required_opt_args[0].def.val_bits = val_enum_to_bit(activation_VAL);
...
commands[110].optional_opt_args[10].opt = activationmode_ARG;
commands[110].optional_opt_args[10].def.val_bits = val_enum_to_bit(activationmode_VAL);
commands[110].optional_opt_args[11].opt = ignoreactivationskip_ARG;
commands[110].optional_opt_args[12].opt = partial_ARG;
commands[110].optional_opt_args[13].opt = sysinit_ARG;
commands[110].optional_opt_args[14].opt = ignorelockingfailure_ARG;
commands[110].optional_opt_args[15].opt = monitor_ARG;
commands[110].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[16].opt = poll_ARG;
commands[110].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[17].opt = addtag_ARG;
commands[110].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[110].optional_opt_args[18].opt = deltag_ARG;
commands[110].optional_opt_args[18].def.val_bits = val_enum_to_bit(tag_VAL);
commands[110].optional_opt_args[19].opt = logicalvolume_ARG;
commands[110].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[110].optional_opt_args[20].opt = maxphysicalvolumes_ARG;
commands[110].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[110].optional_opt_args[21].opt = alloc_ARG;
commands[110].optional_opt_args[21].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[110].optional_opt_args[22].opt = uuid_ARG;
commands[110].optional_opt_args[23].opt = clustered_ARG;
commands[110].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[24].opt = metadatacopies_ARG;
commands[110].optional_opt_args[24].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[110].optional_opt_args[25].opt = vgmetadatacopies_ARG;
commands[110].optional_opt_args[25].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[110].optional_opt_args[26].opt = physicalextentsize_ARG;
commands[110].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[110].optional_opt_args[27].opt = resizeable_ARG;
commands[110].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[28].opt = systemid_ARG;
commands[110].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[29].opt = locktype_ARG;
commands[110].optional_opt_args[29].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[110].optional_opt_args[30].opt = profile_ARG;
commands[110].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[31].opt = detachprofile_ARG;
commands[110].optional_opt_args[32].opt = metadataprofile_ARG;
commands[110].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[33].opt = autobackup_ARG;
commands[110].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[34].opt = ignoremonitoring_ARG;
commands[110].optional_opt_args[35].opt = ignoreskippedcluster_ARG;
commands[110].optional_opt_args[36].opt = noudevsync_ARG;
commands[110].optional_opt_args[37].opt = reportformat_ARG;
commands[110].optional_opt_args[37].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[38].opt = select_ARG;
commands[110].optional_opt_args[38].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[39].opt = test_ARG;
commands[110].optional_opt_args[40].opt = force_ARG;
...
commands[111].command_line_id = "vgchange_refresh";
commands[111].command_line_enum = vgchange_refresh_CMD;
commands[111].fn = vgchange;
commands[111].ro_count = 1;
commands[111].rp_count = 0;
commands[111].oo_count = 38;
commands[111].op_count = 1;
commands[111].desc = "";
commands[111].usage = "vgchange --refresh"
" [ --sysinit, --ignorelockingfailure, --monitor y|n, --poll y|n, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, --autobackup y|n, --ignoremonitoring, --ignoreskippedcluster, --reportformat String, --select String ]"
" [ VG|Tag ... ]";
commands[111].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[111].required_opt_args[0].opt = refresh_ARG;
...
commands[111].optional_opt_args[10].opt = sysinit_ARG;
commands[111].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[111].optional_opt_args[12].opt = monitor_ARG;
commands[111].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[111].optional_opt_args[13].opt = poll_ARG;
commands[111].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[111].optional_opt_args[14].opt = addtag_ARG;
commands[111].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[111].optional_opt_args[15].opt = deltag_ARG;
commands[111].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[111].optional_opt_args[16].opt = logicalvolume_ARG;
commands[111].optional_opt_args[16].def.val_bits = val_enum_to_bit(number_VAL);
commands[111].optional_opt_args[17].opt = maxphysicalvolumes_ARG;
commands[111].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[111].optional_opt_args[18].opt = alloc_ARG;
commands[111].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[111].optional_opt_args[19].opt = uuid_ARG;
commands[111].optional_opt_args[20].opt = clustered_ARG;
commands[111].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[111].optional_opt_args[21].opt = metadatacopies_ARG;
commands[111].optional_opt_args[21].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[111].optional_opt_args[22].opt = vgmetadatacopies_ARG;
commands[111].optional_opt_args[22].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[111].optional_opt_args[23].opt = physicalextentsize_ARG;
commands[111].optional_opt_args[23].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[111].optional_opt_args[24].opt = resizeable_ARG;
commands[111].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[111].optional_opt_args[25].opt = systemid_ARG;
commands[111].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[111].optional_opt_args[26].opt = locktype_ARG;
commands[111].optional_opt_args[26].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[111].optional_opt_args[27].opt = profile_ARG;
commands[111].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[111].optional_opt_args[28].opt = detachprofile_ARG;
commands[111].optional_opt_args[29].opt = metadataprofile_ARG;
commands[111].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[111].optional_opt_args[30].opt = autobackup_ARG;
commands[111].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[111].optional_opt_args[31].opt = ignoremonitoring_ARG;
commands[111].optional_opt_args[32].opt = ignoreskippedcluster_ARG;
commands[111].optional_opt_args[33].opt = noudevsync_ARG;
commands[111].optional_opt_args[34].opt = reportformat_ARG;
commands[111].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[111].optional_opt_args[35].opt = select_ARG;
commands[111].optional_opt_args[35].def.val_bits = val_enum_to_bit(string_VAL);
commands[111].optional_opt_args[36].opt = test_ARG;
commands[111].optional_opt_args[37].opt = force_ARG;
...
commands[112].command_line_id = "vgchange_lockstart";
commands[112].command_line_enum = vgchange_lockstart_CMD;
...
commands[112].desc = "";
commands[112].usage = "vgchange --lockstart"
" [ --lockopt String, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, --autobackup y|n, --ignoremonitoring, --ignoreskippedcluster, --reportformat String, --select String ]"
" [ VG|Tag ... ]";
commands[112].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[112].required_opt_args[0].opt = lockstart_ARG;
...
commands[113].command_line_id = "vgchange_lockstop";
commands[113].command_line_enum = vgchange_lockstop_CMD;
commands[113].fn = vgchange;
commands[113].ro_count = 1;
commands[113].rp_count = 0;
commands[113].oo_count = 35;
commands[113].op_count = 1;
commands[113].desc = "";
commands[113].usage = "vgchange --lockstop"
" [ --lockopt String, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, --autobackup y|n, --ignoremonitoring, --ignoreskippedcluster, --reportformat String, --select String ]"
" [ VG|Tag ... ]";
commands[113].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[113].required_opt_args[0].opt = lockstop_ARG;
...
commands[113].optional_opt_args[10].opt = lockopt_ARG;
commands[113].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[11].opt = addtag_ARG;
commands[113].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[113].optional_opt_args[12].opt = deltag_ARG;
commands[113].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[113].optional_opt_args[13].opt = logicalvolume_ARG;
commands[113].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[113].optional_opt_args[14].opt = maxphysicalvolumes_ARG;
commands[113].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[113].optional_opt_args[15].opt = alloc_ARG;
commands[113].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[113].optional_opt_args[16].opt = uuid_ARG;
commands[113].optional_opt_args[17].opt = clustered_ARG;
commands[113].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[113].optional_opt_args[18].opt = metadatacopies_ARG;
commands[113].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[113].optional_opt_args[19].opt = vgmetadatacopies_ARG;
commands[113].optional_opt_args[19].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[113].optional_opt_args[20].opt = physicalextentsize_ARG;
commands[113].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[113].optional_opt_args[21].opt = resizeable_ARG;
commands[113].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[113].optional_opt_args[22].opt = systemid_ARG;
commands[113].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[23].opt = locktype_ARG;
commands[113].optional_opt_args[23].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[113].optional_opt_args[24].opt = profile_ARG;
commands[113].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[25].opt = detachprofile_ARG;
commands[113].optional_opt_args[26].opt = metadataprofile_ARG;
commands[113].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[27].opt = autobackup_ARG;
commands[113].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[113].optional_opt_args[28].opt = ignoremonitoring_ARG;
commands[113].optional_opt_args[29].opt = ignoreskippedcluster_ARG;
commands[113].optional_opt_args[30].opt = noudevsync_ARG;
commands[113].optional_opt_args[31].opt = reportformat_ARG;
commands[113].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[32].opt = select_ARG;
commands[113].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[113].optional_opt_args[33].opt = test_ARG;
commands[113].optional_opt_args[34].opt = force_ARG;
...
commands[114].name = "vgck";
commands[114].command_line_id = "vgck_general";
commands[114].command_line_enum = vgck_general_CMD;
commands[114].fn = vgck;
commands[114].ro_count = 0;
commands[114].rp_count = 0;
commands[114].oo_count = 11;
commands[114].op_count = 1;
commands[114].desc = "";
commands[114].usage = "vgck"
" [ --reportformat String ]"
" [ VG|Tag ... ]";
...
commands[114].optional_opt_args[10].opt = reportformat_ARG;
commands[114].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[115].name = "vgconvert";
commands[115].command_line_id = "vgconvert_general";
commands[115].command_line_enum = vgconvert_general_CMD;
commands[115].fn = vgconvert;
commands[115].ro_count = 0;
commands[115].rp_count = 1;
commands[115].oo_count = 18;
commands[115].op_count = 0;
commands[115].desc = "";
commands[115].usage = "vgconvert VG ..."
...
commands[115].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[115].optional_opt_args[10].opt = force_ARG;
commands[115].optional_opt_args[11].opt = test_ARG;
commands[115].optional_opt_args[12].opt = labelsector_ARG;
commands[115].optional_opt_args[12].def.val_bits = val_enum_to_bit(number_VAL);
commands[115].optional_opt_args[13].opt = bootloaderareasize_ARG;
commands[115].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[115].optional_opt_args[14].opt = metadatatype_ARG;
commands[115].optional_opt_args[14].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[115].optional_opt_args[15].opt = pvmetadatacopies_ARG;
commands[115].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[115].optional_opt_args[16].opt = metadatasize_ARG;
commands[115].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[115].optional_opt_args[17].opt = reportformat_ARG;
commands[115].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);

commands[116].name = "vgcreate";
commands[116].command_line_id = "vgcreate_general";
commands[116].command_line_enum = vgcreate_general_CMD;
commands[116].fn = vgcreate;
commands[116].ro_count = 0;
commands[116].rp_count = 2;
commands[116].oo_count = 34;
commands[116].op_count = 0;
commands[116].desc = "";
commands[116].usage = "vgcreate VG_new PV ..."
...
commands[116].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[116].required_pos_args[0].def.flags = ARG_DEF_FLAG_NEW;
commands[116].required_pos_args[1].pos = 2;
commands[116].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[116].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[116].optional_opt_args[10].opt = addtag_ARG;
commands[116].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[116].optional_opt_args[11].opt = alloc_ARG;
commands[116].optional_opt_args[11].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[116].optional_opt_args[12].opt = autobackup_ARG;
commands[116].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[116].optional_opt_args[13].opt = clustered_ARG;
commands[116].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[116].optional_opt_args[14].opt = maxlogicalvolumes_ARG;
commands[116].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[116].optional_opt_args[15].opt = maxphysicalvolumes_ARG;
commands[116].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[116].optional_opt_args[16].opt = metadataprofile_ARG;
commands[116].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[116].optional_opt_args[17].opt = metadatatype_ARG;
commands[116].optional_opt_args[17].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[116].optional_opt_args[18].opt = physicalextentsize_ARG;
commands[116].optional_opt_args[18].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[116].optional_opt_args[19].opt = test_ARG;
commands[116].optional_opt_args[20].opt = force_ARG;
commands[116].optional_opt_args[21].opt = zero_ARG;
commands[116].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[116].optional_opt_args[22].opt = labelsector_ARG;
commands[116].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[116].optional_opt_args[23].opt = metadatasize_ARG;
commands[116].optional_opt_args[23].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[116].optional_opt_args[24].opt = pvmetadatacopies_ARG;
commands[116].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
...
commands[116].optional_opt_args[26].opt = metadatacopies_ARG;
commands[116].optional_opt_args[26].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[116].optional_opt_args[27].opt = vgmetadatacopies_ARG;
commands[116].optional_opt_args[27].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[116].optional_opt_args[28].opt = dataalignment_ARG;
commands[116].optional_opt_args[28].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[116].optional_opt_args[29].opt = dataalignmentoffset_ARG;
commands[116].optional_opt_args[29].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[116].optional_opt_args[30].opt = shared_ARG;
commands[116].optional_opt_args[31].opt = systemid_ARG;
commands[116].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[116].optional_opt_args[32].opt = locktype_ARG;
commands[116].optional_opt_args[32].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[116].optional_opt_args[33].opt = lockopt_ARG;
commands[116].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);

commands[117].name = "vgdisplay";
commands[117].command_line_id = "vgdisplay_general";
commands[117].command_line_enum = vgdisplay_general_CMD;
commands[117].fn = vgdisplay;
commands[117].ro_count = 0;
commands[117].rp_count = 0;
commands[117].oo_count = 33;
commands[117].op_count = 1;
commands[117].desc = "";
commands[117].usage = "vgdisplay"
...
commands[117].optional_opt_args[10].opt = activevolumegroups_ARG;
commands[117].optional_opt_args[11].opt = aligned_ARG;
commands[117].optional_opt_args[12].opt = binary_ARG;
commands[117].optional_opt_args[13].opt = colon_ARG;
commands[117].optional_opt_args[14].opt = columns_ARG;
commands[117].optional_opt_args[15].opt = configreport_ARG;
commands[117].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[16].opt = foreign_ARG;
commands[117].optional_opt_args[17].opt = ignorelockingfailure_ARG;
commands[117].optional_opt_args[18].opt = ignoreskippedcluster_ARG;
commands[117].optional_opt_args[19].opt = logonly_ARG;
commands[117].optional_opt_args[20].opt = noheadings_ARG;
commands[117].optional_opt_args[21].opt = nosuffix_ARG;
commands[117].optional_opt_args[22].opt = options_ARG;
commands[117].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[23].opt = partial_ARG;
commands[117].optional_opt_args[24].opt = readonly_ARG;
commands[117].optional_opt_args[25].opt = reportformat_ARG;
commands[117].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[26].opt = select_ARG;
commands[117].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[27].opt = shared_ARG;
commands[117].optional_opt_args[28].opt = short_ARG;
commands[117].optional_opt_args[29].opt = separator_ARG;
commands[117].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[30].opt = sort_ARG;
commands[117].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[31].opt = unbuffered_ARG;
commands[117].optional_opt_args[32].opt = units_ARG;
commands[117].optional_opt_args[32].def.val_bits = val_enum_to_bit(units_VAL);
...
commands[118].command_line_id = "vgexport_some";
commands[118].command_line_enum = vgexport_some_CMD;
commands[118].fn = vgexport;
commands[118].ro_count = 0;
commands[118].rp_count = 1;
commands[118].oo_count = 13;
commands[118].op_count = 0;
commands[118].desc = "";
commands[118].usage = "vgexport VG|Tag|Select ..."
" [ --select String, --reportformat String ]";
commands[118].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[118].required_pos_args[0].pos = 1;
commands[118].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[118].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[118].optional_opt_args[10].opt = select_ARG;
commands[118].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[118].optional_opt_args[11].opt = reportformat_ARG;
commands[118].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[118].optional_opt_args[12].opt = test_ARG;

commands[119].name = "vgexport";
commands[119].command_line_id = "vgexport_all";
commands[119].command_line_enum = vgexport_all_CMD;
commands[119].fn = vgexport;
commands[119].ro_count = 1;
commands[119].rp_count = 0;
commands[119].oo_count = 12;
commands[119].op_count = 0;
commands[119].desc = "";
commands[119].usage = "vgexport --all"
" [ --reportformat String ]";
commands[119].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[119].required_opt_args[0].opt = all_ARG;
...
commands[120].name = "vgextend";
commands[120].command_line_id = "vgextend_general";
commands[120].command_line_enum = vgextend_general_CMD;
commands[120].fn = vgextend;
commands[120].ro_count = 0;
commands[120].rp_count = 2;
commands[120].oo_count = 23;
commands[120].op_count = 0;
commands[120].desc = "";
commands[120].usage = "vgextend VG PV ..."
...
commands[120].required_pos_args[1].pos = 2;
commands[120].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[120].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[120].optional_opt_args[10].opt = autobackup_ARG;
commands[120].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[120].optional_opt_args[11].opt = test_ARG;
commands[120].optional_opt_args[12].opt = force_ARG;
commands[120].optional_opt_args[13].opt = zero_ARG;
commands[120].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[120].optional_opt_args[14].opt = labelsector_ARG;
commands[120].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[120].optional_opt_args[15].opt = metadatatype_ARG;
commands[120].optional_opt_args[15].def.val_bits = val_enum_to_bit(metadatatype_VAL);
...
commands[120].optional_opt_args[17].opt = pvmetadatacopies_ARG;
commands[120].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[120].optional_opt_args[18].opt = metadataignore_ARG;
commands[120].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[120].optional_opt_args[19].opt = dataalignment_ARG;
commands[120].optional_opt_args[19].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[120].optional_opt_args[20].opt = dataalignmentoffset_ARG;
commands[120].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[120].optional_opt_args[21].opt = reportformat_ARG;
commands[120].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[120].optional_opt_args[22].opt = restoremissing_ARG;

commands[121].name = "vgimport";
commands[121].command_line_id = "vgimport_some";
commands[121].command_line_enum = vgimport_some_CMD;
...
commands[121].desc = "";
commands[121].usage = "vgimport VG|Tag|Select ..."
" [ --select String, --reportformat String ]";
commands[121].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[121].required_pos_args[0].pos = 1;
commands[121].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
...
commands[121].optional_opt_args[10].opt = select_ARG;
commands[121].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[122].name = "vgimport";
commands[122].command_line_id = "vgimport_all";
commands[122].command_line_enum = vgimport_all_CMD;
commands[122].fn = vgimport;
commands[122].ro_count = 1;
commands[122].rp_count = 0;
commands[122].oo_count = 13;
commands[122].op_count = 0;
commands[122].desc = "";
commands[122].usage = "vgimport --all"
" [ --reportformat String ]";
commands[122].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[122].required_opt_args[0].opt = all_ARG;
...
commands[122].optional_opt_args[10].opt = force_ARG;
commands[122].optional_opt_args[11].opt = reportformat_ARG;
commands[122].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[122].optional_opt_args[12].opt = test_ARG;

commands[123].name = "vgimportclone";
commands[123].command_line_id = "vgimportclone_general";
commands[123].command_line_enum = vgimportclone_general_CMD;
commands[123].fn = vgimportclone;
commands[123].ro_count = 0;
commands[123].rp_count = 1;
commands[123].oo_count = 13;
commands[123].op_count = 0;
commands[123].desc = "";
commands[123].usage = "vgimportclone PV ..."
" [ --basevgname VG, --import ]";
commands[123].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[123].required_pos_args[0].pos = 1;
commands[123].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
...
commands[123].optional_opt_args[10].opt = basevgname_ARG;
commands[123].optional_opt_args[10].def.val_bits = val_enum_to_bit(vg_VAL);
commands[123].optional_opt_args[11].opt = test_ARG;
commands[123].optional_opt_args[12].opt = import_ARG;

commands[124].name = "vgmerge";
commands[124].command_line_id = "vgmerge_general";
commands[124].command_line_enum = vgmerge_general_CMD;
commands[124].fn = vgmerge;
commands[124].ro_count = 0;
commands[124].rp_count = 2;
commands[124].oo_count = 13;
commands[124].op_count = 0;
commands[124].desc = "";
commands[124].usage = "vgmerge VG VG"
" [ --autobackup y|n, --list ]";
...
commands[124].required_pos_args[1].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[124].optional_opt_args[11].opt = list_ARG;
commands[124].optional_opt_args[12].opt = test_ARG;

commands[125].name = "vgmknodes";
commands[125].command_line_id = "vgmknodes_general";
commands[125].command_line_enum = vgmknodes_general_CMD;
commands[125].fn = vgmknodes;
commands[125].ro_count = 0;
commands[125].rp_count = 0;
commands[125].oo_count = 13;
commands[125].op_count = 1;
commands[125].desc = "";
commands[125].usage = "vgmknodes"
...
commands[125].optional_opt_args[10].opt = ignorelockingfailure_ARG;
commands[125].optional_opt_args[11].opt = refresh_ARG;
...
commands[125].optional_pos_args[0].pos = 1;
commands[125].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL);
commands[125].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[126].name = "vgreduce";
commands[126].command_line_id = "vgreduce_by_pv";
commands[126].command_line_enum = vgreduce_by_pv_CMD;
...
commands[126].desc = "";
commands[126].usage = "vgreduce VG PV ..."
" [ --autobackup y|n, --reportformat String ]";
...
commands[126].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[126].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[127].command_line_id = "vgreduce_all";
commands[127].command_line_enum = vgreduce_all_CMD;
commands[127].fn = vgreduce;
commands[127].ro_count = 1;
commands[127].rp_count = 1;
commands[127].oo_count = 14;
commands[127].op_count = 0;
commands[127].desc = "";
commands[127].usage = "vgreduce --all VG"
" [ --autobackup y|n, --reportformat String ]";
...
commands[127].optional_opt_args[11].opt = force_ARG;
...
commands[127].optional_opt_args[13].opt = test_ARG;

commands[128].name = "vgreduce";
commands[128].command_line_id = "vgreduce_missing";
commands[128].command_line_enum = vgreduce_missing_CMD;
commands[128].fn = vgreduce;
commands[128].ro_count = 1;
commands[128].rp_count = 1;
commands[128].oo_count = 15;
commands[128].op_count = 0;
commands[128].desc = "";
commands[128].usage = "vgreduce --removemissing VG"
" [ --mirrorsonly, --autobackup y|n, --reportformat String ]";
commands[128].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[128].required_opt_args[0].opt = removemissing_ARG;
...
commands[128].optional_opt_args[10].opt = mirrorsonly_ARG;
commands[128].optional_opt_args[11].opt = autobackup_ARG;
commands[128].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[128].optional_opt_args[12].opt = force_ARG;
commands[128].optional_opt_args[13].opt = reportformat_ARG;
commands[128].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[128].optional_opt_args[14].opt = test_ARG;

commands[129].name = "vgremove";
commands[129].command_line_id = "vgremove_general";
commands[129].command_line_enum = vgremove_general_CMD;
commands[129].fn = vgremove;
commands[129].ro_count = 0;
commands[129].rp_count = 1;
commands[129].oo_count = 15;
commands[129].op_count = 0;
commands[129].desc = "";
commands[129].usage = "vgremove VG|Tag|Select ..."
" [ --reportformat String, --select String ]";
commands[129].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[129].required_pos_args[0].pos = 1;
commands[129].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[129].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[129].optional_opt_args[10].opt = force_ARG;
commands[129].optional_opt_args[11].opt = noudevsync_ARG;
...
commands[129].optional_opt_args[13].opt = select_ARG;
commands[129].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[129].optional_opt_args[14].opt = test_ARG;

commands[130].name = "vgrename";
commands[130].command_line_id = "vgrename_by_name";
commands[130].command_line_enum = vgrename_by_name_CMD;
...
commands[130].desc = "";
commands[130].usage = "vgrename VG VG_new"
" [ --autobackup y|n, --reportformat String ]";
commands[130].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[130].required_pos_args[0].pos = 1;
commands[130].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[131].name = "vgrename";
commands[131].command_line_id = "vgrename_by_uuid";
commands[131].command_line_enum = vgrename_by_uuid_CMD;
commands[131].fn = vgrename;
commands[131].ro_count = 0;
commands[131].rp_count = 2;
commands[131].oo_count = 14;
commands[131].op_count = 0;
commands[131].desc = "";
commands[131].usage = "vgrename String VG_new"
" [ --autobackup y|n, --reportformat String ]";
commands[131].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[131].required_pos_args[0].pos = 1;
commands[131].required_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[131].required_pos_args[1].pos = 2;
commands[131].required_pos_args[1].def.val_bits = val_enum_to_bit(vg_VAL);
commands[131].required_pos_args[1].def.flags = ARG_DEF_FLAG_NEW;
...
commands[132].name = "vgs";
commands[132].command_line_id = "vgs_general";
commands[132].command_line_enum = vgs_general_CMD;
commands[132].fn = vgs;
...
commands[132].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL);
commands[132].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[133].name = "vgscan";
commands[133].command_line_id = "vgscan_general";
commands[133].command_line_enum = vgscan_general_CMD;
commands[133].fn = vgscan;
commands[133].ro_count = 0;
commands[133].rp_count = 0;
commands[133].oo_count = 16;
commands[133].op_count = 0;
commands[133].desc = "";
commands[133].usage = "vgscan"
...
commands[133].optional_opt_args[10].opt = cache_long_ARG;
commands[133].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[133].optional_opt_args[12].opt = mknodes_ARG;
commands[133].optional_opt_args[13].opt = notifydbus_ARG;
commands[133].optional_opt_args[14].opt = partial_ARG;
commands[133].optional_opt_args[15].opt = reportformat_ARG;
commands[133].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);

commands[134].name = "vgsplit";
commands[134].command_line_id = "vgsplit_by_pv";
commands[134].command_line_enum = vgsplit_by_pv_CMD;
commands[134].fn = vgsplit;
commands[134].ro_count = 0;
commands[134].rp_count = 3;
commands[134].oo_count = 18;
commands[134].op_count = 0;
commands[134].desc = "";
commands[134].usage = "vgsplit VG VG PV ..."
...
commands[134].required_pos_args[2].pos = 3;
commands[134].required_pos_args[2].def.val_bits = val_enum_to_bit(pv_VAL);
commands[134].required_pos_args[2].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[135].name = "vgsplit";
commands[135].command_line_id = "vgsplit_by_lv";
commands[135].command_line_enum = vgsplit_by_lv_CMD;
commands[135].fn = vgsplit;
commands[135].ro_count = 1;
commands[135].rp_count = 2;
commands[135].oo_count = 18;
commands[135].op_count = 0;
commands[135].desc = "";
commands[135].usage = "vgsplit --name LV VG VG"
" [ --autobackup y|n, --alloc contiguous|cling|normal|anywhere|inherit, --clustered y|n, --maxlogicalvolumes Number, --maxphysicalvolumes Number, --metadatatype lvm2|lvm1, --vgmetadatacopies all|unmanaged|Number ]";
commands[135].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[135].required_opt_args[0].opt = name_ARG;
commands[135].required_opt_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[135].optional_opt_args[11].opt = test_ARG;
commands[135].optional_opt_args[12].opt = alloc_ARG;
commands[135].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[135].optional_opt_args[13].opt = clustered_ARG;
commands[135].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[135].optional_opt_args[14].opt = maxlogicalvolumes_ARG;
commands[135].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[135].optional_opt_args[15].opt = maxphysicalvolumes_ARG;
commands[135].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[135].optional_opt_args[16].opt = metadatatype_ARG;
commands[135].optional_opt_args[16].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[135].optional_opt_args[17].opt = vgmetadatacopies_ARG;
commands[135].optional_opt_args[17].def.val_bits = val_enum_to_bit(metadatacopies_VAL);

commands[136].name = "config";
commands[136].command_line_id = "lvmconfig_general";
commands[136].command_line_enum = lvmconfig_general_CMD;
commands[136].fn = config;
commands[136].ro_count = 0;
commands[136].rp_count = 0;
commands[136].oo_count = 28;
commands[136].op_count = 1;
commands[136].desc = "";
commands[136].usage = "config"
" [ --atversion String, --typeconfig String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions ]"
" [ String ... ]";
...
commands[137].name = "dumpconfig";
commands[137].command_line_id = "lvmconfig_general";
commands[137].command_line_enum = lvmconfig_general_CMD;
commands[137].fn = dumpconfig;
commands[137].ro_count = 0;
commands[137].rp_count = 0;
commands[137].oo_count = 28;
commands[137].op_count = 1;
commands[137].desc = "";
commands[137].usage = "dumpconfig"
" [ --atversion String, --typeconfig String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions ]"
" [ String ... ]";
...
commands[137].optional_opt_args[10].opt = atversion_ARG;
commands[137].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_opt_args[11].opt = configtype_ARG;
commands[137].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_opt_args[12].opt = file_ARG;
commands[137].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_opt_args[13].opt = ignoreadvanced_ARG;
commands[137].optional_opt_args[14].opt = ignoreunsupported_ARG;
commands[137].optional_opt_args[15].opt = ignorelocal_ARG;
commands[137].optional_opt_args[16].opt = list_ARG;
commands[137].optional_opt_args[17].opt = mergedconfig_ARG;
commands[137].optional_opt_args[18].opt = metadataprofile_ARG;
commands[137].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_opt_args[19].opt = sinceversion_ARG;
commands[137].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_opt_args[20].opt = showdeprecated_ARG;
commands[137].optional_opt_args[21].opt = showunsupported_ARG;
commands[137].optional_opt_args[22].opt = validate_ARG;
commands[137].optional_opt_args[23].opt = withsummary_ARG;
commands[137].optional_opt_args[24].opt = withcomments_ARG;
commands[137].optional_opt_args[25].opt = withspaces_ARG;
commands[137].optional_opt_args[26].opt = unconfigured_ARG;
commands[137].optional_opt_args[27].opt = withversions_ARG;
commands[137].optional_pos_args[0].pos = 1;
commands[137].optional_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[137].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[138].name = "devtypes";
commands[138].command_line_id = "devtypes_general";
commands[138].command_line_enum = devtypes_general_CMD;
commands[138].fn = devtypes;
commands[138].ro_count = 0;
commands[138].rp_count = 0;
commands[138].oo_count = 23;
commands[138].op_count = 0;
commands[138].desc = "";
commands[138].usage = "devtypes"
...
commands[138].optional_opt_args[11].opt = binary_ARG;
commands[138].optional_opt_args[12].opt = nameprefixes_ARG;
commands[138].optional_opt_args[13].opt = noheadings_ARG;
commands[138].optional_opt_args[14].opt = nosuffix_ARG;
commands[138].optional_opt_args[15].opt = options_ARG;
commands[138].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[16].opt = reportformat_ARG;
commands[138].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[17].opt = rows_ARG;
commands[138].optional_opt_args[18].opt = select_ARG;
commands[138].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[19].opt = separator_ARG;
commands[138].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[20].opt = sort_ARG;
commands[138].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[21].opt = unbuffered_ARG;
commands[138].optional_opt_args[22].opt = unquoted_ARG;

commands[139].name = "fullreport";
commands[139].command_line_id = "fullreport_general";
commands[139].command_line_enum = fullreport_general_CMD;
commands[139].fn = fullreport;
commands[139].ro_count = 0;
commands[139].rp_count = 0;
commands[139].oo_count = 35;
commands[139].op_count = 1;
commands[139].desc = "";
commands[139].usage = "fullreport"
" [ --aligned, --all, --binary, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --nameprefixes, --noheadings, --nolocking, --nosuffix, --options String, --partial, --readonly, --reportformat String, --rows, --select String, --separator String, --shared, --sort String, --trustcache, --unbuffered, --units hHbBsSkKmMgGtTpPeE, --unquoted ]"
" [ VG ... ]";
...
commands[139].optional_opt_args[10].opt = aligned_ARG;
commands[139].optional_opt_args[11].opt = all_ARG;
commands[139].optional_opt_args[12].opt = binary_ARG;
commands[139].optional_opt_args[13].opt = configreport_ARG;
commands[139].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[14].opt = foreign_ARG;
commands[139].optional_opt_args[15].opt = ignorelockingfailure_ARG;
commands[139].optional_opt_args[16].opt = ignoreskippedcluster_ARG;
commands[139].optional_opt_args[17].opt = logonly_ARG;
commands[139].optional_opt_args[18].opt = nameprefixes_ARG;
commands[139].optional_opt_args[19].opt = noheadings_ARG;
commands[139].optional_opt_args[20].opt = nolocking_ARG;
commands[139].optional_opt_args[21].opt = nosuffix_ARG;
commands[139].optional_opt_args[22].opt = options_ARG;
commands[139].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[23].opt = partial_ARG;
commands[139].optional_opt_args[24].opt = readonly_ARG;
commands[139].optional_opt_args[25].opt = reportformat_ARG;
commands[139].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[26].opt = rows_ARG;
commands[139].optional_opt_args[27].opt = select_ARG;
commands[139].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[28].opt = separator_ARG;
commands[139].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[29].opt = shared_ARG;
commands[139].optional_opt_args[30].opt = sort_ARG;
commands[139].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].optional_opt_args[31].opt = trustcache_ARG;
commands[139].optional_opt_args[32].opt = unbuffered_ARG;
commands[139].optional_opt_args[33].opt = units_ARG;
commands[139].optional_opt_args[33].def.val_bits = val_enum_to_bit(units_VAL);
commands[139].optional_opt_args[34].opt = unquoted_ARG;
commands[139].optional_pos_args[0].pos = 1;
commands[139].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[139].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[140].name = "lastlog";
commands[140].command_line_id = "lastlog_general";
commands[140].command_line_enum = lastlog_general_CMD;
commands[140].fn = lastlog;
commands[140].ro_count = 0;
commands[140].rp_count = 0;
commands[140].oo_count = 12;
commands[140].op_count = 0;
commands[140].desc = "";
commands[140].usage = "lastlog"
" [ --reportformat String, --select String ]";
...
commands[140].optional_opt_args[10].opt = reportformat_ARG;
commands[140].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[140].optional_opt_args[11].opt = select_ARG;
commands[140].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);

commands[141].name = "lvpoll";
commands[141].command_line_id = "lvpoll_general";
commands[141].command_line_enum = lvpoll_general_CMD;
commands[141].fn = lvpoll;
commands[141].ro_count = 1;
commands[141].rp_count = 1;
commands[141].oo_count = 15;
commands[141].op_count = 0;
commands[141].desc = "";
commands[141].usage = "lvpoll --polloperation String LV ..."
" [ --abort, --autobackup y|n, --handlemissingpvs, --interval Number ]";
commands[141].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[141].required_opt_args[0].opt = polloperation_ARG;
commands[141].required_opt_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[141].required_pos_args[0].pos = 1;
commands[141].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[141].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[141].optional_opt_args[10].opt = abort_ARG;
commands[141].optional_opt_args[11].opt = autobackup_ARG;
commands[141].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[141].optional_opt_args[12].opt = handlemissingpvs_ARG;
commands[141].optional_opt_args[13].opt = interval_ARG;
commands[141].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[141].optional_opt_args[14].opt = test_ARG;

commands[142].name = "formats";
commands[142].command_line_id = "formats_general";
commands[142].command_line_enum = formats_general_CMD;
commands[142].fn = formats;
commands[142].ro_count = 0;
commands[142].rp_count = 0;
commands[142].oo_count = 10;
commands[142].op_count = 0;
commands[142].desc = "";
commands[142].usage = "formats";
...
commands[143].name = "help";
commands[143].command_line_id = "help_general";
commands[143].command_line_enum = help_general_CMD;
commands[143].fn = help;
commands[143].ro_count = 0;
commands[143].rp_count = 0;
commands[143].oo_count = 10;
commands[143].op_count = 0;
commands[143].desc = "";
commands[143].usage = "help";
...
commands[144].name = "version";
commands[144].command_line_id = "version_general";
commands[144].command_line_enum = version_general_CMD;
commands[144].fn = version;
commands[144].ro_count = 0;
commands[144].rp_count = 0;
commands[144].oo_count = 10;
commands[144].op_count = 0;
commands[144].desc = "";
commands[144].usage = "version";
...
commands[145].name = "pvdata";
commands[145].command_line_id = "pvdata_general";
commands[145].command_line_enum = pvdata_general_CMD;
commands[145].fn = pvdata;
commands[145].ro_count = 0;
commands[145].rp_count = 0;
commands[145].oo_count = 10;
commands[145].op_count = 0;
commands[145].desc = "";
commands[145].usage = "pvdata";
...
commands[146].name = "segtypes";
commands[146].command_line_id = "segtypes_general";
commands[146].command_line_enum = segtypes_general_CMD;
commands[146].fn = segtypes;
commands[146].ro_count = 0;
commands[146].rp_count = 0;
commands[146].oo_count = 10;
commands[146].op_count = 0;
commands[146].desc = "";
commands[146].usage = "segtypes";
...
commands[147].name = "systemid";
commands[147].command_line_id = "systemid_general";
commands[147].command_line_enum = systemid_general_CMD;
commands[147].fn = systemid;
commands[147].ro_count = 0;
commands[147].rp_count = 0;
commands[147].oo_count = 10;
commands[147].op_count = 0;
commands[147].desc = "";
commands[147].usage = "systemid";
...
commands[148].name = "tags";
commands[148].command_line_id = "tags_general";
commands[148].command_line_enum = tags_general_CMD;
commands[148].fn = tags;
commands[148].ro_count = 0;
commands[148].rp_count = 0;
commands[148].oo_count = 10;
commands[148].op_count = 0;
commands[148].desc = "";
commands[148].usage = "tags";
...
commands[149].name = "lvmchange";
commands[149].command_line_id = "lvmchange_general";
commands[149].command_line_enum = lvmchange_general_CMD;
commands[149].fn = lvmchange;
commands[149].ro_count = 0;
commands[149].rp_count = 0;
commands[149].oo_count = 10;
commands[149].op_count = 0;
commands[149].desc = "";
commands[149].usage = "lvmchange";
...
commands[150].name = "lvmdiskscan";
commands[150].command_line_id = "lvmdiskscan_general";
commands[150].command_line_enum = lvmdiskscan_general_CMD;
commands[150].fn = lvmdiskscan;
commands[150].ro_count = 0;
commands[150].rp_count = 0;
commands[150].oo_count = 12;
commands[150].op_count = 0;
commands[150].desc = "";
commands[150].usage = "lvmdiskscan"
...
commands[150].optional_opt_args[10].opt = lvmpartition_ARG;
commands[150].optional_opt_args[11].opt = readonly_ARG;

commands[151].name = "lvmsadc";
commands[151].command_line_id = "lvmsadc_general";
commands[151].command_line_enum = lvmsadc_general_CMD;
commands[151].fn = lvmsadc;
commands[151].ro_count = 0;
commands[151].rp_count = 0;
commands[151].oo_count = 10;
commands[151].op_count = 0;
commands[151].desc = "";
commands[151].usage = "lvmsadc";
...
commands[152].name = "lvmsar";
commands[152].command_line_id = "lvmsar_general";
commands[152].command_line_enum = lvmsar_general_CMD;
commands[152].fn = lvmsar;
commands[152].ro_count = 0;
commands[152].rp_count = 0;
commands[152].oo_count = 12;
commands[152].op_count = 0;
commands[152].desc = "";
commands[152].usage = "lvmsar"
" [ --full, --stdin ]";
commands[152].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[152].optional_opt_args[0].opt = commandprofile_ARG;
commands[152].optional_opt_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[152].optional_opt_args[1].opt = config_ARG;
commands[152].optional_opt_args[1].def.val_bits = val_enum_to_bit(string_VAL);
commands[152].optional_opt_args[2].opt = debug_ARG;
commands[152].optional_opt_args[3].opt = driverloaded_ARG;
commands[152].optional_opt_args[3].def.val_bits = val_enum_to_bit(bool_VAL);
commands[152].optional_opt_args[4].opt = help_ARG;
commands[152].optional_opt_args[5].opt = profile_ARG;
commands[152].optional_opt_args[5].def.val_bits = val_enum_to_bit(string_VAL);
commands[152].optional_opt_args[6].opt = quiet_ARG;
commands[152].optional_opt_args[7].opt = verbose_ARG;
commands[152].optional_opt_args[8].opt = version_ARG;
commands[152].optional_opt_args[9].opt = yes_ARG;
commands[152].optional_opt_args[10].opt = full_ARG;
commands[152].optional_opt_args[11].opt = stdin_ARG;
