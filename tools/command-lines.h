...
" [ --commandprofile String, --config String, --driverloaded y|n, --ignorelockingfailure, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --sysinit, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
...
commands[1].desc = "DESC: Resyncronize a mirror or raid LV.";
commands[1].usage = "lvchange --resync VG|LV_mirror_raid|Tag|Select ..."
" [ COMMON_OPTIONS ]";
...
commands[1].required_pos_args[0].def.lv_types = ARG_DEF_LV_MIRROR | ARG_DEF_LV_RAID;
...
commands[2].desc = "DESC: Resynchronize or check a raid LV.";
commands[2].usage = "lvchange --syncaction String VG|LV_raid|Tag|Select ..."
" [ COMMON_OPTIONS ]";
...
commands[2].required_pos_args[0].def.lv_types = ARG_DEF_LV_RAID;
...
commands[3].desc = "DESC: Reconstruct data on specific PVs of a raid LV.";
commands[3].usage = "lvchange --rebuild PV VG|LV_raid|Tag|Select ..."
" [ COMMON_OPTIONS ]";
...
commands[3].required_pos_args[0].def.lv_types = ARG_DEF_LV_RAID;
...
commands[5].oo_count = 21;
commands[5].op_count = 0;
commands[5].desc = "DESC: Reactivate an LV using the latest metadata.";
commands[5].usage = "lvchange --refresh VG|LV|Tag|Select ..."
" [ --partial, COMMON_OPTIONS ]";
...
commands[5].optional_opt_args[10].opt = partial_ARG;
commands[5].optional_opt_args[11].opt = autobackup_ARG;
commands[5].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[12].opt = force_ARG;
commands[5].optional_opt_args[13].opt = ignorelockingfailure_ARG;
commands[5].optional_opt_args[14].opt = ignoremonitoring_ARG;
commands[5].optional_opt_args[15].opt = ignoreskippedcluster_ARG;
commands[5].optional_opt_args[16].opt = noudevsync_ARG;
commands[5].optional_opt_args[17].opt = reportformat_ARG;
commands[5].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[18].opt = sysinit_ARG;
commands[5].optional_opt_args[19].opt = test_ARG;
commands[5].optional_opt_args[20].opt = select_ARG;
commands[5].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[6].desc = "DESC: Start or stop monitoring an LV from dmeventd.";
commands[6].usage = "lvchange --monitor y|n VG|LV|Tag|Select ..."
" [ --poll y|n, COMMON_OPTIONS ]";
...
commands[7].desc = "DESC: Start or stop processing an LV conversion.";
commands[7].usage = "lvchange --poll y|n VG|LV|Tag|Select ..."
" [ --monitor y|n, COMMON_OPTIONS ]";
...
commands[8].desc = "DESC: Make the minor device number persistent for an LV.";
commands[8].usage = "lvchange --persistent y|n VG|LV|Tag|Select ..."
" [ --minor Number, --major Number, COMMON_OPTIONS ]";
...
" [ --interval Number, COMMON_OPTIONS ]";
commands[9].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --noudevsync, --profile String, --usepolicies, --version, --background, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
...
commands[9].optional_opt_args[13].opt = background_ARG;
commands[9].optional_opt_args[14].opt = force_ARG;
commands[9].optional_opt_args[15].opt = noudevsync_ARG;
commands[9].optional_opt_args[16].opt = test_ARG;
commands[9].optional_opt_args[17].opt = usepolicies_ARG;
...
" [ --chunksize Number[k|unit], --zero y|n, COMMON_OPTIONS ]";
...
" [ --thin, --originname LV_new, --zero y|n, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], COMMON_OPTIONS ]";
...
" [ --type thin, --originname LV_new, --zero y|n, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], COMMON_OPTIONS ]";
...
" [ --cache, --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --zero y|n, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], COMMON_OPTIONS ]";
...
" [ --type cache, --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --zero y|n, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], COMMON_OPTIONS ]";
...
" [ --stripes Number, --stripesize Number[k|unit], --discards passdown|nopassdown|ignore, --zero y|n, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], COMMON_OPTIONS ]";
...
" [ --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, COMMON_OPTIONS ]";
...
" [ --type cache-pool, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, COMMON_OPTIONS ]";
...
" [ --mirrorlog core|disk, --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --interval Number, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[21].command_line_id = "lvconvert_to_mirror";
commands[21].command_line_enum = lvconvert_to_mirror_CMD;
commands[21].fn = lvconvert;
commands[21].ro_count = 1;
commands[21].rp_count = 1;
commands[21].oo_count = 22;
commands[21].op_count = 1;
commands[21].desc = "DESC: Convert LV from type raid1 to type mirror.";
commands[21].usage = "lvconvert --type mirror LV_raid1"
" [ --mirrors [+|-]Number, --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --interval Number, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[21].optional_opt_args[11].opt = mirrors_ARG;
commands[21].optional_opt_args[11].def.val_bits = val_enum_to_bit(numsigned_VAL);
commands[21].optional_opt_args[12].opt = stripes_long_ARG;
commands[21].optional_opt_args[12].def.val_bits = val_enum_to_bit(number_VAL);
commands[21].optional_opt_args[13].opt = stripesize_ARG;
commands[21].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[21].optional_opt_args[14].opt = regionsize_ARG;
commands[21].optional_opt_args[14].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[21].optional_opt_args[15].opt = interval_ARG;
commands[21].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[21].optional_opt_args[16].opt = alloc_ARG;
commands[21].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[21].optional_opt_args[17].opt = background_ARG;
commands[21].optional_opt_args[18].opt = force_ARG;
commands[21].optional_opt_args[19].opt = noudevsync_ARG;
commands[21].optional_opt_args[20].opt = test_ARG;
commands[21].optional_opt_args[21].opt = usepolicies_ARG;
...
commands[22].command_line_id = "lvconvert_general_to_raid";
commands[22].command_line_enum = lvconvert_general_to_raid_CMD;
commands[22].fn = lvconvert;
commands[22].ro_count = 1;
commands[22].rp_count = 1;
commands[22].oo_count = 21;
commands[22].op_count = 1;
commands[22].desc = "DESC: Convert LV to type raid.  DESC: Change LV between raid types.";
commands[22].usage = "lvconvert --type raid LV_linear_striped_mirror_raid"
" [ --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --interval Number, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[22].required_opt_args[0].def.str = "raid";
...
commands[22].optional_opt_args[14].opt = interval_ARG;
commands[22].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[22].optional_opt_args[15].opt = alloc_ARG;
commands[22].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[22].optional_opt_args[16].opt = background_ARG;
commands[22].optional_opt_args[17].opt = force_ARG;
commands[22].optional_opt_args[18].opt = noudevsync_ARG;
commands[22].optional_opt_args[19].opt = test_ARG;
commands[22].optional_opt_args[20].opt = usepolicies_ARG;
...
commands[23].command_line_id = "lvconvert_to_mirrored_or_change_image_count";
commands[23].command_line_enum = lvconvert_to_mirrored_or_change_image_count_CMD;
commands[23].fn = lvconvert;
commands[23].ro_count = 1;
commands[23].rp_count = 1;
commands[23].oo_count = 24;
commands[23].op_count = 1;
commands[23].desc = "DESC: Change the number of mirror images in a raid1 or mirror LV.  DESC: Convert a linear or striped LV to type raid1 or mirror  DESC: (variant, infers --type raid1|mirror).";
commands[23].usage = "lvconvert --mirrors [+|-]Number LV_linear_striped_mirror_raid"
" [ --type raid1, --type mirror, --mirrorlog core|disk, --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --interval Number, COMMON_OPTIONS ]"
" [ PV ... ]";
commands[23].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --noudevsync, --profile String, --usepolicies, --version, --background, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[23].required_opt_args[0].opt = mirrors_ARG;
commands[23].required_opt_args[0].def.val_bits = val_enum_to_bit(numsigned_VAL);
commands[23].required_pos_args[0].pos = 1;
commands[23].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[23].required_pos_args[0].def.lv_types = ARG_DEF_LV_LINEAR | ARG_DEF_LV_STRIPED | ARG_DEF_LV_MIRROR | ARG_DEF_LV_RAID;
...
commands[23].optional_opt_args[10].opt = type_ARG;
commands[23].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[23].optional_opt_args[10].def.str = "raid1";
commands[23].optional_opt_args[11].opt = type_ARG;
commands[23].optional_opt_args[11].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[23].optional_opt_args[11].def.str = "mirror";
commands[23].optional_opt_args[12].opt = mirrorlog_ARG;
commands[23].optional_opt_args[12].def.val_bits = val_enum_to_bit(mirrorlog_VAL);
commands[23].optional_opt_args[13].opt = mirrors_ARG;
commands[23].optional_opt_args[13].def.val_bits = val_enum_to_bit(numsigned_VAL);
commands[23].optional_opt_args[14].opt = stripes_long_ARG;
commands[23].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[23].optional_opt_args[15].opt = stripesize_ARG;
commands[23].optional_opt_args[15].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[23].optional_opt_args[16].opt = regionsize_ARG;
commands[23].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[23].optional_opt_args[17].opt = interval_ARG;
commands[23].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[23].optional_opt_args[18].opt = alloc_ARG;
commands[23].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[23].optional_opt_args[19].opt = background_ARG;
commands[23].optional_opt_args[20].opt = force_ARG;
commands[23].optional_opt_args[21].opt = noudevsync_ARG;
commands[23].optional_opt_args[22].opt = test_ARG;
commands[23].optional_opt_args[23].opt = usepolicies_ARG;
...
commands[24].command_line_id = "lvconvert_raid_to_striped";
commands[24].command_line_enum = lvconvert_raid_to_striped_CMD;
commands[24].fn = lvconvert;
commands[24].ro_count = 1;
commands[24].rp_count = 1;
commands[24].oo_count = 21;
commands[24].op_count = 1;
commands[24].desc = "DESC: Convert LV to type striped.";
commands[24].usage = "lvconvert --type striped LV_raid"
" [ --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --interval Number, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[24].required_opt_args[0].def.str = "striped";
commands[24].required_pos_args[0].pos = 1;
commands[24].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[24].required_pos_args[0].def.lv_types = ARG_DEF_LV_RAID;
...
commands[24].optional_opt_args[14].opt = interval_ARG;
commands[24].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[24].optional_opt_args[15].opt = alloc_ARG;
commands[24].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[24].optional_opt_args[16].opt = background_ARG;
commands[24].optional_opt_args[17].opt = force_ARG;
commands[24].optional_opt_args[18].opt = noudevsync_ARG;
commands[24].optional_opt_args[19].opt = test_ARG;
commands[24].optional_opt_args[20].opt = usepolicies_ARG;
...
commands[25].oo_count = 16;
commands[25].op_count = 0;
commands[25].desc = "DESC: Convert LV to type linear.";
commands[25].usage = "lvconvert --type linear LV_mirror_raid"
" [ COMMON_OPTIONS ]";
...
commands[25].required_opt_args[0].def.str = "linear";
...
commands[25].optional_opt_args[10].opt = alloc_ARG;
commands[25].optional_opt_args[10].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[25].optional_opt_args[11].opt = background_ARG;
commands[25].optional_opt_args[12].opt = force_ARG;
commands[25].optional_opt_args[13].opt = noudevsync_ARG;
commands[25].optional_opt_args[14].opt = test_ARG;
commands[25].optional_opt_args[15].opt = usepolicies_ARG;
...
commands[26].oo_count = 18;
commands[26].op_count = 0;
commands[26].desc = "DESC: Convert LV to type linear (variant, infers --type linear).";
commands[26].usage = "lvconvert --mirrors 0 LV_mirror_raid"
" [ --type linear, --type mirror, COMMON_OPTIONS ]";
commands[26].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --noudevsync, --profile String, --usepolicies, --version, --background, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[26].required_opt_args[0].opt = mirrors_ARG;
commands[26].required_opt_args[0].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[26].required_opt_args[0].def.num = 0;
...
commands[26].optional_opt_args[10].opt = type_ARG;
commands[26].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[26].optional_opt_args[10].def.str = "linear";
commands[26].optional_opt_args[11].opt = type_ARG;
commands[26].optional_opt_args[11].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[26].optional_opt_args[11].def.str = "mirror";
commands[26].optional_opt_args[12].opt = alloc_ARG;
commands[26].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[26].optional_opt_args[13].opt = background_ARG;
commands[26].optional_opt_args[14].opt = force_ARG;
commands[26].optional_opt_args[15].opt = noudevsync_ARG;
commands[26].optional_opt_args[16].opt = test_ARG;
commands[26].optional_opt_args[17].opt = usepolicies_ARG;
...
commands[28].optional_pos_args[0].pos = 2;
commands[28].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[28].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[31].desc = "DESC: Change the type of mirror log used by a mirror LV.";
...
commands[32].desc = "DESC: Separate and keep the cache pool from a cache LV.";
...
commands[33].desc = "DESC: Separate and delete the cache pool from a cache LV.";
...
commands[35].desc = "DESC: Poll mirror LV to collapse resync layers.";
...
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
...
" [ --mirrors 0, --stripes 1, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[39].optional_opt_args[10].opt = mirrors_ARG;
commands[39].optional_opt_args[10].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[39].optional_opt_args[10].def.num = 0;
commands[39].optional_opt_args[11].opt = stripes_ARG;
commands[39].optional_opt_args[11].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[39].optional_opt_args[11].def.num = 1;
commands[39].optional_opt_args[12].opt = addtag_ARG;
commands[39].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[39].optional_opt_args[13].opt = alloc_ARG;
commands[39].optional_opt_args[13].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[39].optional_opt_args[14].opt = autobackup_ARG;
commands[39].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[15].opt = activate_ARG;
commands[39].optional_opt_args[15].def.val_bits = val_enum_to_bit(activation_VAL);
commands[39].optional_opt_args[16].opt = contiguous_ARG;
commands[39].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[17].opt = ignoreactivationskip_ARG;
commands[39].optional_opt_args[18].opt = ignoremonitoring_ARG;
commands[39].optional_opt_args[19].opt = major_ARG;
commands[39].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[39].optional_opt_args[20].opt = metadataprofile_ARG;
commands[39].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
commands[39].optional_opt_args[21].opt = minor_ARG;
commands[39].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[39].optional_opt_args[22].opt = monitor_ARG;
commands[39].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[23].opt = name_ARG;
commands[39].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[39].optional_opt_args[24].opt = nosync_ARG;
commands[39].optional_opt_args[25].opt = noudevsync_ARG;
commands[39].optional_opt_args[26].opt = permission_ARG;
commands[39].optional_opt_args[26].def.val_bits = val_enum_to_bit(permission_VAL);
commands[39].optional_opt_args[27].opt = persistent_ARG;
commands[39].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[28].opt = readahead_ARG;
commands[39].optional_opt_args[28].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[39].optional_opt_args[29].opt = reportformat_ARG;
commands[39].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[39].optional_opt_args[30].opt = setactivationskip_ARG;
commands[39].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[31].opt = test_ARG;
commands[39].optional_opt_args[32].opt = wipesignatures_ARG;
commands[39].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[39].optional_opt_args[33].opt = zero_ARG;
...
" [ --type linear, --mirrors 0, --stripes 1, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[40].optional_opt_args[11].opt = mirrors_ARG;
commands[40].optional_opt_args[11].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[40].optional_opt_args[11].def.num = 0;
commands[40].optional_opt_args[12].opt = stripes_ARG;
commands[40].optional_opt_args[12].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[40].optional_opt_args[12].def.num = 1;
commands[40].optional_opt_args[13].opt = addtag_ARG;
commands[40].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[40].optional_opt_args[14].opt = alloc_ARG;
commands[40].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[40].optional_opt_args[15].opt = autobackup_ARG;
commands[40].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[16].opt = activate_ARG;
commands[40].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[40].optional_opt_args[17].opt = contiguous_ARG;
commands[40].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[40].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[40].optional_opt_args[20].opt = major_ARG;
commands[40].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[40].optional_opt_args[21].opt = metadataprofile_ARG;
commands[40].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[40].optional_opt_args[22].opt = minor_ARG;
commands[40].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[40].optional_opt_args[23].opt = monitor_ARG;
commands[40].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[24].opt = name_ARG;
commands[40].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[40].optional_opt_args[25].opt = nosync_ARG;
commands[40].optional_opt_args[26].opt = noudevsync_ARG;
commands[40].optional_opt_args[27].opt = permission_ARG;
commands[40].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[40].optional_opt_args[28].opt = persistent_ARG;
commands[40].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[29].opt = readahead_ARG;
commands[40].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[40].optional_opt_args[30].opt = reportformat_ARG;
commands[40].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[40].optional_opt_args[31].opt = setactivationskip_ARG;
commands[40].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[32].opt = test_ARG;
commands[40].optional_opt_args[33].opt = wipesignatures_ARG;
commands[40].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[40].optional_opt_args[34].opt = zero_ARG;
commands[40].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
...
" [ --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
" [ --type striped, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[43].desc = "DESC: Create a mirror LV (also see --type raid1).";
commands[43].usage = "lvcreate --type mirror --size Number[m|unit] VG"
" [ --mirrors [+|-]Number, --mirrorlog core|disk, --regionsize Number[m|unit], --stripes Number, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[43].optional_opt_args[12].opt = regionsize_ARG;
commands[43].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[44].command_line_id = "lvcreate_mirror_or_raid1";
commands[44].command_line_enum = lvcreate_mirror_or_raid1_CMD;
...
" [ --type raid1, --type mirror, --mirrorlog core|disk, --stripes Number, --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --minrecoveryrate Number[k|unit], --maxrecoveryrate Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[44].optional_opt_args[13].opt = stripes_ARG;
commands[44].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
...
" [ --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --minrecoveryrate Number[k|unit], --maxrecoveryrate Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
" [ --snapshot, --stripes Number, --stripesize Number[k|unit], --chunksize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
" [ --type snapshot, --stripes Number, --stripesize Number[k|unit], --chunksize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
" [ --snapshot, --chunksize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[48].optional_opt_args[11].opt = chunksize_ARG;
commands[48].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[49].desc = "DESC: Create a sparse COW snapshot LV of a virtual origin LV  DESC: (infers --type snapshot).";
commands[49].usage = "lvcreate --snapshot --size Number[m|unit] --virtualsize Number[m|unit] VG"
" [ --type snapshot, --chunksize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[49].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[49].required_opt_args[0].opt = snapshot_ARG;
...
commands[49].optional_opt_args[10].opt = type_ARG;
commands[49].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[49].optional_opt_args[10].def.str = "snapshot";
...
" [ --thinpool LV_new, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[50].optional_opt_args[10].opt = thinpool_ARG;
commands[50].optional_opt_args[10].def.val_bits = val_enum_to_bit(lv_VAL);
commands[50].optional_opt_args[10].def.flags = ARG_DEF_FLAG_NEW;
...
commands[50].optional_opt_args[16].opt = mirrors_ARG;
commands[50].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[50].optional_opt_args[16].def.num = 0;
commands[50].optional_opt_args[17].opt = addtag_ARG;
commands[50].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[50].optional_opt_args[18].opt = alloc_ARG;
commands[50].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[50].optional_opt_args[19].opt = autobackup_ARG;
commands[50].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[20].opt = activate_ARG;
commands[50].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[50].optional_opt_args[21].opt = contiguous_ARG;
commands[50].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[50].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[50].optional_opt_args[24].opt = major_ARG;
commands[50].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[50].optional_opt_args[25].opt = metadataprofile_ARG;
commands[50].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[50].optional_opt_args[26].opt = minor_ARG;
commands[50].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[50].optional_opt_args[27].opt = monitor_ARG;
commands[50].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[28].opt = name_ARG;
commands[50].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[50].optional_opt_args[29].opt = nosync_ARG;
commands[50].optional_opt_args[30].opt = noudevsync_ARG;
commands[50].optional_opt_args[31].opt = permission_ARG;
commands[50].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[50].optional_opt_args[32].opt = persistent_ARG;
commands[50].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[33].opt = readahead_ARG;
commands[50].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[50].optional_opt_args[34].opt = reportformat_ARG;
commands[50].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[50].optional_opt_args[35].opt = setactivationskip_ARG;
commands[50].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[36].opt = test_ARG;
commands[50].optional_opt_args[37].opt = wipesignatures_ARG;
commands[50].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[38].opt = zero_ARG;
commands[50].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[50].optional_opt_args[39].opt = stripes_ARG;
commands[50].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[50].optional_opt_args[40].opt = stripesize_ARG;
commands[50].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[51].desc = "DESC: Create a thin pool (variant, infers --type thin-pool).";
commands[51].usage = "lvcreate --thin --size Number[m|unit] VG"
" [ --type thin-pool, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[51].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[51].required_opt_args[0].opt = thin_ARG;
...
commands[51].optional_opt_args[10].opt = type_ARG;
commands[51].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[51].optional_opt_args[10].def.str = "thin-pool";
...
commands[52].oo_count = 42;
commands[52].op_count = 1;
commands[52].desc = "DESC: Create a thin pool named by the --thinpool arg  DESC: (variant, infers --type thin-pool).";
commands[52].usage = "lvcreate --size Number[m|unit] --thinpool LV_new VG"
" [ --thin, --type thin-pool, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[52].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[52].required_opt_args[0].opt = size_ARG;
commands[52].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[52].required_opt_args[1].opt = thinpool_ARG;
commands[52].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[52].required_opt_args[1].def.flags = ARG_DEF_FLAG_NEW;
...
commands[52].optional_opt_args[10].opt = thin_ARG;
commands[52].optional_opt_args[11].opt = type_ARG;
commands[52].optional_opt_args[11].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[52].optional_opt_args[11].def.str = "thin-pool";
commands[52].optional_opt_args[12].opt = poolmetadatasize_ARG;
commands[52].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[52].optional_opt_args[13].opt = poolmetadataspare_ARG;
commands[52].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[14].opt = chunksize_ARG;
commands[52].optional_opt_args[14].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[52].optional_opt_args[15].opt = discards_ARG;
commands[52].optional_opt_args[15].def.val_bits = val_enum_to_bit(discards_VAL);
commands[52].optional_opt_args[16].opt = errorwhenfull_ARG;
commands[52].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[17].opt = mirrors_ARG;
commands[52].optional_opt_args[17].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[52].optional_opt_args[17].def.num = 0;
commands[52].optional_opt_args[18].opt = addtag_ARG;
commands[52].optional_opt_args[18].def.val_bits = val_enum_to_bit(tag_VAL);
commands[52].optional_opt_args[19].opt = alloc_ARG;
commands[52].optional_opt_args[19].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[52].optional_opt_args[20].opt = autobackup_ARG;
commands[52].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[21].opt = activate_ARG;
commands[52].optional_opt_args[21].def.val_bits = val_enum_to_bit(activation_VAL);
commands[52].optional_opt_args[22].opt = contiguous_ARG;
commands[52].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[23].opt = ignoreactivationskip_ARG;
commands[52].optional_opt_args[24].opt = ignoremonitoring_ARG;
commands[52].optional_opt_args[25].opt = major_ARG;
commands[52].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[52].optional_opt_args[26].opt = metadataprofile_ARG;
commands[52].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[27].opt = minor_ARG;
commands[52].optional_opt_args[27].def.val_bits = val_enum_to_bit(number_VAL);
commands[52].optional_opt_args[28].opt = monitor_ARG;
commands[52].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[29].opt = name_ARG;
commands[52].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[30].opt = nosync_ARG;
commands[52].optional_opt_args[31].opt = noudevsync_ARG;
commands[52].optional_opt_args[32].opt = permission_ARG;
commands[52].optional_opt_args[32].def.val_bits = val_enum_to_bit(permission_VAL);
commands[52].optional_opt_args[33].opt = persistent_ARG;
commands[52].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[34].opt = readahead_ARG;
commands[52].optional_opt_args[34].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[52].optional_opt_args[35].opt = reportformat_ARG;
commands[52].optional_opt_args[35].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[36].opt = setactivationskip_ARG;
commands[52].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[37].opt = test_ARG;
commands[52].optional_opt_args[38].opt = wipesignatures_ARG;
commands[52].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[39].opt = zero_ARG;
commands[52].optional_opt_args[39].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[40].opt = stripes_ARG;
commands[52].optional_opt_args[40].def.val_bits = val_enum_to_bit(number_VAL);
commands[52].optional_opt_args[41].opt = stripesize_ARG;
commands[52].optional_opt_args[41].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[53].command_line_id = "lvcreate_cachepool";
commands[53].command_line_enum = lvcreate_cachepool_CMD;
commands[53].fn = lvcreate;
commands[53].ro_count = 2;
commands[53].rp_count = 1;
commands[53].oo_count = 38;
commands[53].op_count = 1;
commands[53].desc = "DESC: Create a cache pool.";
commands[53].usage = "lvcreate --type cache-pool --size Number[m|unit] VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[53].required_opt_args[0].def.str = "cache-pool";
commands[53].required_opt_args[1].opt = size_ARG;
...
commands[53].optional_opt_args[13].opt = cachemode_ARG;
commands[53].optional_opt_args[13].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[53].optional_opt_args[14].opt = cachepolicy_ARG;
commands[53].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[15].opt = cachesettings_ARG;
commands[53].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[16].opt = addtag_ARG;
commands[53].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[53].optional_opt_args[17].opt = alloc_ARG;
commands[53].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[53].optional_opt_args[18].opt = autobackup_ARG;
commands[53].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[19].opt = activate_ARG;
commands[53].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[53].optional_opt_args[20].opt = contiguous_ARG;
commands[53].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[53].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[53].optional_opt_args[23].opt = major_ARG;
commands[53].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[53].optional_opt_args[24].opt = metadataprofile_ARG;
commands[53].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[25].opt = minor_ARG;
commands[53].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[53].optional_opt_args[26].opt = monitor_ARG;
commands[53].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[27].opt = name_ARG;
commands[53].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[28].opt = nosync_ARG;
commands[53].optional_opt_args[29].opt = noudevsync_ARG;
commands[53].optional_opt_args[30].opt = permission_ARG;
commands[53].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[53].optional_opt_args[31].opt = persistent_ARG;
commands[53].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[32].opt = readahead_ARG;
commands[53].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[53].optional_opt_args[33].opt = reportformat_ARG;
commands[53].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[34].opt = setactivationskip_ARG;
commands[53].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[35].opt = test_ARG;
commands[53].optional_opt_args[36].opt = wipesignatures_ARG;
commands[53].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[37].opt = zero_ARG;
...
commands[54].desc = "DESC: Create a cache pool (variant, infers --type cache-pool).";
commands[54].usage = "lvcreate --cache --size Number[m|unit] VG"
" [ --type cache-pool, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, COMMON_OPTIONS ]"
" [ PV ... ]";
commands[54].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[54].required_opt_args[0].opt = cache_ARG;
...
commands[54].optional_opt_args[10].def.str = "cache-pool";
commands[54].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[54].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[54].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[54].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[13].opt = chunksize_ARG;
commands[54].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[54].optional_opt_args[14].opt = cachemode_ARG;
commands[54].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[54].optional_opt_args[15].opt = cachepolicy_ARG;
commands[54].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[16].opt = cachesettings_ARG;
commands[54].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[55].ro_count = 3;
commands[55].rp_count = 1;
commands[55].oo_count = 38;
commands[55].op_count = 1;
commands[55].desc = "DESC: Create a cache pool named by the --cachepool arg  DESC: (variant, uses --cachepool in place of --name).";
commands[55].usage = "lvcreate --type cache-pool --size Number[m|unit] --cachepool LV_new VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[55].required_opt_args[2].opt = cachepool_ARG;
commands[55].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[55].required_opt_args[2].def.flags = ARG_DEF_FLAG_NEW;
...
commands[56].command_line_id = "lvcreate_thin_vol";
commands[56].command_line_enum = lvcreate_thin_vol_CMD;
commands[56].fn = lvcreate;
commands[56].ro_count = 3;
commands[56].rp_count = 1;
commands[56].oo_count = 39;
commands[56].op_count = 0;
commands[56].desc = "DESC: Create a thin LV in a thin pool.";
commands[56].usage = "lvcreate --type thin --virtualsize Number[m|unit] --thinpool LV_thinpool VG"
" [ --thin, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
...
commands[56].required_opt_args[2].opt = thinpool_ARG;
commands[56].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[56].required_opt_args[2].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[56].optional_opt_args[10].opt = thin_ARG;
commands[56].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[56].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[56].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[56].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[13].opt = chunksize_ARG;
commands[56].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[56].optional_opt_args[14].opt = discards_ARG;
commands[56].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[56].optional_opt_args[15].opt = errorwhenfull_ARG;
commands[56].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[16].opt = mirrors_ARG;
commands[56].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[56].optional_opt_args[16].def.num = 0;
commands[56].optional_opt_args[17].opt = addtag_ARG;
commands[56].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[56].optional_opt_args[18].opt = alloc_ARG;
commands[56].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[56].optional_opt_args[19].opt = autobackup_ARG;
commands[56].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[20].opt = activate_ARG;
commands[56].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[56].optional_opt_args[21].opt = contiguous_ARG;
commands[56].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[56].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[56].optional_opt_args[24].opt = major_ARG;
commands[56].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[56].optional_opt_args[25].opt = metadataprofile_ARG;
commands[56].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[56].optional_opt_args[26].opt = minor_ARG;
commands[56].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[56].optional_opt_args[27].opt = monitor_ARG;
commands[56].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[28].opt = name_ARG;
commands[56].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[56].optional_opt_args[29].opt = nosync_ARG;
commands[56].optional_opt_args[30].opt = noudevsync_ARG;
commands[56].optional_opt_args[31].opt = permission_ARG;
commands[56].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[56].optional_opt_args[32].opt = persistent_ARG;
commands[56].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[33].opt = readahead_ARG;
commands[56].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[56].optional_opt_args[34].opt = reportformat_ARG;
commands[56].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[56].optional_opt_args[35].opt = setactivationskip_ARG;
commands[56].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[36].opt = test_ARG;
commands[56].optional_opt_args[37].opt = wipesignatures_ARG;
commands[56].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[56].optional_opt_args[38].opt = zero_ARG;
commands[56].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[57].oo_count = 36;
commands[57].op_count = 0;
commands[57].desc = "DESC: Create a thin LV in a thin pool named in the first arg  DESC: (variant, also see --thinpool for naming pool).";
commands[57].usage = "lvcreate --type thin --virtualsize Number[m|unit] LV_thinpool"
" [ --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
...
commands[57].required_pos_args[0].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[57].optional_opt_args[11].opt = discards_ARG;
commands[57].optional_opt_args[11].def.val_bits = val_enum_to_bit(discards_VAL);
commands[57].optional_opt_args[12].opt = errorwhenfull_ARG;
commands[57].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[13].opt = mirrors_ARG;
commands[57].optional_opt_args[13].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[57].optional_opt_args[13].def.num = 0;
commands[57].optional_opt_args[14].opt = addtag_ARG;
commands[57].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[57].optional_opt_args[15].opt = alloc_ARG;
commands[57].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[57].optional_opt_args[16].opt = autobackup_ARG;
commands[57].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[17].opt = activate_ARG;
commands[57].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[57].optional_opt_args[18].opt = contiguous_ARG;
commands[57].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[57].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[57].optional_opt_args[21].opt = major_ARG;
commands[57].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[57].optional_opt_args[22].opt = metadataprofile_ARG;
commands[57].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[23].opt = minor_ARG;
commands[57].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[57].optional_opt_args[24].opt = monitor_ARG;
commands[57].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[25].opt = name_ARG;
commands[57].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[26].opt = nosync_ARG;
commands[57].optional_opt_args[27].opt = noudevsync_ARG;
commands[57].optional_opt_args[28].opt = permission_ARG;
commands[57].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[57].optional_opt_args[29].opt = persistent_ARG;
commands[57].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[30].opt = readahead_ARG;
commands[57].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[57].optional_opt_args[31].opt = reportformat_ARG;
commands[57].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[32].opt = setactivationskip_ARG;
commands[57].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[33].opt = test_ARG;
commands[57].optional_opt_args[34].opt = wipesignatures_ARG;
commands[57].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[57].optional_opt_args[35].opt = zero_ARG;
...
commands[58].rp_count = 0;
commands[58].oo_count = 37;
commands[58].op_count = 1;
commands[58].desc = "DESC: Create a thin LV in a thin pool (variant, infers --type thin).";
commands[58].usage = "lvcreate --virtualsize Number[m|unit] --thinpool LV_thinpool"
" [ --type thin, --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]"
" [ VG ]";
commands[58].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[58].required_opt_args[0].opt = virtualsize_ARG;
commands[58].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[58].optional_opt_args[11].opt = thin_ARG;
commands[58].optional_opt_args[12].opt = discards_ARG;
commands[58].optional_opt_args[12].def.val_bits = val_enum_to_bit(discards_VAL);
commands[58].optional_opt_args[13].opt = errorwhenfull_ARG;
commands[58].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[14].opt = mirrors_ARG;
commands[58].optional_opt_args[14].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[58].optional_opt_args[14].def.num = 0;
commands[58].optional_opt_args[15].opt = addtag_ARG;
commands[58].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[58].optional_opt_args[16].opt = alloc_ARG;
commands[58].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[58].optional_opt_args[17].opt = autobackup_ARG;
commands[58].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[18].opt = activate_ARG;
commands[58].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[58].optional_opt_args[19].opt = contiguous_ARG;
commands[58].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[58].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[58].optional_opt_args[22].opt = major_ARG;
commands[58].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[58].optional_opt_args[23].opt = metadataprofile_ARG;
commands[58].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[24].opt = minor_ARG;
commands[58].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[58].optional_opt_args[25].opt = monitor_ARG;
commands[58].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[26].opt = name_ARG;
commands[58].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[27].opt = nosync_ARG;
commands[58].optional_opt_args[28].opt = noudevsync_ARG;
commands[58].optional_opt_args[29].opt = permission_ARG;
commands[58].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[58].optional_opt_args[30].opt = persistent_ARG;
commands[58].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[31].opt = readahead_ARG;
commands[58].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[58].optional_opt_args[32].opt = reportformat_ARG;
commands[58].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[58].optional_opt_args[33].opt = setactivationskip_ARG;
commands[58].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[34].opt = test_ARG;
commands[58].optional_opt_args[35].opt = wipesignatures_ARG;
commands[58].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_opt_args[36].opt = zero_ARG;
commands[58].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[58].optional_pos_args[0].pos = 1;
commands[58].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[59].ro_count = 1;
commands[59].rp_count = 1;
commands[59].oo_count = 37;
commands[59].op_count = 0;
commands[59].desc = "DESC: Create a thin LV in the thin pool named in the first arg  DESC: (variant, infers --type thin, also see --thinpool for  DESC: naming pool.)";
commands[59].usage = "lvcreate --virtualsize Number[m|unit] LV_thinpool"
" [ --type thin, --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
...
commands[59].required_pos_args[0].pos = 1;
commands[59].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[59].required_pos_args[0].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[60].command_line_id = "lvcreate_thin_snapshot";
commands[60].command_line_enum = lvcreate_thin_snapshot_CMD;
commands[60].fn = lvcreate;
commands[60].ro_count = 1;
commands[60].rp_count = 1;
commands[60].oo_count = 36;
commands[60].op_count = 0;
commands[60].desc = "DESC: Create a thin LV that is a snapshot of an existing thin LV.";
commands[60].usage = "lvcreate --type thin LV_thin"
" [ --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
commands[60].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[60].required_opt_args[0].opt = type_ARG;
commands[60].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[60].required_opt_args[0].def.str = "thin";
commands[60].required_pos_args[0].pos = 1;
commands[60].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[60].required_pos_args[0].def.lv_types = ARG_DEF_LV_THIN;
...
commands[60].optional_opt_args[10].opt = thin_ARG;
commands[60].optional_opt_args[11].opt = discards_ARG;
commands[60].optional_opt_args[11].def.val_bits = val_enum_to_bit(discards_VAL);
commands[60].optional_opt_args[12].opt = errorwhenfull_ARG;
commands[60].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[13].opt = mirrors_ARG;
commands[60].optional_opt_args[13].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[60].optional_opt_args[13].def.num = 0;
...
commands[61].desc = "DESC: Create a thin LV that is a snapshot of an existing thin LV  DESC: (infers --type thin).";
commands[61].usage = "lvcreate --thin LV_thin"
" [ --type thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
commands[61].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[61].required_opt_args[0].opt = thin_ARG;
...
commands[62].usage = "lvcreate --snapshot LV_thin"
" [ --type thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
commands[62].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[62].required_opt_args[0].opt = snapshot_ARG;
...
commands[63].command_line_id = "lvcreate_thin_snapshot_of_external";
commands[63].command_line_enum = lvcreate_thin_snapshot_of_external_CMD;
commands[63].fn = lvcreate;
commands[63].ro_count = 2;
commands[63].rp_count = 1;
commands[63].oo_count = 38;
commands[63].op_count = 0;
commands[63].desc = "DESC: Create a thin LV that is a snapshot of an external origin LV.";
commands[63].usage = "lvcreate --type thin --thinpool LV_thinpool LV"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
...
commands[63].required_opt_args[1].opt = thinpool_ARG;
commands[63].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[63].required_opt_args[1].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[63].optional_opt_args[15].opt = mirrors_ARG;
commands[63].optional_opt_args[15].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[63].optional_opt_args[15].def.num = 0;
commands[63].optional_opt_args[16].opt = addtag_ARG;
commands[63].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[63].optional_opt_args[17].opt = alloc_ARG;
commands[63].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[63].optional_opt_args[18].opt = autobackup_ARG;
commands[63].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[19].opt = activate_ARG;
commands[63].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[63].optional_opt_args[20].opt = contiguous_ARG;
commands[63].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[63].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[63].optional_opt_args[23].opt = major_ARG;
commands[63].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[63].optional_opt_args[24].opt = metadataprofile_ARG;
commands[63].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[25].opt = minor_ARG;
commands[63].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[63].optional_opt_args[26].opt = monitor_ARG;
commands[63].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[27].opt = name_ARG;
commands[63].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[28].opt = nosync_ARG;
commands[63].optional_opt_args[29].opt = noudevsync_ARG;
commands[63].optional_opt_args[30].opt = permission_ARG;
commands[63].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[63].optional_opt_args[31].opt = persistent_ARG;
commands[63].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[32].opt = readahead_ARG;
commands[63].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[63].optional_opt_args[33].opt = reportformat_ARG;
commands[63].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[34].opt = setactivationskip_ARG;
commands[63].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[35].opt = test_ARG;
commands[63].optional_opt_args[36].opt = wipesignatures_ARG;
commands[63].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[37].opt = zero_ARG;
commands[63].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[64].oo_count = 36;
commands[64].op_count = 0;
commands[64].desc = "DESC: Create a thin LV that is a snapshot of an external origin LV  DESC: (infers --type thin).";
commands[64].usage = "lvcreate --snapshot --thinpool LV_thinpool LV"
" [ --type thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, COMMON_OPTIONS ]";
...
commands[64].optional_opt_args[13].opt = mirrors_ARG;
commands[64].optional_opt_args[13].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[64].optional_opt_args[13].def.num = 0;
commands[64].optional_opt_args[14].opt = addtag_ARG;
commands[64].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[64].optional_opt_args[15].opt = alloc_ARG;
commands[64].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[64].optional_opt_args[16].opt = autobackup_ARG;
commands[64].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[17].opt = activate_ARG;
commands[64].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[64].optional_opt_args[18].opt = contiguous_ARG;
commands[64].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[64].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[64].optional_opt_args[21].opt = major_ARG;
commands[64].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[64].optional_opt_args[22].opt = metadataprofile_ARG;
commands[64].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[23].opt = minor_ARG;
commands[64].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[64].optional_opt_args[24].opt = monitor_ARG;
commands[64].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[25].opt = name_ARG;
commands[64].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[26].opt = nosync_ARG;
commands[64].optional_opt_args[27].opt = noudevsync_ARG;
commands[64].optional_opt_args[28].opt = permission_ARG;
commands[64].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[64].optional_opt_args[29].opt = persistent_ARG;
commands[64].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[30].opt = readahead_ARG;
commands[64].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[64].optional_opt_args[31].opt = reportformat_ARG;
commands[64].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[32].opt = setactivationskip_ARG;
commands[64].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[33].opt = test_ARG;
commands[64].optional_opt_args[34].opt = wipesignatures_ARG;
commands[64].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[35].opt = zero_ARG;
commands[64].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);

commands[65].name = "lvcreate";
commands[65].command_line_id = "lvcreate_thin_vol_and_thinpool";
commands[65].command_line_enum = lvcreate_thin_vol_and_thinpool_CMD;
commands[65].fn = lvcreate;
commands[65].ro_count = 4;
commands[65].rp_count = 0;
commands[65].oo_count = 40;
commands[65].op_count = 1;
commands[65].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named by the --thinpool arg.";
commands[65].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] --thinpool LV_new"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[65].required_opt_args[1].opt = virtualsize_ARG;
commands[65].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[65].required_opt_args[2].opt = size_ARG;
commands[65].required_opt_args[2].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[65].required_opt_args[3].opt = thinpool_ARG;
commands[65].required_opt_args[3].def.val_bits = val_enum_to_bit(lv_VAL);
commands[65].required_opt_args[3].def.flags = ARG_DEF_FLAG_NEW;
...
commands[65].optional_opt_args[15].opt = mirrors_ARG;
commands[65].optional_opt_args[15].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[65].optional_opt_args[15].def.num = 0;
...
commands[65].optional_opt_args[38].opt = stripes_ARG;
commands[65].optional_opt_args[38].def.val_bits = val_enum_to_bit(number_VAL);
commands[65].optional_opt_args[39].opt = stripesize_ARG;
commands[65].optional_opt_args[39].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[65].optional_pos_args[0].pos = 1;
...
commands[66].command_line_id = "lvcreate_thin_vol_and_thinpool";
commands[66].command_line_enum = lvcreate_thin_vol_and_thinpool_CMD;
commands[66].fn = lvcreate;
commands[66].ro_count = 4;
commands[66].rp_count = 0;
commands[66].oo_count = 41;
commands[66].op_count = 1;
commands[66].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named by the --thinpool argreportformat  DESC: (variant, infers --type thin!";
commands[66].usage = "lvcreate --thin --virtualsize Number[m|unit] --size Number[m|unit] --thinpool LV_new"
" [ --type thin, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[66].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[66].required_opt_args[0].opt = thin_ARG;
...
commands[66].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[66].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[66].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[66].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[13].opt = chunksize_ARG;
commands[66].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[66].optional_opt_args[14].opt = discards_ARG;
commands[66].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[66].optional_opt_args[15].opt = errorwhenfull_ARG;
commands[66].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[16].opt = mirrors_ARG;
commands[66].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[66].optional_opt_args[16].def.num = 0;
commands[66].optional_opt_args[17].opt = addtag_ARG;
commands[66].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[66].optional_opt_args[18].opt = alloc_ARG;
commands[66].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[66].optional_opt_args[19].opt = autobackup_ARG;
commands[66].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[20].opt = activate_ARG;
commands[66].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[66].optional_opt_args[21].opt = contiguous_ARG;
commands[66].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[66].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[66].optional_opt_args[24].opt = major_ARG;
commands[66].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[66].optional_opt_args[25].opt = metadataprofile_ARG;
commands[66].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[26].opt = minor_ARG;
commands[66].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[66].optional_opt_args[27].opt = monitor_ARG;
commands[66].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[28].opt = name_ARG;
commands[66].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[29].opt = nosync_ARG;
commands[66].optional_opt_args[30].opt = noudevsync_ARG;
commands[66].optional_opt_args[31].opt = permission_ARG;
commands[66].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[66].optional_opt_args[32].opt = persistent_ARG;
commands[66].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[33].opt = readahead_ARG;
commands[66].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[66].optional_opt_args[34].opt = reportformat_ARG;
commands[66].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[66].optional_opt_args[35].opt = setactivationskip_ARG;
commands[66].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[36].opt = test_ARG;
commands[66].optional_opt_args[37].opt = wipesignatures_ARG;
commands[66].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[38].opt = zero_ARG;
commands[66].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[66].optional_opt_args[39].opt = stripes_ARG;
commands[66].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[66].optional_opt_args[40].opt = stripesize_ARG;
commands[66].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[67].command_line_id = "lvcreate_thin_vol_and_thinpool";
commands[67].command_line_enum = lvcreate_thin_vol_and_thinpool_CMD;
commands[67].fn = lvcreate;
commands[67].ro_count = 3;
commands[67].rp_count = 1;
commands[67].oo_count = 40;
commands[67].op_count = 1;
commands[67].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named in the first arg.";
commands[67].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] LV_new"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[67].required_pos_args[0].def.flags = ARG_DEF_FLAG_NEW;
...
commands[67].optional_opt_args[15].opt = mirrors_ARG;
commands[67].optional_opt_args[15].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[67].optional_opt_args[15].def.num = 0;
commands[67].optional_opt_args[16].opt = addtag_ARG;
commands[67].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[67].optional_opt_args[17].opt = alloc_ARG;
commands[67].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[67].optional_opt_args[18].opt = autobackup_ARG;
commands[67].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[19].opt = activate_ARG;
commands[67].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[67].optional_opt_args[20].opt = contiguous_ARG;
commands[67].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[67].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[67].optional_opt_args[23].opt = major_ARG;
commands[67].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[67].optional_opt_args[24].opt = metadataprofile_ARG;
commands[67].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[25].opt = minor_ARG;
commands[67].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[67].optional_opt_args[26].opt = monitor_ARG;
commands[67].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[27].opt = name_ARG;
commands[67].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[28].opt = nosync_ARG;
commands[67].optional_opt_args[29].opt = noudevsync_ARG;
commands[67].optional_opt_args[30].opt = permission_ARG;
commands[67].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[67].optional_opt_args[31].opt = persistent_ARG;
commands[67].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[32].opt = readahead_ARG;
commands[67].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[67].optional_opt_args[33].opt = reportformat_ARG;
commands[67].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[34].opt = setactivationskip_ARG;
commands[67].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[35].opt = test_ARG;
commands[67].optional_opt_args[36].opt = wipesignatures_ARG;
commands[67].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[37].opt = zero_ARG;
commands[67].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[38].opt = stripes_ARG;
commands[67].optional_opt_args[38].def.val_bits = val_enum_to_bit(number_VAL);
commands[67].optional_opt_args[39].opt = stripesize_ARG;
commands[67].optional_opt_args[39].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[67].optional_pos_args[0].pos = 2;
...
commands[68].command_line_id = "lvcreate_thin_vol_and_thinpool";
commands[68].command_line_enum = lvcreate_thin_vol_and_thinpool_CMD;
commands[68].fn = lvcreate;
commands[68].ro_count = 3;
commands[68].rp_count = 1;
commands[68].oo_count = 41;
commands[68].op_count = 1;
commands[68].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named in the first arg  DESC: (variant, infers --type thin).";
commands[68].usage = "lvcreate --thin --virtualsize Number[m|unit] --size Number[m|unit] LV_new"
" [ --type thin, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[68].optional_opt_args[16].opt = mirrors_ARG;
commands[68].optional_opt_args[16].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[68].optional_opt_args[16].def.num = 0;
commands[68].optional_opt_args[17].opt = addtag_ARG;
commands[68].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[68].optional_opt_args[18].opt = alloc_ARG;
commands[68].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[68].optional_opt_args[19].opt = autobackup_ARG;
commands[68].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[20].opt = activate_ARG;
commands[68].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[68].optional_opt_args[21].opt = contiguous_ARG;
commands[68].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[68].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[68].optional_opt_args[24].opt = major_ARG;
commands[68].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[68].optional_opt_args[25].opt = metadataprofile_ARG;
commands[68].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[68].optional_opt_args[26].opt = minor_ARG;
commands[68].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[68].optional_opt_args[27].opt = monitor_ARG;
commands[68].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[28].opt = name_ARG;
commands[68].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[68].optional_opt_args[29].opt = nosync_ARG;
commands[68].optional_opt_args[30].opt = noudevsync_ARG;
commands[68].optional_opt_args[31].opt = permission_ARG;
commands[68].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[68].optional_opt_args[32].opt = persistent_ARG;
commands[68].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[33].opt = readahead_ARG;
commands[68].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[68].optional_opt_args[34].opt = reportformat_ARG;
commands[68].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[68].optional_opt_args[35].opt = setactivationskip_ARG;
commands[68].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[36].opt = test_ARG;
commands[68].optional_opt_args[37].opt = wipesignatures_ARG;
commands[68].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[38].opt = zero_ARG;
commands[68].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[39].opt = stripes_ARG;
commands[68].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[68].optional_opt_args[40].opt = stripesize_ARG;
commands[68].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[69].command_line_id = "lvcreate_thin_vol_and_thinpool";
commands[69].command_line_enum = lvcreate_thin_vol_and_thinpool_CMD;
commands[69].fn = lvcreate;
commands[69].ro_count = 3;
commands[69].rp_count = 1;
commands[69].oo_count = 40;
commands[69].op_count = 1;
commands[69].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool name is generated automatically.";
commands[69].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[69].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[69].optional_opt_args[15].opt = mirrors_ARG;
commands[69].optional_opt_args[15].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[69].optional_opt_args[15].def.num = 0;
commands[69].optional_opt_args[16].opt = addtag_ARG;
commands[69].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[69].optional_opt_args[17].opt = alloc_ARG;
commands[69].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[69].optional_opt_args[18].opt = autobackup_ARG;
commands[69].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[19].opt = activate_ARG;
commands[69].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[69].optional_opt_args[20].opt = contiguous_ARG;
commands[69].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[69].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[69].optional_opt_args[23].opt = major_ARG;
commands[69].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[69].optional_opt_args[24].opt = metadataprofile_ARG;
commands[69].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[25].opt = minor_ARG;
commands[69].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[69].optional_opt_args[26].opt = monitor_ARG;
commands[69].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[27].opt = name_ARG;
commands[69].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[28].opt = nosync_ARG;
commands[69].optional_opt_args[29].opt = noudevsync_ARG;
commands[69].optional_opt_args[30].opt = permission_ARG;
commands[69].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[69].optional_opt_args[31].opt = persistent_ARG;
commands[69].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[32].opt = readahead_ARG;
commands[69].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[69].optional_opt_args[33].opt = reportformat_ARG;
commands[69].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[34].opt = setactivationskip_ARG;
commands[69].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[35].opt = test_ARG;
commands[69].optional_opt_args[36].opt = wipesignatures_ARG;
commands[69].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[37].opt = zero_ARG;
commands[69].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[38].opt = stripes_ARG;
commands[69].optional_opt_args[38].def.val_bits = val_enum_to_bit(number_VAL);
commands[69].optional_opt_args[39].opt = stripesize_ARG;
commands[69].optional_opt_args[39].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[70].command_line_id = "lvcreate_thin_vol_with_thinpool_or_sparse_snapshot";
commands[70].command_line_enum = lvcreate_thin_vol_with_thinpool_or_sparse_snapshot_CMD;
commands[70].fn = lvcreate;
commands[70].ro_count = 2;
commands[70].rp_count = 1;
commands[70].oo_count = 44;
commands[70].op_count = 1;
commands[70].desc = "DESC: Create a thin LV, first creating a thin pool for it  DESC: (infers --type thin).  DESC: Create a sparse snapshot of a virtual origin LV  DESC: (infers --type snapshot).  DESC: Chooses --type thin or --type snapshot according to  DESC: config setting sparse_segtype_default.";
commands[70].usage = "lvcreate --size Number[m|unit] --virtualsize Number[m|unit] VG"
" [ --type thin, --type snapshot, --thin, --snapshot, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --mirrors 0, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[70].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[70].required_opt_args[0].opt = size_ARG;
commands[70].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[70].optional_opt_args[11].opt = type_ARG;
commands[70].optional_opt_args[11].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[70].optional_opt_args[11].def.str = "snapshot";
commands[70].optional_opt_args[12].opt = thin_ARG;
commands[70].optional_opt_args[13].opt = snapshot_ARG;
commands[70].optional_opt_args[14].opt = poolmetadatasize_ARG;
commands[70].optional_opt_args[14].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[70].optional_opt_args[15].opt = poolmetadataspare_ARG;
commands[70].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[16].opt = chunksize_ARG;
commands[70].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[70].optional_opt_args[17].opt = discards_ARG;
commands[70].optional_opt_args[17].def.val_bits = val_enum_to_bit(discards_VAL);
commands[70].optional_opt_args[18].opt = errorwhenfull_ARG;
commands[70].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[19].opt = mirrors_ARG;
commands[70].optional_opt_args[19].def.val_bits = val_enum_to_bit(constnum_VAL);
commands[70].optional_opt_args[19].def.num = 0;
commands[70].optional_opt_args[20].opt = addtag_ARG;
commands[70].optional_opt_args[20].def.val_bits = val_enum_to_bit(tag_VAL);
commands[70].optional_opt_args[21].opt = alloc_ARG;
commands[70].optional_opt_args[21].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[70].optional_opt_args[22].opt = autobackup_ARG;
commands[70].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[23].opt = activate_ARG;
commands[70].optional_opt_args[23].def.val_bits = val_enum_to_bit(activation_VAL);
commands[70].optional_opt_args[24].opt = contiguous_ARG;
commands[70].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[25].opt = ignoreactivationskip_ARG;
commands[70].optional_opt_args[26].opt = ignoremonitoring_ARG;
commands[70].optional_opt_args[27].opt = major_ARG;
commands[70].optional_opt_args[27].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[28].opt = metadataprofile_ARG;
commands[70].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[29].opt = minor_ARG;
commands[70].optional_opt_args[29].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[30].opt = monitor_ARG;
commands[70].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[31].opt = name_ARG;
commands[70].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[32].opt = nosync_ARG;
commands[70].optional_opt_args[33].opt = noudevsync_ARG;
commands[70].optional_opt_args[34].opt = permission_ARG;
commands[70].optional_opt_args[34].def.val_bits = val_enum_to_bit(permission_VAL);
commands[70].optional_opt_args[35].opt = persistent_ARG;
commands[70].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[36].opt = readahead_ARG;
commands[70].optional_opt_args[36].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[70].optional_opt_args[37].opt = reportformat_ARG;
commands[70].optional_opt_args[37].def.val_bits = val_enum_to_bit(string_VAL);
commands[70].optional_opt_args[38].opt = setactivationskip_ARG;
commands[70].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[39].opt = test_ARG;
commands[70].optional_opt_args[40].opt = wipesignatures_ARG;
commands[70].optional_opt_args[40].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[41].opt = zero_ARG;
commands[70].optional_opt_args[41].def.val_bits = val_enum_to_bit(bool_VAL);
commands[70].optional_opt_args[42].opt = stripes_ARG;
commands[70].optional_opt_args[42].def.val_bits = val_enum_to_bit(number_VAL);
commands[70].optional_opt_args[43].opt = stripesize_ARG;
commands[70].optional_opt_args[43].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[71].command_line_id = "lvcreate_cache_vol_with_new_origin";
commands[71].command_line_enum = lvcreate_cache_vol_with_new_origin_CMD;
commands[71].fn = lvcreate;
commands[71].ro_count = 3;
commands[71].rp_count = 1;
commands[71].oo_count = 41;
commands[71].op_count = 1;
commands[71].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: by the --cachepool arg.";
commands[71].usage = "lvcreate --type cache --size Number[m|unit] --cachepool LV_cachepool VG"
" [ --cache, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[71].required_opt_args[0].def.str = "cache";
commands[71].required_opt_args[1].opt = size_ARG;
commands[71].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[71].required_opt_args[2].opt = cachepool_ARG;
commands[71].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[71].required_opt_args[2].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[71].optional_opt_args[10].opt = cache_ARG;
...
commands[71].optional_opt_args[14].opt = cachemode_ARG;
commands[71].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[71].optional_opt_args[15].opt = cachepolicy_ARG;
commands[71].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[16].opt = cachesettings_ARG;
commands[71].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[17].opt = addtag_ARG;
commands[71].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[71].optional_opt_args[18].opt = alloc_ARG;
commands[71].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[71].optional_opt_args[19].opt = autobackup_ARG;
commands[71].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[20].opt = activate_ARG;
commands[71].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[71].optional_opt_args[21].opt = contiguous_ARG;
commands[71].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[71].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[71].optional_opt_args[24].opt = major_ARG;
commands[71].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[25].opt = metadataprofile_ARG;
commands[71].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[26].opt = minor_ARG;
commands[71].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[27].opt = monitor_ARG;
commands[71].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[28].opt = name_ARG;
commands[71].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[29].opt = nosync_ARG;
commands[71].optional_opt_args[30].opt = noudevsync_ARG;
commands[71].optional_opt_args[31].opt = permission_ARG;
commands[71].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[71].optional_opt_args[32].opt = persistent_ARG;
commands[71].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[33].opt = readahead_ARG;
commands[71].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[71].optional_opt_args[34].opt = reportformat_ARG;
commands[71].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[35].opt = setactivationskip_ARG;
commands[71].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[36].opt = test_ARG;
commands[71].optional_opt_args[37].opt = wipesignatures_ARG;
commands[71].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[38].opt = zero_ARG;
commands[71].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[39].opt = stripes_ARG;
commands[71].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[40].opt = stripesize_ARG;
commands[71].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[72].oo_count = 39;
commands[72].op_count = 1;
commands[72].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: by the --cachepool arg (variant, infers --type cache).";
commands[72].usage = "lvcreate --size Number[m|unit] --cachepool LV_cachepool VG"
" [ --type cache, --cache, --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[72].required_opt_args[1].opt = cachepool_ARG;
commands[72].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[72].required_opt_args[1].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[72].optional_opt_args[10].def.str = "cache";
commands[72].optional_opt_args[11].opt = cache_ARG;
commands[72].optional_opt_args[12].opt = cachemode_ARG;
commands[72].optional_opt_args[12].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[72].optional_opt_args[13].opt = cachepolicy_ARG;
commands[72].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[14].opt = cachesettings_ARG;
commands[72].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[15].opt = addtag_ARG;
commands[72].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[72].optional_opt_args[16].opt = alloc_ARG;
commands[72].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[72].optional_opt_args[17].opt = autobackup_ARG;
commands[72].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[18].opt = activate_ARG;
commands[72].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[72].optional_opt_args[19].opt = contiguous_ARG;
commands[72].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[72].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[72].optional_opt_args[22].opt = major_ARG;
commands[72].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[23].opt = metadataprofile_ARG;
commands[72].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[24].opt = minor_ARG;
commands[72].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[25].opt = monitor_ARG;
commands[72].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[26].opt = name_ARG;
commands[72].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[27].opt = nosync_ARG;
commands[72].optional_opt_args[28].opt = noudevsync_ARG;
commands[72].optional_opt_args[29].opt = permission_ARG;
commands[72].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[72].optional_opt_args[30].opt = persistent_ARG;
commands[72].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[31].opt = readahead_ARG;
commands[72].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[72].optional_opt_args[32].opt = reportformat_ARG;
commands[72].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[33].opt = setactivationskip_ARG;
commands[72].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[34].opt = test_ARG;
commands[72].optional_opt_args[35].opt = wipesignatures_ARG;
commands[72].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[36].opt = zero_ARG;
commands[72].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[37].opt = stripes_ARG;
commands[72].optional_opt_args[37].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[38].opt = stripesize_ARG;
commands[72].optional_opt_args[38].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[73].oo_count = 41;
commands[73].op_count = 1;
commands[73].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool named  DESC: in the first arg (variant, also use --cachepool).";
commands[73].usage = "lvcreate --type cache --size Number[m|unit] LV_cachepool"
" [ --cache, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
...
commands[73].required_pos_args[0].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[73].optional_opt_args[10].opt = cache_ARG;
commands[73].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[73].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[73].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[73].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[13].opt = chunksize_ARG;
commands[73].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[73].optional_opt_args[14].opt = cachemode_ARG;
commands[73].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[73].optional_opt_args[15].opt = cachepolicy_ARG;
commands[73].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[16].opt = cachesettings_ARG;
commands[73].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[17].opt = addtag_ARG;
commands[73].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[73].optional_opt_args[18].opt = alloc_ARG;
commands[73].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[73].optional_opt_args[19].opt = autobackup_ARG;
commands[73].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[20].opt = activate_ARG;
commands[73].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[73].optional_opt_args[21].opt = contiguous_ARG;
commands[73].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[73].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[73].optional_opt_args[24].opt = major_ARG;
commands[73].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[73].optional_opt_args[25].opt = metadataprofile_ARG;
commands[73].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[26].opt = minor_ARG;
commands[73].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[73].optional_opt_args[27].opt = monitor_ARG;
commands[73].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[28].opt = name_ARG;
commands[73].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[29].opt = nosync_ARG;
commands[73].optional_opt_args[30].opt = noudevsync_ARG;
commands[73].optional_opt_args[31].opt = permission_ARG;
commands[73].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[73].optional_opt_args[32].opt = persistent_ARG;
commands[73].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[33].opt = readahead_ARG;
commands[73].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[73].optional_opt_args[34].opt = reportformat_ARG;
commands[73].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[35].opt = setactivationskip_ARG;
commands[73].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[36].opt = test_ARG;
commands[73].optional_opt_args[37].opt = wipesignatures_ARG;
commands[73].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[38].opt = zero_ARG;
commands[73].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[39].opt = stripes_ARG;
commands[73].optional_opt_args[39].def.val_bits = val_enum_to_bit(number_VAL);
commands[73].optional_opt_args[40].opt = stripesize_ARG;
commands[73].optional_opt_args[40].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[74].command_line_id = "lvcreate_cache_vol_with_new_origin_or_convert_to_cache_vol_with_cachepool";
commands[74].command_line_enum = lvcreate_cache_vol_with_new_origin_or_convert_to_cache_vol_with_cachepool_CMD;
commands[74].fn = lvcreate;
commands[74].ro_count = 2;
commands[74].rp_count = 1;
commands[74].oo_count = 37;
commands[74].op_count = 1;
commands[74].desc = "DESC: When LV is a cache pool, create a cache LV,  DESC: first creating a new origin LV, then combining it with  DESC: the existing cache pool named in the first arg  DESC: (variant, infers --type cache, also use --cachepool).  DESC: When LV is not a cache pool, convert the specified LV  DESC: to type cache after creating a new cache pool LV to use  DESC: (use lvconvert).";
commands[74].usage = "lvcreate --cache --size Number[m|unit] LV"
" [ --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[74].usage_common = 
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --metadataprofile String, --minor Number, --monitor y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --activate y|n|ay, --autobackup y|n, --contiguous y|n, --debug, --help, --persistent y|n, --major Number, --setactivationskip y|n, --ignoreactivationskip, --name String, --permission rw|r, --quiet, --readahead auto|none|NumberSectors, --test, --verbose, --wipesignatures y|n, --yes, --zero y|n, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[74].required_opt_args[0].opt = cache_ARG;
...
commands[74].optional_opt_args[10].opt = cachemode_ARG;
commands[74].optional_opt_args[10].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[74].optional_opt_args[11].opt = cachepolicy_ARG;
commands[74].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[12].opt = cachesettings_ARG;
commands[74].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[13].opt = addtag_ARG;
commands[74].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[74].optional_opt_args[14].opt = alloc_ARG;
commands[74].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[74].optional_opt_args[15].opt = autobackup_ARG;
commands[74].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[16].opt = activate_ARG;
commands[74].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[74].optional_opt_args[17].opt = contiguous_ARG;
commands[74].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[74].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[74].optional_opt_args[20].opt = major_ARG;
commands[74].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[21].opt = metadataprofile_ARG;
commands[74].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[22].opt = minor_ARG;
commands[74].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[23].opt = monitor_ARG;
commands[74].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[24].opt = name_ARG;
commands[74].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[25].opt = nosync_ARG;
commands[74].optional_opt_args[26].opt = noudevsync_ARG;
commands[74].optional_opt_args[27].opt = permission_ARG;
commands[74].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[74].optional_opt_args[28].opt = persistent_ARG;
commands[74].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[29].opt = readahead_ARG;
commands[74].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[74].optional_opt_args[30].opt = reportformat_ARG;
commands[74].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[74].optional_opt_args[31].opt = setactivationskip_ARG;
commands[74].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[32].opt = test_ARG;
commands[74].optional_opt_args[33].opt = wipesignatures_ARG;
commands[74].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[34].opt = zero_ARG;
commands[74].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[74].optional_opt_args[35].opt = stripes_ARG;
commands[74].optional_opt_args[35].def.val_bits = val_enum_to_bit(number_VAL);
commands[74].optional_opt_args[36].opt = stripesize_ARG;
commands[74].optional_opt_args[36].def.val_bits = val_enum_to_bit(sizekb_VAL);
...
commands[75].name = "lvdisplay";
commands[75].command_line_id = "lvdisplay_general";
commands[75].command_line_enum = lvdisplay_general_CMD;
commands[75].fn = lvdisplay;
commands[75].ro_count = 0;
commands[75].rp_count = 0;
commands[75].oo_count = 35;
commands[75].op_count = 1;
commands[75].desc = "";
commands[75].usage = "lvdisplay"
" [ --aligned, --all, --binary, --colon, --columns, --configreport String, --foreign, --history, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --maps, --noheadings, --nosuffix, --options String, --sort String, --partial, --readonly, --reportformat String, --segments, --select String, --separator String, --shared, --unbuffered, --units hHbBsSkKmMgGtTpPeE, COMMON_OPTIONS ]"
" [ VG|LV|Tag ... ]";
...
commands[75].optional_opt_args[10].opt = aligned_ARG;
commands[75].optional_opt_args[11].opt = all_ARG;
commands[75].optional_opt_args[12].opt = binary_ARG;
commands[75].optional_opt_args[13].opt = colon_ARG;
commands[75].optional_opt_args[14].opt = columns_ARG;
commands[75].optional_opt_args[15].opt = configreport_ARG;
commands[75].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[16].opt = foreign_ARG;
commands[75].optional_opt_args[17].opt = history_ARG;
commands[75].optional_opt_args[18].opt = ignorelockingfailure_ARG;
commands[75].optional_opt_args[19].opt = ignoreskippedcluster_ARG;
commands[75].optional_opt_args[20].opt = logonly_ARG;
commands[75].optional_opt_args[21].opt = maps_ARG;
commands[75].optional_opt_args[22].opt = noheadings_ARG;
commands[75].optional_opt_args[23].opt = nosuffix_ARG;
commands[75].optional_opt_args[24].opt = options_ARG;
commands[75].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[25].opt = sort_ARG;
commands[75].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[26].opt = partial_ARG;
commands[75].optional_opt_args[27].opt = readonly_ARG;
commands[75].optional_opt_args[28].opt = reportformat_ARG;
commands[75].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[29].opt = segments_ARG;
commands[75].optional_opt_args[30].opt = select_ARG;
commands[75].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[31].opt = separator_ARG;
commands[75].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[32].opt = shared_ARG;
commands[75].optional_opt_args[33].opt = unbuffered_ARG;
commands[75].optional_opt_args[34].opt = units_ARG;
commands[75].optional_opt_args[34].def.val_bits = val_enum_to_bit(units_VAL);
commands[75].optional_pos_args[0].pos = 1;
commands[75].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL);
commands[75].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[76].name = "lvextend";
commands[76].command_line_id = "lvextend_by_size";
commands[76].command_line_enum = lvextend_by_size_CMD;
commands[76].fn = lvextend;
commands[76].ro_count = 1;
commands[76].rp_count = 1;
commands[76].oo_count = 23;
commands[76].op_count = 1;
commands[76].desc = "DESC: Extend an LV by a specified size.";
commands[76].usage = "lvextend --size Number[m|unit] LV"
" [ --resizefs, --stripes Number, --stripesize Number[k|unit], --poolmetadatasize Number[m|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[76].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --mirrors [+|-]Number, --nofsck, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[76].required_opt_args[0].opt = size_ARG;
...
commands[76].optional_opt_args[18].opt = resizefs_ARG;
commands[76].optional_opt_args[19].opt = stripes_ARG;
commands[76].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[76].optional_opt_args[20].opt = stripesize_ARG;
commands[76].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[76].optional_opt_args[21].opt = test_ARG;
commands[76].optional_opt_args[22].opt = poolmetadatasize_ARG;
commands[76].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
...
commands[77].command_line_id = "lvextend_by_pv";
commands[77].command_line_enum = lvextend_by_pv_CMD;
commands[77].fn = lvextend;
commands[77].ro_count = 0;
commands[77].rp_count = 2;
commands[77].oo_count = 22;
commands[77].op_count = 0;
commands[77].desc = "DESC: Extend an LV by a specified PV.";
commands[77].usage = "lvextend LV PV ..."
" [ --resizefs, --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]";
...
commands[77].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[77].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[78].command_line_id = "lvextend_pool_metadata_by_size";
commands[78].command_line_enum = lvextend_pool_metadata_by_size_CMD;
commands[78].fn = lvextend;
commands[78].ro_count = 1;
commands[78].rp_count = 1;
commands[78].oo_count = 21;
commands[78].op_count = 1;
commands[78].desc = "DESC: Extend a pool metadata SubLV by a specified size.";
commands[78].usage = "lvextend --poolmetadatasize Number[m|unit] LV_thinpool"
" [ --stripes Number, --stripesize Number[k|unit], COMMON_OPTIONS ]"
" [ PV ... ]";
commands[78].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --mirrors [+|-]Number, --nofsck, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[78].required_opt_args[0].opt = poolmetadatasize_ARG;
...
commands[78].required_pos_args[0].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[79].command_line_id = "lvextend_by_policy";
commands[79].command_line_enum = lvextend_by_policy_CMD;
commands[79].fn = lvextend;
commands[79].ro_count = 1;
commands[79].rp_count = 1;
commands[79].oo_count = 20;
commands[79].op_count = 0;
commands[79].desc = "DESC: Extend an LV according to a predefined policy.";
commands[79].usage = "lvextend --usepolicies LV_snapshot_thinpool"
" [ --resizefs, COMMON_OPTIONS ]";
commands[79].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --mirrors [+|-]Number, --nofsck, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[79].required_opt_args[0].opt = usepolicies_ARG;
commands[79].required_pos_args[0].pos = 1;
commands[79].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[79].required_pos_args[0].def.lv_types = ARG_DEF_LV_SNAPSHOT | ARG_DEF_LV_THINPOOL;
...
commands[79].optional_opt_args[18].opt = resizefs_ARG;
commands[79].optional_opt_args[19].opt = test_ARG;

commands[80].name = "lvmconfig";
commands[80].command_line_id = "lvmconfig_general";
commands[80].command_line_enum = lvmconfig_general_CMD;
commands[80].fn = lvmconfig;
commands[80].ro_count = 0;
commands[80].rp_count = 0;
commands[80].oo_count = 28;
commands[80].op_count = 0;
commands[80].desc = "";
commands[80].usage = "lvmconfig"
" [ --atversion String, --typeconfig String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions, COMMON_OPTIONS ]";
...
commands[80].optional_opt_args[10].opt = atversion_ARG;
commands[80].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[80].optional_opt_args[11].opt = configtype_ARG;
commands[80].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[80].optional_opt_args[12].opt = file_ARG;
commands[80].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[80].optional_opt_args[13].opt = ignoreadvanced_ARG;
commands[80].optional_opt_args[14].opt = ignoreunsupported_ARG;
commands[80].optional_opt_args[15].opt = ignorelocal_ARG;
commands[80].optional_opt_args[16].opt = list_ARG;
commands[80].optional_opt_args[17].opt = mergedconfig_ARG;
commands[80].optional_opt_args[18].opt = metadataprofile_ARG;
commands[80].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[80].optional_opt_args[19].opt = sinceversion_ARG;
commands[80].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[80].optional_opt_args[20].opt = showdeprecated_ARG;
commands[80].optional_opt_args[21].opt = showunsupported_ARG;
commands[80].optional_opt_args[22].opt = validate_ARG;
commands[80].optional_opt_args[23].opt = withsummary_ARG;
commands[80].optional_opt_args[24].opt = withcomments_ARG;
commands[80].optional_opt_args[25].opt = withspaces_ARG;
commands[80].optional_opt_args[26].opt = unconfigured_ARG;
commands[80].optional_opt_args[27].opt = withversions_ARG;

commands[81].name = "lvreduce";
commands[81].command_line_id = "lvreduce_general";
commands[81].command_line_enum = lvreduce_general_CMD;
commands[81].fn = lvreduce;
commands[81].ro_count = 1;
commands[81].rp_count = 1;
commands[81].oo_count = 17;
commands[81].op_count = 0;
commands[81].desc = "";
commands[81].usage = "lvreduce --size Number[m|unit] LV"
" [ --autobackup y|n, --nofsck, --reportformat String, --resizefs, COMMON_OPTIONS ]";
commands[81].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[81].required_opt_args[0].opt = size_ARG;
commands[81].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[81].required_pos_args[0].pos = 1;
commands[81].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[81].optional_opt_args[10].opt = autobackup_ARG;
commands[81].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[81].optional_opt_args[11].opt = force_ARG;
commands[81].optional_opt_args[12].opt = nofsck_ARG;
commands[81].optional_opt_args[13].opt = noudevsync_ARG;
commands[81].optional_opt_args[14].opt = reportformat_ARG;
commands[81].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[81].optional_opt_args[15].opt = resizefs_ARG;
commands[81].optional_opt_args[16].opt = test_ARG;

commands[82].name = "lvremove";
commands[82].command_line_id = "lvremove_general";
commands[82].command_line_enum = lvremove_general_CMD;
commands[82].fn = lvremove;
commands[82].ro_count = 0;
commands[82].rp_count = 1;
commands[82].oo_count = 17;
commands[82].op_count = 0;
commands[82].desc = "";
commands[82].usage = "lvremove VG|LV|Tag|Select ..."
" [ --autobackup y|n, --nohistory, --reportformat String, --select String, COMMON_OPTIONS ]";
commands[82].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[82].required_pos_args[0].pos = 1;
commands[82].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[82].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[82].optional_opt_args[12].opt = nohistory_ARG;
...
commands[82].optional_opt_args[15].opt = select_ARG;
commands[82].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[82].optional_opt_args[16].opt = test_ARG;

commands[83].name = "lvrename";
commands[83].command_line_id = "lvrename_vg_lv_lv";
commands[83].command_line_enum = lvrename_vg_lv_lv_CMD;
commands[83].fn = lvrename;
commands[83].ro_count = 0;
commands[83].rp_count = 3;
commands[83].oo_count = 14;
commands[83].op_count = 0;
commands[83].desc = "";
commands[83].usage = "lvrename VG LV LV_new"
" [ COMMON_OPTIONS ]";
commands[83].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[83].required_pos_args[0].pos = 1;
commands[83].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[83].required_pos_args[1].pos = 2;
commands[83].required_pos_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[83].required_pos_args[2].pos = 3;
commands[83].required_pos_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[83].required_pos_args[2].def.flags = ARG_DEF_FLAG_NEW;
...
commands[83].optional_opt_args[11].opt = noudevsync_ARG;
commands[83].optional_opt_args[12].opt = reportformat_ARG;
commands[83].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[83].optional_opt_args[13].opt = test_ARG;

commands[84].name = "lvrename";
commands[84].command_line_id = "lvrename_lv_lv";
commands[84].command_line_enum = lvrename_lv_lv_CMD;
commands[84].fn = lvrename;
commands[84].ro_count = 0;
commands[84].rp_count = 2;
commands[84].oo_count = 14;
commands[84].op_count = 0;
commands[84].desc = "";
commands[84].usage = "lvrename LV LV_new"
" [ COMMON_OPTIONS ]";
commands[84].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[84].required_pos_args[0].pos = 1;
commands[84].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[84].required_pos_args[1].pos = 2;
commands[84].required_pos_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[84].required_pos_args[1].def.flags = ARG_DEF_FLAG_NEW;
...
commands[86].command_line_id = "lvresize_by_pv";
commands[86].command_line_enum = lvresize_by_pv_CMD;
commands[86].fn = lvresize;
commands[86].ro_count = 0;
commands[86].rp_count = 2;
commands[86].oo_count = 21;
commands[86].op_count = 0;
commands[86].desc = "DESC: Resize an LV by a specified PV.";
commands[86].usage = "lvresize LV PV ..."
" [ --resizefs, COMMON_OPTIONS ]";
...
commands[86].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[86].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[87].command_line_id = "lvresize_pool_metadata_by_size";
commands[87].command_line_enum = lvresize_pool_metadata_by_size_CMD;
commands[87].fn = lvresize;
commands[87].ro_count = 1;
commands[87].rp_count = 1;
commands[87].oo_count = 20;
commands[87].op_count = 1;
commands[87].desc = "DESC: Resize a pool metadata SubLV by a specified size.";
commands[87].usage = "lvresize --poolmetadatasize Number[m|unit] LV_thinpool"
" [ COMMON_OPTIONS ]"
" [ PV ... ]";
commands[87].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --nosync, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --stripes Number, --stripesize Number[k|unit], --nofsck, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[87].required_opt_args[0].opt = poolmetadatasize_ARG;
...
commands[87].required_pos_args[0].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[87].optional_opt_args[17].opt = stripes_ARG;
commands[87].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[87].optional_opt_args[18].opt = stripesize_ARG;
commands[87].optional_opt_args[18].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[87].optional_opt_args[19].opt = test_ARG;
...
commands[88].name = "lvs";
commands[88].command_line_id = "lvs_general";
commands[88].command_line_enum = lvs_general_CMD;
commands[88].fn = lvs;
commands[88].ro_count = 0;
commands[88].rp_count = 0;
commands[88].oo_count = 37;
commands[88].op_count = 1;
commands[88].desc = "";
commands[88].usage = "lvs"
" [ --history, --segments, --aligned, --all, --binary, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --nameprefixes, --noheadings, --nolocking, --nosuffix, --options String, --partial, --readonly, --reportformat String, --rows, --select String, --separator String, --shared, --sort String, --trustcache, --unbuffered, --units hHbBsSkKmMgGtTpPeE, --unquoted, COMMON_OPTIONS ]"
" [ VG|LV|Tag ... ]";
...
commands[88].optional_opt_args[10].opt = history_ARG;
commands[88].optional_opt_args[11].opt = segments_ARG;
commands[88].optional_opt_args[12].opt = aligned_ARG;
commands[88].optional_opt_args[13].opt = all_ARG;
commands[88].optional_opt_args[14].opt = binary_ARG;
...
commands[88].optional_opt_args[20].opt = nameprefixes_ARG;
commands[88].optional_opt_args[21].opt = noheadings_ARG;
commands[88].optional_opt_args[22].opt = nolocking_ARG;
commands[88].optional_opt_args[23].opt = nosuffix_ARG;
commands[88].optional_opt_args[24].opt = options_ARG;
commands[88].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[88].optional_opt_args[25].opt = partial_ARG;
commands[88].optional_opt_args[26].opt = readonly_ARG;
commands[88].optional_opt_args[27].opt = reportformat_ARG;
commands[88].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[88].optional_opt_args[28].opt = rows_ARG;
commands[88].optional_opt_args[29].opt = select_ARG;
commands[88].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[88].optional_opt_args[30].opt = separator_ARG;
commands[88].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[88].optional_opt_args[31].opt = shared_ARG;
commands[88].optional_opt_args[32].opt = sort_ARG;
commands[88].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[88].optional_opt_args[33].opt = trustcache_ARG;
commands[88].optional_opt_args[34].opt = unbuffered_ARG;
commands[88].optional_opt_args[35].opt = units_ARG;
commands[88].optional_opt_args[35].def.val_bits = val_enum_to_bit(units_VAL);
commands[88].optional_opt_args[36].opt = unquoted_ARG;
commands[88].optional_pos_args[0].pos = 1;
commands[88].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL);
commands[88].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[89].name = "lvscan";
commands[89].command_line_id = "lvscan_general";
commands[89].command_line_enum = lvscan_general_CMD;
commands[89].fn = lvscan;
commands[89].ro_count = 0;
commands[89].rp_count = 0;
commands[89].oo_count = 17;
commands[89].op_count = 0;
commands[89].desc = "";
commands[89].usage = "lvscan"
" [ --all, --blockdevice, --ignorelockingfailure, --partial, --readonly, --reportformat String, --cache, COMMON_OPTIONS ]";
...
commands[89].optional_opt_args[10].opt = all_ARG;
commands[89].optional_opt_args[11].opt = blockdevice_ARG;
commands[89].optional_opt_args[12].opt = ignorelockingfailure_ARG;
commands[89].optional_opt_args[13].opt = partial_ARG;
commands[89].optional_opt_args[14].opt = readonly_ARG;
commands[89].optional_opt_args[15].opt = reportformat_ARG;
commands[89].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[89].optional_opt_args[16].opt = cache_long_ARG;

commands[90].name = "pvchange";
commands[90].command_line_id = "pvchange_properties_all";
commands[90].command_line_enum = pvchange_properties_all_CMD;
commands[90].fn = pvchange;
commands[90].ro_count = 6;
commands[90].rp_count = 0;
commands[90].oo_count = 16;
commands[90].op_count = 0;
commands[90].cmd_flags = CMD_FLAG_ONE_REQUIRED_OPT;
commands[90].desc = "DESC: Change properties of all PVs.";
commands[90].usage = "pvchange ( --allocatable y|n, --addtag Tag, --deltag Tag, --uuid, --metadataignore y|n, --all )"
" [ COMMON_OPTIONS ]";
commands[90].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoreskippedcluster, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --test, --uuid, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[90].required_opt_args[0].opt = allocatable_ARG;
commands[90].required_opt_args[0].def.val_bits = val_enum_to_bit(bool_VAL);
commands[90].required_opt_args[1].opt = addtag_ARG;
commands[90].required_opt_args[1].def.val_bits = val_enum_to_bit(tag_VAL);
commands[90].required_opt_args[2].opt = deltag_ARG;
commands[90].required_opt_args[2].def.val_bits = val_enum_to_bit(tag_VAL);
commands[90].required_opt_args[3].opt = uuid_ARG;
commands[90].required_opt_args[4].opt = metadataignore_ARG;
commands[90].required_opt_args[4].def.val_bits = val_enum_to_bit(bool_VAL);
commands[90].required_opt_args[5].opt = all_ARG;
...
commands[90].optional_opt_args[10].opt = autobackup_ARG;
commands[90].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[90].optional_opt_args[11].opt = force_ARG;
commands[90].optional_opt_args[12].opt = ignoreskippedcluster_ARG;
commands[90].optional_opt_args[13].opt = reportformat_ARG;
commands[90].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[90].optional_opt_args[14].opt = test_ARG;
commands[90].optional_opt_args[15].opt = uuid_ARG;

commands[91].name = "pvchange";
commands[91].command_line_id = "pvchange_properties_some";
commands[91].command_line_enum = pvchange_properties_some_CMD;
commands[91].fn = pvchange;
commands[91].ro_count = 5;
commands[91].rp_count = 1;
commands[91].oo_count = 17;
commands[91].op_count = 0;
commands[91].cmd_flags = CMD_FLAG_ONE_REQUIRED_OPT;
commands[91].desc = "DESC: Change properties of specified PVs.";
commands[91].usage = "pvchange ( --allocatable y|n, --addtag Tag, --deltag Tag, --uuid, --metadataignore y|n ) PV|Select ..."
" [ --select String, COMMON_OPTIONS ]";
...
commands[91].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL) | val_enum_to_bit(select_VAL);
...
commands[91].optional_opt_args[10].opt = select_ARG;
commands[91].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[91].optional_opt_args[11].opt = autobackup_ARG;
commands[91].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[91].optional_opt_args[12].opt = force_ARG;
commands[91].optional_opt_args[13].opt = ignoreskippedcluster_ARG;
commands[91].optional_opt_args[14].opt = reportformat_ARG;
commands[91].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[91].optional_opt_args[15].opt = test_ARG;
commands[91].optional_opt_args[16].opt = uuid_ARG;

commands[92].name = "pvresize";
commands[92].command_line_id = "pvresize_general";
commands[92].command_line_enum = pvresize_general_CMD;
commands[92].fn = pvresize;
commands[92].ro_count = 0;
commands[92].rp_count = 1;
commands[92].oo_count = 13;
commands[92].op_count = 0;
commands[92].desc = "";
commands[92].usage = "pvresize PV ..."
" [ --setphysicalvolumesize Number[m|unit], --reportformat String, COMMON_OPTIONS ]";
commands[92].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[92].required_pos_args[0].pos = 1;
commands[92].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
...
commands[92].optional_opt_args[10].opt = physicalvolumesize_ARG;
commands[92].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[92].optional_opt_args[11].opt = reportformat_ARG;
commands[92].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[92].optional_opt_args[12].opt = test_ARG;

commands[93].name = "pvck";
commands[93].command_line_id = "pvck_general";
commands[93].command_line_enum = pvck_general_CMD;
commands[93].fn = pvck;
commands[93].ro_count = 0;
commands[93].rp_count = 1;
commands[93].oo_count = 11;
commands[93].op_count = 0;
commands[93].desc = "";
commands[93].usage = "pvck PV ..."
" [ --labelsector Number, COMMON_OPTIONS ]";
...
commands[93].optional_opt_args[10].opt = labelsector_ARG;
commands[93].optional_opt_args[10].def.val_bits = val_enum_to_bit(number_VAL);

commands[94].name = "pvcreate";
commands[94].command_line_id = "pvcreate_general";
commands[94].command_line_enum = pvcreate_general_CMD;
commands[94].fn = pvcreate;
commands[94].ro_count = 0;
commands[94].rp_count = 1;
commands[94].oo_count = 27;
commands[94].op_count = 0;
commands[94].desc = "";
commands[94].usage = "pvcreate PV ..."
" [ --dataalignment Number[k|unit], --dataalignmentoffset Number[k|unit], --bootloaderareasize Number[m|unit], --labelsector Number, --metadatatype lvm2|lvm1, --pvmetadatacopies Number, --metadatacopies all|unmanaged|Number, --metadatasize Number[m|unit], --metadataignore y|n, --norestorefile, --setphysicalvolumesize Number[m|unit], --reportformat String, --restorefile String, --uuid String, --zero y|n, COMMON_OPTIONS ]";
...
commands[94].optional_opt_args[10].opt = dataalignment_ARG;
commands[94].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[94].optional_opt_args[11].opt = dataalignmentoffset_ARG;
commands[94].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[94].optional_opt_args[12].opt = bootloaderareasize_ARG;
commands[94].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[94].optional_opt_args[13].opt = force_ARG;
commands[94].optional_opt_args[14].opt = test_ARG;
commands[94].optional_opt_args[15].opt = labelsector_ARG;
commands[94].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[94].optional_opt_args[16].opt = metadatatype_ARG;
commands[94].optional_opt_args[16].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[94].optional_opt_args[17].opt = pvmetadatacopies_ARG;
commands[94].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[94].optional_opt_args[18].opt = metadatacopies_ARG;
commands[94].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[94].optional_opt_args[19].opt = metadatasize_ARG;
commands[94].optional_opt_args[19].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[94].optional_opt_args[20].opt = metadataignore_ARG;
commands[94].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[94].optional_opt_args[21].opt = norestorefile_ARG;
commands[94].optional_opt_args[22].opt = physicalvolumesize_ARG;
commands[94].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[94].optional_opt_args[23].opt = reportformat_ARG;
commands[94].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[94].optional_opt_args[24].opt = restorefile_ARG;
commands[94].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[94].optional_opt_args[25].opt = uuidstr_ARG;
commands[94].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[94].optional_opt_args[26].opt = zero_ARG;
commands[94].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);

commands[95].name = "pvdisplay";
commands[95].command_line_id = "pvdisplay_general";
commands[95].command_line_enum = pvdisplay_general_CMD;
commands[95].fn = pvdisplay;
commands[95].ro_count = 0;
commands[95].rp_count = 0;
commands[95].oo_count = 33;
commands[95].op_count = 1;
commands[95].desc = "";
commands[95].usage = "pvdisplay"
" [ --aligned, --all, --binary, --colon, --columns, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --maps, --noheadings, --nosuffix, --options String, --readonly, --reportformat String, --select String, --separator String, --shared, --short, --sort String, --unbuffered, --units hHbBsSkKmMgGtTpPeE, COMMON_OPTIONS ]"
" [ PV|Tag ... ]";
...
commands[95].optional_opt_args[10].opt = aligned_ARG;
commands[95].optional_opt_args[11].opt = all_ARG;
commands[95].optional_opt_args[12].opt = binary_ARG;
commands[95].optional_opt_args[13].opt = colon_ARG;
commands[95].optional_opt_args[14].opt = columns_ARG;
commands[95].optional_opt_args[15].opt = configreport_ARG;
commands[95].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[16].opt = foreign_ARG;
commands[95].optional_opt_args[17].opt = ignorelockingfailure_ARG;
commands[95].optional_opt_args[18].opt = ignoreskippedcluster_ARG;
commands[95].optional_opt_args[19].opt = logonly_ARG;
commands[95].optional_opt_args[20].opt = maps_ARG;
commands[95].optional_opt_args[21].opt = noheadings_ARG;
commands[95].optional_opt_args[22].opt = nosuffix_ARG;
commands[95].optional_opt_args[23].opt = options_ARG;
commands[95].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[24].opt = readonly_ARG;
commands[95].optional_opt_args[25].opt = reportformat_ARG;
commands[95].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[26].opt = select_ARG;
commands[95].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[27].opt = separator_ARG;
commands[95].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[28].opt = shared_ARG;
commands[95].optional_opt_args[29].opt = short_ARG;
commands[95].optional_opt_args[30].opt = sort_ARG;
commands[95].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[95].optional_opt_args[31].opt = unbuffered_ARG;
commands[95].optional_opt_args[32].opt = units_ARG;
commands[95].optional_opt_args[32].def.val_bits = val_enum_to_bit(units_VAL);
commands[95].optional_pos_args[0].pos = 1;
commands[95].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL) | val_enum_to_bit(tag_VAL);
commands[95].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[96].name = "pvmove";
commands[96].command_line_id = "pvmove_one";
commands[96].command_line_enum = pvmove_one_CMD;
commands[96].fn = pvmove;
commands[96].ro_count = 0;
commands[96].rp_count = 1;
commands[96].oo_count = 20;
commands[96].op_count = 1;
commands[96].desc = "DESC: Move PV extents.";
commands[96].usage = "pvmove PV"
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --atomic, --autobackup y|n, --interval Number, --name LV, --reportformat String, COMMON_OPTIONS ]"
" [ PV ... ]";
commands[96].usage_common = 
" [ --abort, --commandprofile String, --config String, --driverloaded y|n, --profile String, --version, --background, --debug, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
...
commands[96].optional_opt_args[10].opt = abort_ARG;
commands[96].optional_opt_args[11].opt = alloc_ARG;
commands[96].optional_opt_args[11].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[96].optional_opt_args[12].opt = atomic_ARG;
commands[96].optional_opt_args[13].opt = autobackup_ARG;
commands[96].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[96].optional_opt_args[14].opt = background_ARG;
commands[96].optional_opt_args[15].opt = interval_ARG;
commands[96].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[96].optional_opt_args[16].opt = name_ARG;
commands[96].optional_opt_args[16].def.val_bits = val_enum_to_bit(lv_VAL);
commands[96].optional_opt_args[17].opt = noudevsync_ARG;
commands[96].optional_opt_args[18].opt = reportformat_ARG;
commands[96].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[96].optional_opt_args[19].opt = test_ARG;
commands[96].optional_pos_args[0].pos = 2;
commands[96].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[96].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[97].name = "pvmove";
commands[97].command_line_id = "pvmove_any";
commands[97].command_line_enum = pvmove_any_CMD;
commands[97].fn = pvmove;
commands[97].ro_count = 0;
commands[97].rp_count = 0;
commands[97].oo_count = 13;
commands[97].op_count = 0;
commands[97].desc = "DESC: Continue or abort existing pvmove operations.";
commands[97].usage = "pvmove"
" [ COMMON_OPTIONS ]";
...
commands[97].optional_opt_args[11].opt = background_ARG;
commands[97].optional_opt_args[12].opt = test_ARG;

commands[98].name = "pvremove";
commands[98].command_line_id = "pvremove_general";
commands[98].command_line_enum = pvremove_general_CMD;
commands[98].fn = pvremove;
commands[98].ro_count = 0;
commands[98].rp_count = 1;
commands[98].oo_count = 13;
commands[98].op_count = 0;
commands[98].desc = "";
commands[98].usage = "pvremove PV ..."
" [ --reportformat String, COMMON_OPTIONS ]";
commands[98].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[98].required_pos_args[0].pos = 1;
commands[98].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[98].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[98].optional_opt_args[10].opt = force_ARG;
commands[98].optional_opt_args[11].opt = reportformat_ARG;
commands[98].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[98].optional_opt_args[12].opt = test_ARG;

commands[99].name = "pvs";
commands[99].command_line_id = "pvs_general";
commands[99].command_line_enum = pvs_general_CMD;
commands[99].fn = pvs;
commands[99].ro_count = 0;
commands[99].rp_count = 0;
commands[99].oo_count = 36;
commands[99].op_count = 1;
commands[99].desc = "";
commands[99].usage = "pvs"
...
commands[99].optional_opt_args[10].opt = segments_ARG;
commands[99].optional_opt_args[11].opt = aligned_ARG;
commands[99].optional_opt_args[12].opt = all_ARG;
commands[99].optional_opt_args[13].opt = binary_ARG;
commands[99].optional_opt_args[14].opt = configreport_ARG;
commands[99].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[15].opt = foreign_ARG;
commands[99].optional_opt_args[16].opt = ignorelockingfailure_ARG;
commands[99].optional_opt_args[17].opt = ignoreskippedcluster_ARG;
commands[99].optional_opt_args[18].opt = logonly_ARG;
commands[99].optional_opt_args[19].opt = nameprefixes_ARG;
commands[99].optional_opt_args[20].opt = noheadings_ARG;
commands[99].optional_opt_args[21].opt = nolocking_ARG;
commands[99].optional_opt_args[22].opt = nosuffix_ARG;
commands[99].optional_opt_args[23].opt = options_ARG;
commands[99].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[24].opt = partial_ARG;
commands[99].optional_opt_args[25].opt = readonly_ARG;
commands[99].optional_opt_args[26].opt = reportformat_ARG;
commands[99].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[27].opt = rows_ARG;
commands[99].optional_opt_args[28].opt = select_ARG;
commands[99].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[29].opt = separator_ARG;
commands[99].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[30].opt = shared_ARG;
commands[99].optional_opt_args[31].opt = sort_ARG;
commands[99].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[99].optional_opt_args[32].opt = trustcache_ARG;
commands[99].optional_opt_args[33].opt = unbuffered_ARG;
commands[99].optional_opt_args[34].opt = units_ARG;
commands[99].optional_opt_args[34].def.val_bits = val_enum_to_bit(units_VAL);
commands[99].optional_opt_args[35].opt = unquoted_ARG;
commands[99].optional_pos_args[0].pos = 1;
commands[99].optional_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL) | val_enum_to_bit(tag_VAL);
commands[99].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[100].name = "pvscan";
commands[100].command_line_id = "pvscan_show";
commands[100].command_line_enum = pvscan_show_CMD;
commands[100].fn = pvscan;
commands[100].ro_count = 0;
commands[100].rp_count = 0;
commands[100].oo_count = 16;
commands[100].op_count = 0;
commands[100].desc = "DESC: Display PV information.";
commands[100].usage = "pvscan"
" [ --exported, --novolumegroup, --short, --uuid, COMMON_OPTIONS ]";
commands[100].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignorelockingfailure, --profile String, --reportformat String, --version, --debug, --help, --quiet, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
...
commands[100].optional_opt_args[11].opt = reportformat_ARG;
commands[100].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[100].optional_opt_args[12].opt = exported_ARG;
commands[100].optional_opt_args[13].opt = novolumegroup_ARG;
commands[100].optional_opt_args[14].opt = short_ARG;
commands[100].optional_opt_args[15].opt = uuid_ARG;

commands[101].name = "pvscan";
commands[101].command_line_id = "pvscan_cache";
commands[101].command_line_enum = pvscan_cache_CMD;
commands[101].fn = pvscan;
commands[101].ro_count = 1;
commands[101].rp_count = 0;
commands[101].oo_count = 16;
commands[101].op_count = 1;
commands[101].desc = "DESC: Populate the lvmetad cache by scanning PVs.";
commands[101].usage = "pvscan --cache"
" [ --background, --activate y|n|ay, --major Number, --minor Number, COMMON_OPTIONS ]"
" [ String|PV ... ]";
commands[101].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignorelockingfailure, --profile String, --reportformat String, --version, --debug, --help, --quiet, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[101].required_opt_args[0].opt = cache_long_ARG;
...
commands[101].optional_opt_args[12].opt = background_ARG;
commands[101].optional_opt_args[13].opt = activate_ARG;
commands[101].optional_opt_args[13].def.val_bits = val_enum_to_bit(activation_VAL);
commands[101].optional_opt_args[14].opt = major_ARG;
commands[101].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[101].optional_opt_args[15].opt = minor_ARG;
commands[101].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[101].optional_pos_args[0].pos = 1;
commands[101].optional_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL) | val_enum_to_bit(pv_VAL);
commands[101].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[102].name = "vgcfgbackup";
commands[102].command_line_id = "vgcfgbackup_general";
commands[102].command_line_enum = vgcfgbackup_general_CMD;
commands[102].fn = vgcfgbackup;
commands[102].ro_count = 0;
commands[102].rp_count = 0;
commands[102].oo_count = 16;
commands[102].op_count = 1;
commands[102].desc = "";
commands[102].usage = "vgcfgbackup"
" [ --file String, --foreign, --ignorelockingfailure, --partial, --readonly, --reportformat String, COMMON_OPTIONS ]"
" [ VG ... ]";
...
commands[102].optional_opt_args[10].opt = file_ARG;
commands[102].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[102].optional_opt_args[11].opt = foreign_ARG;
commands[102].optional_opt_args[12].opt = ignorelockingfailure_ARG;
commands[102].optional_opt_args[13].opt = partial_ARG;
commands[102].optional_opt_args[14].opt = readonly_ARG;
commands[102].optional_opt_args[15].opt = reportformat_ARG;
commands[102].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[102].optional_pos_args[0].pos = 1;
commands[102].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[102].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[103].name = "vgcfgrestore";
commands[103].command_line_id = "vgcfgrestore_by_vg";
commands[103].command_line_enum = vgcfgrestore_by_vg_CMD;
commands[103].fn = vgcfgrestore;
commands[103].ro_count = 0;
commands[103].rp_count = 1;
commands[103].oo_count = 15;
commands[103].op_count = 0;
commands[103].desc = "";
commands[103].usage = "vgcfgrestore VG"
" [ --file String, --force, --list, --metadatatype lvm2|lvm1, COMMON_OPTIONS ]";
commands[103].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --version, --debug, --help, --quiet, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[103].required_pos_args[0].pos = 1;
commands[103].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[103].optional_opt_args[11].opt = force_long_ARG;
commands[103].optional_opt_args[12].opt = list_ARG;
commands[103].optional_opt_args[13].opt = metadatatype_ARG;
commands[103].optional_opt_args[13].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[103].optional_opt_args[14].opt = test_ARG;

commands[104].name = "vgcfgrestore";
commands[104].command_line_id = "vgcfgrestore_by_file";
commands[104].command_line_enum = vgcfgrestore_by_file_CMD;
commands[104].fn = vgcfgrestore;
commands[104].ro_count = 2;
commands[104].rp_count = 0;
commands[104].oo_count = 10;
commands[104].op_count = 0;
commands[104].desc = "";
commands[104].usage = "vgcfgrestore --list --file String"
" [ COMMON_OPTIONS ]";
commands[104].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --version, --debug, --help, --quiet, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[104].required_opt_args[0].opt = list_ARG;
commands[104].required_opt_args[1].opt = file_ARG;
commands[104].required_opt_args[1].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[105].name = "vgchange";
commands[105].command_line_id = "vgchange_properties";
commands[105].command_line_enum = vgchange_properties_CMD;
commands[105].fn = vgchange;
commands[105].ro_count = 16;
commands[105].rp_count = 0;
commands[105].oo_count = 18;
commands[105].op_count = 1;
commands[105].cmd_flags = CMD_FLAG_ONE_REQUIRED_OPT;
commands[105].desc = "DESC: Change a general VG property.";
commands[105].usage = "vgchange ( --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --profile String, --detachprofile, --metadataprofile String )"
" [ COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[105].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[105].required_opt_args[0].opt = addtag_ARG;
commands[105].required_opt_args[0].def.val_bits = val_enum_to_bit(tag_VAL);
commands[105].required_opt_args[1].opt = deltag_ARG;
commands[105].required_opt_args[1].def.val_bits = val_enum_to_bit(tag_VAL);
commands[105].required_opt_args[2].opt = logicalvolume_ARG;
commands[105].required_opt_args[2].def.val_bits = val_enum_to_bit(number_VAL);
commands[105].required_opt_args[3].opt = maxphysicalvolumes_ARG;
commands[105].required_opt_args[3].def.val_bits = val_enum_to_bit(number_VAL);
commands[105].required_opt_args[4].opt = alloc_ARG;
commands[105].required_opt_args[4].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[105].required_opt_args[5].opt = uuid_ARG;
commands[105].required_opt_args[6].opt = clustered_ARG;
commands[105].required_opt_args[6].def.val_bits = val_enum_to_bit(bool_VAL);
commands[105].required_opt_args[7].opt = metadatacopies_ARG;
commands[105].required_opt_args[7].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[105].required_opt_args[8].opt = vgmetadatacopies_ARG;
commands[105].required_opt_args[8].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[105].required_opt_args[9].opt = physicalextentsize_ARG;
commands[105].required_opt_args[9].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[105].required_opt_args[10].opt = resizeable_ARG;
commands[105].required_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[105].required_opt_args[11].opt = systemid_ARG;
commands[105].required_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[105].required_opt_args[12].opt = locktype_ARG;
commands[105].required_opt_args[12].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[105].required_opt_args[13].opt = profile_ARG;
commands[105].required_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[105].required_opt_args[14].opt = detachprofile_ARG;
commands[105].required_opt_args[15].opt = metadataprofile_ARG;
commands[105].required_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[105].optional_opt_args[10].opt = autobackup_ARG;
commands[105].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[105].optional_opt_args[11].opt = ignoremonitoring_ARG;
commands[105].optional_opt_args[12].opt = ignoreskippedcluster_ARG;
commands[105].optional_opt_args[13].opt = noudevsync_ARG;
commands[105].optional_opt_args[14].opt = reportformat_ARG;
commands[105].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[105].optional_opt_args[15].opt = select_ARG;
commands[105].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[105].optional_opt_args[16].opt = test_ARG;
commands[105].optional_opt_args[17].opt = force_ARG;
...
commands[106].command_line_id = "vgchange_monitor";
commands[106].command_line_enum = vgchange_monitor_CMD;
commands[106].fn = vgchange;
commands[106].ro_count = 1;
commands[106].rp_count = 0;
commands[106].oo_count = 37;
commands[106].op_count = 1;
commands[106].desc = "DESC: Start or stop monitoring LVs from dmeventd.";
commands[106].usage = "vgchange --monitor y|n"
" [ --sysinit, --ignorelockingfailure, --poll y|n, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[106].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[106].required_opt_args[0].opt = monitor_ARG;
commands[106].required_opt_args[0].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[106].optional_opt_args[10].opt = sysinit_ARG;
commands[106].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[106].optional_opt_args[12].opt = poll_ARG;
commands[106].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[106].optional_opt_args[13].opt = addtag_ARG;
commands[106].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[106].optional_opt_args[14].opt = deltag_ARG;
commands[106].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[106].optional_opt_args[15].opt = logicalvolume_ARG;
commands[106].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[106].optional_opt_args[16].opt = maxphysicalvolumes_ARG;
commands[106].optional_opt_args[16].def.val_bits = val_enum_to_bit(number_VAL);
commands[106].optional_opt_args[17].opt = alloc_ARG;
commands[106].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[106].optional_opt_args[18].opt = uuid_ARG;
commands[106].optional_opt_args[19].opt = clustered_ARG;
commands[106].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[106].optional_opt_args[20].opt = metadatacopies_ARG;
commands[106].optional_opt_args[20].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[106].optional_opt_args[21].opt = vgmetadatacopies_ARG;
commands[106].optional_opt_args[21].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[106].optional_opt_args[22].opt = physicalextentsize_ARG;
commands[106].optional_opt_args[22].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[106].optional_opt_args[23].opt = resizeable_ARG;
commands[106].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[106].optional_opt_args[24].opt = systemid_ARG;
commands[106].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[106].optional_opt_args[25].opt = locktype_ARG;
commands[106].optional_opt_args[25].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[106].optional_opt_args[26].opt = profile_ARG;
commands[106].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[106].optional_opt_args[27].opt = detachprofile_ARG;
commands[106].optional_opt_args[28].opt = metadataprofile_ARG;
commands[106].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[106].optional_opt_args[29].opt = autobackup_ARG;
commands[106].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[106].optional_opt_args[30].opt = ignoremonitoring_ARG;
commands[106].optional_opt_args[31].opt = ignoreskippedcluster_ARG;
commands[106].optional_opt_args[32].opt = noudevsync_ARG;
commands[106].optional_opt_args[33].opt = reportformat_ARG;
commands[106].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[106].optional_opt_args[34].opt = select_ARG;
commands[106].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[106].optional_opt_args[35].opt = test_ARG;
commands[106].optional_opt_args[36].opt = force_ARG;
...
commands[107].command_line_id = "vgchange_poll";
commands[107].command_line_enum = vgchange_poll_CMD;
commands[107].fn = vgchange;
commands[107].ro_count = 1;
commands[107].rp_count = 0;
commands[107].oo_count = 35;
commands[107].op_count = 1;
commands[107].desc = "DESC: Start or stop processing LV conversions.";
commands[107].usage = "vgchange --poll y|n"
" [ --ignorelockingfailure, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[107].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[107].required_opt_args[0].opt = poll_ARG;
...
commands[107].optional_opt_args[10].opt = ignorelockingfailure_ARG;
commands[107].optional_opt_args[11].opt = addtag_ARG;
commands[107].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[107].optional_opt_args[12].opt = deltag_ARG;
commands[107].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[107].optional_opt_args[13].opt = logicalvolume_ARG;
commands[107].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[107].optional_opt_args[14].opt = maxphysicalvolumes_ARG;
commands[107].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[107].optional_opt_args[15].opt = alloc_ARG;
commands[107].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[107].optional_opt_args[16].opt = uuid_ARG;
commands[107].optional_opt_args[17].opt = clustered_ARG;
commands[107].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].optional_opt_args[18].opt = metadatacopies_ARG;
commands[107].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[107].optional_opt_args[19].opt = vgmetadatacopies_ARG;
commands[107].optional_opt_args[19].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[107].optional_opt_args[20].opt = physicalextentsize_ARG;
commands[107].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[107].optional_opt_args[21].opt = resizeable_ARG;
commands[107].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].optional_opt_args[22].opt = systemid_ARG;
commands[107].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[23].opt = locktype_ARG;
commands[107].optional_opt_args[23].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[107].optional_opt_args[24].opt = profile_ARG;
commands[107].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[25].opt = detachprofile_ARG;
commands[107].optional_opt_args[26].opt = metadataprofile_ARG;
commands[107].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[27].opt = autobackup_ARG;
commands[107].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[107].optional_opt_args[28].opt = ignoremonitoring_ARG;
commands[107].optional_opt_args[29].opt = ignoreskippedcluster_ARG;
commands[107].optional_opt_args[30].opt = noudevsync_ARG;
commands[107].optional_opt_args[31].opt = reportformat_ARG;
commands[107].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[32].opt = select_ARG;
commands[107].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[107].optional_opt_args[33].opt = test_ARG;
commands[107].optional_opt_args[34].opt = force_ARG;
...
commands[108].command_line_id = "vgchange_activate";
commands[108].command_line_enum = vgchange_activate_CMD;
commands[108].fn = vgchange;
commands[108].ro_count = 1;
commands[108].rp_count = 0;
commands[108].oo_count = 41;
commands[108].op_count = 1;
commands[108].desc = "DESC: Activate or deactivate LVs.";
commands[108].usage = "vgchange --activate y|n|ay"
...
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[108].required_opt_args[0].opt = activate_ARG;
commands[108].required_opt_args[0].def.val_bits = val_enum_to_bit(activation_VAL);
...
commands[108].optional_opt_args[10].opt = activationmode_ARG;
commands[108].optional_opt_args[10].def.val_bits = val_enum_to_bit(activationmode_VAL);
commands[108].optional_opt_args[11].opt = ignoreactivationskip_ARG;
commands[108].optional_opt_args[12].opt = partial_ARG;
commands[108].optional_opt_args[13].opt = sysinit_ARG;
commands[108].optional_opt_args[14].opt = ignorelockingfailure_ARG;
commands[108].optional_opt_args[15].opt = monitor_ARG;
commands[108].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[16].opt = poll_ARG;
commands[108].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[17].opt = addtag_ARG;
commands[108].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[108].optional_opt_args[18].opt = deltag_ARG;
commands[108].optional_opt_args[18].def.val_bits = val_enum_to_bit(tag_VAL);
commands[108].optional_opt_args[19].opt = logicalvolume_ARG;
commands[108].optional_opt_args[19].def.val_bits = val_enum_to_bit(number_VAL);
commands[108].optional_opt_args[20].opt = maxphysicalvolumes_ARG;
commands[108].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[108].optional_opt_args[21].opt = alloc_ARG;
commands[108].optional_opt_args[21].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[108].optional_opt_args[22].opt = uuid_ARG;
commands[108].optional_opt_args[23].opt = clustered_ARG;
commands[108].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[24].opt = metadatacopies_ARG;
commands[108].optional_opt_args[24].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[108].optional_opt_args[25].opt = vgmetadatacopies_ARG;
commands[108].optional_opt_args[25].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[108].optional_opt_args[26].opt = physicalextentsize_ARG;
commands[108].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[108].optional_opt_args[27].opt = resizeable_ARG;
commands[108].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[28].opt = systemid_ARG;
commands[108].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[29].opt = locktype_ARG;
commands[108].optional_opt_args[29].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[108].optional_opt_args[30].opt = profile_ARG;
commands[108].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[31].opt = detachprofile_ARG;
commands[108].optional_opt_args[32].opt = metadataprofile_ARG;
commands[108].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[33].opt = autobackup_ARG;
commands[108].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[108].optional_opt_args[34].opt = ignoremonitoring_ARG;
commands[108].optional_opt_args[35].opt = ignoreskippedcluster_ARG;
commands[108].optional_opt_args[36].opt = noudevsync_ARG;
commands[108].optional_opt_args[37].opt = reportformat_ARG;
commands[108].optional_opt_args[37].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[38].opt = select_ARG;
commands[108].optional_opt_args[38].def.val_bits = val_enum_to_bit(string_VAL);
commands[108].optional_opt_args[39].opt = test_ARG;
commands[108].optional_opt_args[40].opt = force_ARG;
...
commands[109].command_line_id = "vgchange_refresh";
commands[109].command_line_enum = vgchange_refresh_CMD;
commands[109].fn = vgchange;
commands[109].ro_count = 1;
commands[109].rp_count = 0;
commands[109].oo_count = 38;
commands[109].op_count = 1;
commands[109].desc = "DESC: Reactivate LVs using the latest metadata.";
commands[109].usage = "vgchange --refresh"
" [ --sysinit, --ignorelockingfailure, --monitor y|n, --poll y|n, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[109].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[109].required_opt_args[0].opt = refresh_ARG;
...
commands[109].optional_opt_args[10].opt = sysinit_ARG;
commands[109].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[109].optional_opt_args[12].opt = monitor_ARG;
commands[109].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[13].opt = poll_ARG;
commands[109].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[14].opt = addtag_ARG;
commands[109].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[109].optional_opt_args[15].opt = deltag_ARG;
commands[109].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[109].optional_opt_args[16].opt = logicalvolume_ARG;
commands[109].optional_opt_args[16].def.val_bits = val_enum_to_bit(number_VAL);
commands[109].optional_opt_args[17].opt = maxphysicalvolumes_ARG;
commands[109].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[109].optional_opt_args[18].opt = alloc_ARG;
commands[109].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[109].optional_opt_args[19].opt = uuid_ARG;
commands[109].optional_opt_args[20].opt = clustered_ARG;
commands[109].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[21].opt = metadatacopies_ARG;
commands[109].optional_opt_args[21].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[109].optional_opt_args[22].opt = vgmetadatacopies_ARG;
commands[109].optional_opt_args[22].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[109].optional_opt_args[23].opt = physicalextentsize_ARG;
commands[109].optional_opt_args[23].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[109].optional_opt_args[24].opt = resizeable_ARG;
commands[109].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[25].opt = systemid_ARG;
commands[109].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[26].opt = locktype_ARG;
commands[109].optional_opt_args[26].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[109].optional_opt_args[27].opt = profile_ARG;
commands[109].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[28].opt = detachprofile_ARG;
commands[109].optional_opt_args[29].opt = metadataprofile_ARG;
commands[109].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[30].opt = autobackup_ARG;
commands[109].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[109].optional_opt_args[31].opt = ignoremonitoring_ARG;
commands[109].optional_opt_args[32].opt = ignoreskippedcluster_ARG;
commands[109].optional_opt_args[33].opt = noudevsync_ARG;
commands[109].optional_opt_args[34].opt = reportformat_ARG;
commands[109].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[35].opt = select_ARG;
commands[109].optional_opt_args[35].def.val_bits = val_enum_to_bit(string_VAL);
commands[109].optional_opt_args[36].opt = test_ARG;
commands[109].optional_opt_args[37].opt = force_ARG;
...
commands[110].command_line_id = "vgchange_lockstart";
commands[110].command_line_enum = vgchange_lockstart_CMD;
commands[110].fn = vgchange;
commands[110].ro_count = 1;
commands[110].rp_count = 0;
commands[110].oo_count = 35;
commands[110].op_count = 1;
commands[110].desc = "DESC: Start the lockspace of a shared VG in lvmlockd.";
commands[110].usage = "vgchange --lockstart"
" [ --lockopt String, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[110].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[110].required_opt_args[0].opt = lockstart_ARG;
...
commands[110].optional_opt_args[10].opt = lockopt_ARG;
commands[110].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[11].opt = addtag_ARG;
commands[110].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[110].optional_opt_args[12].opt = deltag_ARG;
commands[110].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[110].optional_opt_args[13].opt = logicalvolume_ARG;
commands[110].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[110].optional_opt_args[14].opt = maxphysicalvolumes_ARG;
commands[110].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[110].optional_opt_args[15].opt = alloc_ARG;
commands[110].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[110].optional_opt_args[16].opt = uuid_ARG;
commands[110].optional_opt_args[17].opt = clustered_ARG;
commands[110].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[18].opt = metadatacopies_ARG;
commands[110].optional_opt_args[18].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[110].optional_opt_args[19].opt = vgmetadatacopies_ARG;
commands[110].optional_opt_args[19].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[110].optional_opt_args[20].opt = physicalextentsize_ARG;
commands[110].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[110].optional_opt_args[21].opt = resizeable_ARG;
commands[110].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[22].opt = systemid_ARG;
commands[110].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[23].opt = locktype_ARG;
commands[110].optional_opt_args[23].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[110].optional_opt_args[24].opt = profile_ARG;
commands[110].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[25].opt = detachprofile_ARG;
commands[110].optional_opt_args[26].opt = metadataprofile_ARG;
commands[110].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[27].opt = autobackup_ARG;
commands[110].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[110].optional_opt_args[28].opt = ignoremonitoring_ARG;
commands[110].optional_opt_args[29].opt = ignoreskippedcluster_ARG;
commands[110].optional_opt_args[30].opt = noudevsync_ARG;
commands[110].optional_opt_args[31].opt = reportformat_ARG;
commands[110].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[32].opt = select_ARG;
commands[110].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[110].optional_opt_args[33].opt = test_ARG;
commands[110].optional_opt_args[34].opt = force_ARG;
...
commands[111].command_line_id = "vgchange_lockstop";
commands[111].command_line_enum = vgchange_lockstop_CMD;
commands[111].fn = vgchange;
commands[111].ro_count = 1;
commands[111].rp_count = 0;
commands[111].oo_count = 35;
commands[111].op_count = 1;
commands[111].desc = "DESC: Stop the lockspace of a shared VG in lvmlockd.";
commands[111].usage = "vgchange --lockstop"
" [ --lockopt String, --addtag Tag, --deltag Tag, --logicalvolume Number, --maxphysicalvolumes Number, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --uuid, --clustered y|n, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --physicalextentsize Number[m|unit], --resizeable y|n, --systemid String, --locktype sanlock|dlm|none, --detachprofile, --metadataprofile String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
commands[111].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --ignoremonitoring, --ignoreskippedcluster, --noudevsync, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --select String, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[111].required_opt_args[0].opt = lockstop_ARG;
...
commands[112].name = "vgck";
commands[112].command_line_id = "vgck_general";
commands[112].command_line_enum = vgck_general_CMD;
commands[112].fn = vgck;
commands[112].ro_count = 0;
commands[112].rp_count = 0;
commands[112].oo_count = 11;
commands[112].op_count = 1;
commands[112].desc = "";
commands[112].usage = "vgck"
" [ --reportformat String, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
...
commands[112].optional_opt_args[10].opt = reportformat_ARG;
...
commands[113].name = "vgconvert";
commands[113].command_line_id = "vgconvert_general";
commands[113].command_line_enum = vgconvert_general_CMD;
commands[113].fn = vgconvert;
commands[113].ro_count = 0;
commands[113].rp_count = 1;
commands[113].oo_count = 18;
commands[113].op_count = 0;
commands[113].desc = "";
commands[113].usage = "vgconvert VG ..."
" [ --labelsector Number, --bootloaderareasize Number[m|unit], --metadatatype lvm2|lvm1, --pvmetadatacopies Number, --metadatasize Number[m|unit], --reportformat String, COMMON_OPTIONS ]";
commands[113].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[113].required_pos_args[0].pos = 1;
commands[113].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[113].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[113].optional_opt_args[11].opt = test_ARG;
commands[113].optional_opt_args[12].opt = labelsector_ARG;
commands[113].optional_opt_args[12].def.val_bits = val_enum_to_bit(number_VAL);
commands[113].optional_opt_args[13].opt = bootloaderareasize_ARG;
commands[113].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[113].optional_opt_args[14].opt = metadatatype_ARG;
commands[113].optional_opt_args[14].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[113].optional_opt_args[15].opt = pvmetadatacopies_ARG;
commands[113].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[113].optional_opt_args[16].opt = metadatasize_ARG;
commands[113].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[113].optional_opt_args[17].opt = reportformat_ARG;
commands[113].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);

commands[114].name = "vgcreate";
commands[114].command_line_id = "vgcreate_general";
commands[114].command_line_enum = vgcreate_general_CMD;
commands[114].fn = vgcreate;
commands[114].ro_count = 0;
commands[114].rp_count = 2;
commands[114].oo_count = 34;
commands[114].op_count = 0;
commands[114].desc = "";
commands[114].usage = "vgcreate VG_new PV ..."
" [ --addtag Tag, --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --autobackup y|n, --clustered y|n, --maxlogicalvolumes Number, --maxphysicalvolumes Number, --metadataprofile String, --metadatatype lvm2|lvm1, --physicalextentsize Number[m|unit], --zero y|n, --labelsector Number, --metadatasize Number[m|unit], --pvmetadatacopies Number, --reportformat String, --metadatacopies all|unmanaged|Number, --vgmetadatacopies all|unmanaged|Number, --dataalignment Number[k|unit], --dataalignmentoffset Number[k|unit], --shared, --systemid String, --locktype sanlock|dlm|none, --lockopt String, COMMON_OPTIONS ]";
...
commands[114].required_pos_args[0].def.flags = ARG_DEF_FLAG_NEW;
commands[114].required_pos_args[1].pos = 2;
commands[114].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[114].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[114].optional_opt_args[10].opt = addtag_ARG;
commands[114].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[114].optional_opt_args[11].opt = alloc_ARG;
commands[114].optional_opt_args[11].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[114].optional_opt_args[12].opt = autobackup_ARG;
commands[114].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[114].optional_opt_args[13].opt = clustered_ARG;
commands[114].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[114].optional_opt_args[14].opt = maxlogicalvolumes_ARG;
commands[114].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[114].optional_opt_args[15].opt = maxphysicalvolumes_ARG;
commands[114].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[114].optional_opt_args[16].opt = metadataprofile_ARG;
commands[114].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[114].optional_opt_args[17].opt = metadatatype_ARG;
commands[114].optional_opt_args[17].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[114].optional_opt_args[18].opt = physicalextentsize_ARG;
commands[114].optional_opt_args[18].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[114].optional_opt_args[19].opt = test_ARG;
commands[114].optional_opt_args[20].opt = force_ARG;
commands[114].optional_opt_args[21].opt = zero_ARG;
commands[114].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[114].optional_opt_args[22].opt = labelsector_ARG;
commands[114].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[114].optional_opt_args[23].opt = metadatasize_ARG;
commands[114].optional_opt_args[23].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[114].optional_opt_args[24].opt = pvmetadatacopies_ARG;
commands[114].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[114].optional_opt_args[25].opt = reportformat_ARG;
commands[114].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[114].optional_opt_args[26].opt = metadatacopies_ARG;
commands[114].optional_opt_args[26].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[114].optional_opt_args[27].opt = vgmetadatacopies_ARG;
commands[114].optional_opt_args[27].def.val_bits = val_enum_to_bit(metadatacopies_VAL);
commands[114].optional_opt_args[28].opt = dataalignment_ARG;
commands[114].optional_opt_args[28].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[114].optional_opt_args[29].opt = dataalignmentoffset_ARG;
commands[114].optional_opt_args[29].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[114].optional_opt_args[30].opt = shared_ARG;
commands[114].optional_opt_args[31].opt = systemid_ARG;
commands[114].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[114].optional_opt_args[32].opt = locktype_ARG;
commands[114].optional_opt_args[32].def.val_bits = val_enum_to_bit(locktype_VAL);
commands[114].optional_opt_args[33].opt = lockopt_ARG;
commands[114].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);

commands[115].name = "vgdisplay";
commands[115].command_line_id = "vgdisplay_general";
commands[115].command_line_enum = vgdisplay_general_CMD;
commands[115].fn = vgdisplay;
commands[115].ro_count = 0;
commands[115].rp_count = 0;
commands[115].oo_count = 33;
commands[115].op_count = 1;
commands[115].desc = "";
commands[115].usage = "vgdisplay"
" [ --activevolumegroups, --aligned, --binary, --colon, --columns, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --noheadings, --nosuffix, --options String, --partial, --readonly, --reportformat String, --select String, --shared, --short, --separator String, --sort String, --unbuffered, --units hHbBsSkKmMgGtTpPeE, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
...
commands[115].optional_opt_args[10].opt = activevolumegroups_ARG;
commands[115].optional_opt_args[11].opt = aligned_ARG;
commands[115].optional_opt_args[12].opt = binary_ARG;
commands[115].optional_opt_args[13].opt = colon_ARG;
commands[115].optional_opt_args[14].opt = columns_ARG;
commands[115].optional_opt_args[15].opt = configreport_ARG;
commands[115].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[115].optional_opt_args[16].opt = foreign_ARG;
commands[115].optional_opt_args[17].opt = ignorelockingfailure_ARG;
commands[115].optional_opt_args[18].opt = ignoreskippedcluster_ARG;
commands[115].optional_opt_args[19].opt = logonly_ARG;
commands[115].optional_opt_args[20].opt = noheadings_ARG;
commands[115].optional_opt_args[21].opt = nosuffix_ARG;
commands[115].optional_opt_args[22].opt = options_ARG;
commands[115].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[115].optional_opt_args[23].opt = partial_ARG;
commands[115].optional_opt_args[24].opt = readonly_ARG;
...
commands[115].optional_opt_args[26].opt = select_ARG;
commands[115].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[115].optional_opt_args[27].opt = shared_ARG;
commands[115].optional_opt_args[28].opt = short_ARG;
commands[115].optional_opt_args[29].opt = separator_ARG;
commands[115].optional_opt_args[29].def.val_bits = val_enum_to_bit(string_VAL);
commands[115].optional_opt_args[30].opt = sort_ARG;
commands[115].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[115].optional_opt_args[31].opt = unbuffered_ARG;
commands[115].optional_opt_args[32].opt = units_ARG;
commands[115].optional_opt_args[32].def.val_bits = val_enum_to_bit(units_VAL);
...
commands[116].name = "vgexport";
commands[116].command_line_id = "vgexport_some";
commands[116].command_line_enum = vgexport_some_CMD;
commands[116].fn = vgexport;
commands[116].ro_count = 0;
commands[116].rp_count = 1;
commands[116].oo_count = 13;
commands[116].op_count = 0;
commands[116].desc = "DESC: Export specified VGs.";
commands[116].usage = "vgexport VG|Tag|Select ..."
" [ --select String, COMMON_OPTIONS ]";
commands[116].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --debug, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[116].required_pos_args[0].pos = 1;
commands[116].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[116].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[116].optional_opt_args[10].opt = select_ARG;
commands[116].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[116].optional_opt_args[11].opt = reportformat_ARG;
commands[116].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[116].optional_opt_args[12].opt = test_ARG;

commands[117].name = "vgexport";
commands[117].command_line_id = "vgexport_all";
commands[117].command_line_enum = vgexport_all_CMD;
commands[117].fn = vgexport;
commands[117].ro_count = 1;
commands[117].rp_count = 0;
commands[117].oo_count = 12;
commands[117].op_count = 0;
commands[117].desc = "DESC: Export all VGs.";
commands[117].usage = "vgexport --all"
" [ COMMON_OPTIONS ]";
commands[117].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --debug, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[117].required_opt_args[0].opt = all_ARG;
...
commands[117].optional_opt_args[10].opt = reportformat_ARG;
commands[117].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[117].optional_opt_args[11].opt = test_ARG;

commands[118].name = "vgextend";
commands[118].command_line_id = "vgextend_general";
commands[118].command_line_enum = vgextend_general_CMD;
commands[118].fn = vgextend;
commands[118].ro_count = 0;
commands[118].rp_count = 2;
commands[118].oo_count = 23;
commands[118].op_count = 0;
commands[118].desc = "";
commands[118].usage = "vgextend VG PV ..."
" [ --autobackup y|n, --zero y|n, --labelsector Number, --metadatatype lvm2|lvm1, --metadatasize Number[m|unit], --pvmetadatacopies Number, --metadataignore y|n, --dataalignment Number[k|unit], --dataalignmentoffset Number[k|unit], --reportformat String, --restoremissing, COMMON_OPTIONS ]";
...
commands[118].required_pos_args[1].pos = 2;
commands[118].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[118].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[118].optional_opt_args[12].opt = force_ARG;
commands[118].optional_opt_args[13].opt = zero_ARG;
commands[118].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[118].optional_opt_args[14].opt = labelsector_ARG;
commands[118].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[118].optional_opt_args[15].opt = metadatatype_ARG;
commands[118].optional_opt_args[15].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[118].optional_opt_args[16].opt = metadatasize_ARG;
commands[118].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[118].optional_opt_args[17].opt = pvmetadatacopies_ARG;
commands[118].optional_opt_args[17].def.val_bits = val_enum_to_bit(number_VAL);
commands[118].optional_opt_args[18].opt = metadataignore_ARG;
commands[118].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[118].optional_opt_args[19].opt = dataalignment_ARG;
commands[118].optional_opt_args[19].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[118].optional_opt_args[20].opt = dataalignmentoffset_ARG;
commands[118].optional_opt_args[20].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[118].optional_opt_args[21].opt = reportformat_ARG;
commands[118].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[118].optional_opt_args[22].opt = restoremissing_ARG;

commands[119].name = "vgimport";
commands[119].command_line_id = "vgimport_some";
commands[119].command_line_enum = vgimport_some_CMD;
commands[119].fn = vgimport;
commands[119].ro_count = 0;
commands[119].rp_count = 1;
commands[119].oo_count = 14;
commands[119].op_count = 0;
commands[119].desc = "DESC: Import specified VGs.";
commands[119].usage = "vgimport VG|Tag|Select ..."
" [ --select String, COMMON_OPTIONS ]";
commands[119].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[119].required_pos_args[0].pos = 1;
commands[119].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[119].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[119].optional_opt_args[10].opt = select_ARG;
commands[119].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[119].optional_opt_args[11].opt = force_ARG;
commands[119].optional_opt_args[12].opt = reportformat_ARG;
commands[119].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[119].optional_opt_args[13].opt = test_ARG;

commands[120].name = "vgimport";
commands[120].command_line_id = "vgimport_all";
commands[120].command_line_enum = vgimport_all_CMD;
commands[120].fn = vgimport;
commands[120].ro_count = 1;
commands[120].rp_count = 0;
commands[120].oo_count = 13;
commands[120].op_count = 0;
commands[120].desc = "DESC: Import all VGs.";
commands[120].usage = "vgimport --all"
" [ COMMON_OPTIONS ]";
commands[120].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[120].required_opt_args[0].opt = all_ARG;
...
commands[120].optional_opt_args[11].opt = reportformat_ARG;
commands[120].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[120].optional_opt_args[12].opt = test_ARG;

commands[121].name = "vgimportclone";
commands[121].command_line_id = "vgimportclone_general";
commands[121].command_line_enum = vgimportclone_general_CMD;
commands[121].fn = vgimportclone;
commands[121].ro_count = 0;
commands[121].rp_count = 1;
commands[121].oo_count = 13;
commands[121].op_count = 0;
commands[121].desc = "";
commands[121].usage = "vgimportclone PV ..."
" [ --basevgname VG, --import, COMMON_OPTIONS ]";
commands[121].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[121].required_pos_args[0].pos = 1;
commands[121].required_pos_args[0].def.val_bits = val_enum_to_bit(pv_VAL);
commands[121].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[121].optional_opt_args[10].opt = basevgname_ARG;
commands[121].optional_opt_args[10].def.val_bits = val_enum_to_bit(vg_VAL);
commands[121].optional_opt_args[11].opt = test_ARG;
commands[121].optional_opt_args[12].opt = import_ARG;

commands[122].name = "vgmerge";
commands[122].command_line_id = "vgmerge_general";
commands[122].command_line_enum = vgmerge_general_CMD;
commands[122].fn = vgmerge;
commands[122].ro_count = 0;
commands[122].rp_count = 2;
commands[122].oo_count = 13;
commands[122].op_count = 0;
commands[122].desc = "";
commands[122].usage = "vgmerge VG VG"
" [ --autobackup y|n, --list, COMMON_OPTIONS ]";
commands[122].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[122].required_pos_args[0].pos = 1;
commands[122].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[122].optional_opt_args[11].opt = list_ARG;
commands[122].optional_opt_args[12].opt = test_ARG;

commands[123].name = "vgmknodes";
commands[123].command_line_id = "vgmknodes_general";
commands[123].command_line_enum = vgmknodes_general_CMD;
commands[123].fn = vgmknodes;
commands[123].ro_count = 0;
commands[123].rp_count = 0;
commands[123].oo_count = 13;
commands[123].op_count = 1;
commands[123].desc = "";
commands[123].usage = "vgmknodes"
" [ --ignorelockingfailure, --refresh, --reportformat String, COMMON_OPTIONS ]"
" [ VG|LV|Tag ... ]";
...
commands[123].optional_opt_args[10].opt = ignorelockingfailure_ARG;
commands[123].optional_opt_args[11].opt = refresh_ARG;
commands[123].optional_opt_args[12].opt = reportformat_ARG;
commands[123].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[123].optional_pos_args[0].pos = 1;
commands[123].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(lv_VAL) | val_enum_to_bit(tag_VAL);
commands[123].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[124].name = "vgreduce";
commands[124].command_line_id = "vgreduce_by_pv";
commands[124].command_line_enum = vgreduce_by_pv_CMD;
commands[124].fn = vgreduce;
commands[124].ro_count = 0;
commands[124].rp_count = 2;
commands[124].oo_count = 14;
commands[124].op_count = 0;
commands[124].desc = "DESC: Remove a PV from a VG.";
commands[124].usage = "vgreduce VG PV ..."
" [ COMMON_OPTIONS ]";
commands[124].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[124].required_pos_args[0].pos = 1;
commands[124].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[124].required_pos_args[1].pos = 2;
commands[124].required_pos_args[1].def.val_bits = val_enum_to_bit(pv_VAL);
commands[124].required_pos_args[1].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[124].optional_opt_args[10].opt = autobackup_ARG;
commands[124].optional_opt_args[10].def.val_bits = val_enum_to_bit(bool_VAL);
commands[124].optional_opt_args[11].opt = force_ARG;
...
commands[124].optional_opt_args[13].opt = test_ARG;

commands[125].name = "vgreduce";
commands[125].command_line_id = "vgreduce_all";
commands[125].command_line_enum = vgreduce_all_CMD;
commands[125].fn = vgreduce;
commands[125].ro_count = 1;
commands[125].rp_count = 1;
commands[125].oo_count = 14;
commands[125].op_count = 0;
commands[125].desc = "DESC: Remove all unused PVs from a VG.";
commands[125].usage = "vgreduce --all VG"
" [ COMMON_OPTIONS ]";
commands[125].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[125].required_opt_args[0].opt = all_ARG;
...
commands[126].command_line_id = "vgreduce_missing";
commands[126].command_line_enum = vgreduce_missing_CMD;
commands[126].fn = vgreduce;
commands[126].ro_count = 1;
commands[126].rp_count = 1;
commands[126].oo_count = 15;
commands[126].op_count = 0;
commands[126].desc = "DESC: Remove all missing PVs from a VG.";
commands[126].usage = "vgreduce --removemissing VG"
" [ --mirrorsonly, COMMON_OPTIONS ]";
commands[126].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[126].required_opt_args[0].opt = removemissing_ARG;
...
commands[126].optional_opt_args[10].opt = mirrorsonly_ARG;
commands[126].optional_opt_args[11].opt = autobackup_ARG;
commands[126].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[126].optional_opt_args[12].opt = force_ARG;
commands[126].optional_opt_args[13].opt = reportformat_ARG;
commands[126].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[126].optional_opt_args[14].opt = test_ARG;

commands[127].name = "vgremove";
commands[127].command_line_id = "vgremove_general";
commands[127].command_line_enum = vgremove_general_CMD;
commands[127].fn = vgremove;
commands[127].ro_count = 0;
commands[127].rp_count = 1;
commands[127].oo_count = 15;
commands[127].op_count = 0;
commands[127].desc = "";
commands[127].usage = "vgremove VG|Tag|Select ..."
" [ --reportformat String, --select String, COMMON_OPTIONS ]";
commands[127].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[127].required_pos_args[0].pos = 1;
commands[127].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL) | val_enum_to_bit(select_VAL);
commands[127].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[127].optional_opt_args[11].opt = noudevsync_ARG;
commands[127].optional_opt_args[12].opt = reportformat_ARG;
commands[127].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[127].optional_opt_args[13].opt = select_ARG;
commands[127].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[127].optional_opt_args[14].opt = test_ARG;

commands[128].name = "vgrename";
commands[128].command_line_id = "vgrename_by_name";
commands[128].command_line_enum = vgrename_by_name_CMD;
commands[128].fn = vgrename;
commands[128].ro_count = 0;
commands[128].rp_count = 2;
commands[128].oo_count = 14;
commands[128].op_count = 0;
commands[128].desc = "DESC: Rename a VG.";
commands[128].usage = "vgrename VG VG_new"
" [ COMMON_OPTIONS ]";
...
commands[128].optional_opt_args[11].opt = force_ARG;
...
commands[128].optional_opt_args[13].opt = test_ARG;

commands[129].name = "vgrename";
commands[129].command_line_id = "vgrename_by_uuid";
commands[129].command_line_enum = vgrename_by_uuid_CMD;
commands[129].fn = vgrename;
commands[129].ro_count = 0;
commands[129].rp_count = 2;
commands[129].oo_count = 14;
commands[129].op_count = 0;
commands[129].desc = "DESC: Rename a VG by specifying the VG UUID.";
commands[129].usage = "vgrename String VG_new"
" [ COMMON_OPTIONS ]";
commands[129].usage_common = 
" [ --commandprofile String, --config String, --driverloaded y|n, --profile String, --reportformat String, --version, --autobackup y|n, --debug, --force, --help, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[129].required_pos_args[0].pos = 1;
commands[129].required_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[130].name = "vgs";
commands[130].command_line_id = "vgs_general";
commands[130].command_line_enum = vgs_general_CMD;
commands[130].fn = vgs;
commands[130].ro_count = 0;
commands[130].rp_count = 0;
commands[130].oo_count = 35;
commands[130].op_count = 1;
commands[130].desc = "";
commands[130].usage = "vgs"
" [ --aligned, --all, --binary, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --nameprefixes, --noheadings, --nolocking, --nosuffix, --options String, --partial, --readonly, --reportformat String, --rows, --select String, --separator String, --shared, --sort String, --trustcache, --unbuffered, --units hHbBsSkKmMgGtTpPeE, --unquoted, COMMON_OPTIONS ]"
" [ VG|Tag ... ]";
...
commands[130].optional_opt_args[10].opt = aligned_ARG;
commands[130].optional_opt_args[11].opt = all_ARG;
commands[130].optional_opt_args[12].opt = binary_ARG;
commands[130].optional_opt_args[13].opt = configreport_ARG;
commands[130].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[14].opt = foreign_ARG;
commands[130].optional_opt_args[15].opt = ignorelockingfailure_ARG;
commands[130].optional_opt_args[16].opt = ignoreskippedcluster_ARG;
commands[130].optional_opt_args[17].opt = logonly_ARG;
commands[130].optional_opt_args[18].opt = nameprefixes_ARG;
commands[130].optional_opt_args[19].opt = noheadings_ARG;
commands[130].optional_opt_args[20].opt = nolocking_ARG;
commands[130].optional_opt_args[21].opt = nosuffix_ARG;
commands[130].optional_opt_args[22].opt = options_ARG;
commands[130].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[23].opt = partial_ARG;
commands[130].optional_opt_args[24].opt = readonly_ARG;
commands[130].optional_opt_args[25].opt = reportformat_ARG;
commands[130].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[26].opt = rows_ARG;
commands[130].optional_opt_args[27].opt = select_ARG;
commands[130].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[28].opt = separator_ARG;
commands[130].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[29].opt = shared_ARG;
commands[130].optional_opt_args[30].opt = sort_ARG;
commands[130].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[130].optional_opt_args[31].opt = trustcache_ARG;
commands[130].optional_opt_args[32].opt = unbuffered_ARG;
commands[130].optional_opt_args[33].opt = units_ARG;
commands[130].optional_opt_args[33].def.val_bits = val_enum_to_bit(units_VAL);
commands[130].optional_opt_args[34].opt = unquoted_ARG;
commands[130].optional_pos_args[0].pos = 1;
commands[130].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL) | val_enum_to_bit(tag_VAL);
commands[130].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[131].name = "vgscan";
commands[131].command_line_id = "vgscan_general";
commands[131].command_line_enum = vgscan_general_CMD;
commands[131].fn = vgscan;
commands[131].ro_count = 0;
commands[131].rp_count = 0;
commands[131].oo_count = 16;
commands[131].op_count = 0;
commands[131].desc = "";
commands[131].usage = "vgscan"
" [ --cache, --ignorelockingfailure, --mknodes, --notifydbus, --partial, --reportformat String, COMMON_OPTIONS ]";
...
commands[131].optional_opt_args[10].opt = cache_long_ARG;
commands[131].optional_opt_args[11].opt = ignorelockingfailure_ARG;
commands[131].optional_opt_args[12].opt = mknodes_ARG;
commands[131].optional_opt_args[13].opt = notifydbus_ARG;
commands[131].optional_opt_args[14].opt = partial_ARG;
commands[131].optional_opt_args[15].opt = reportformat_ARG;
commands[131].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);

commands[132].name = "vgsplit";
commands[132].command_line_id = "vgsplit_by_pv";
commands[132].command_line_enum = vgsplit_by_pv_CMD;
commands[132].fn = vgsplit;
commands[132].ro_count = 0;
commands[132].rp_count = 3;
commands[132].oo_count = 18;
commands[132].op_count = 0;
commands[132].desc = "DESC: Split a VG by specified PVs.";
commands[132].usage = "vgsplit VG VG PV ..."
" [ COMMON_OPTIONS ]";
commands[132].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --profile String, --version, --vgmetadatacopies all|unmanaged|Number, --autobackup y|n, --clustered y|n, --debug, --help, --maxlogicalvolumes Number, --metadatatype lvm2|lvm1, --maxphysicalvolumes Number, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[132].required_pos_args[0].pos = 1;
commands[132].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[132].required_pos_args[1].pos = 2;
commands[132].required_pos_args[1].def.val_bits = val_enum_to_bit(vg_VAL);
commands[132].required_pos_args[2].pos = 3;
commands[132].required_pos_args[2].def.val_bits = val_enum_to_bit(pv_VAL);
commands[132].required_pos_args[2].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[132].optional_opt_args[11].opt = test_ARG;
commands[132].optional_opt_args[12].opt = alloc_ARG;
commands[132].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[132].optional_opt_args[13].opt = clustered_ARG;
commands[132].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[132].optional_opt_args[14].opt = maxlogicalvolumes_ARG;
commands[132].optional_opt_args[14].def.val_bits = val_enum_to_bit(number_VAL);
commands[132].optional_opt_args[15].opt = maxphysicalvolumes_ARG;
commands[132].optional_opt_args[15].def.val_bits = val_enum_to_bit(number_VAL);
commands[132].optional_opt_args[16].opt = metadatatype_ARG;
commands[132].optional_opt_args[16].def.val_bits = val_enum_to_bit(metadatatype_VAL);
commands[132].optional_opt_args[17].opt = vgmetadatacopies_ARG;
commands[132].optional_opt_args[17].def.val_bits = val_enum_to_bit(metadatacopies_VAL);

commands[133].name = "vgsplit";
commands[133].command_line_id = "vgsplit_by_lv";
commands[133].command_line_enum = vgsplit_by_lv_CMD;
commands[133].fn = vgsplit;
commands[133].ro_count = 1;
commands[133].rp_count = 2;
commands[133].oo_count = 18;
commands[133].op_count = 0;
commands[133].desc = "DESC: Split a VG by PVs in a specified LV.";
commands[133].usage = "vgsplit --name LV VG VG"
" [ COMMON_OPTIONS ]";
commands[133].usage_common = 
" [ --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --commandprofile String, --config String, --driverloaded y|n, --profile String, --version, --vgmetadatacopies all|unmanaged|Number, --autobackup y|n, --clustered y|n, --debug, --help, --maxlogicalvolumes Number, --metadatatype lvm2|lvm1, --maxphysicalvolumes Number, --quiet, --test, --verbose, --yes, --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[133].required_opt_args[0].opt = name_ARG;
commands[133].required_opt_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[134].name = "config";
commands[134].command_line_id = "lvmconfig_general";
commands[134].command_line_enum = lvmconfig_general_CMD;
commands[134].fn = config;
commands[134].ro_count = 0;
commands[134].rp_count = 0;
commands[134].oo_count = 28;
commands[134].op_count = 1;
commands[134].desc = "";
commands[134].usage = "config"
" [ --atversion String, --typeconfig String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions, COMMON_OPTIONS ]"
" [ String ... ]";
...
commands[134].optional_opt_args[10].opt = atversion_ARG;
commands[134].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_opt_args[11].opt = configtype_ARG;
commands[134].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_opt_args[12].opt = file_ARG;
commands[134].optional_opt_args[12].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_opt_args[13].opt = ignoreadvanced_ARG;
commands[134].optional_opt_args[14].opt = ignoreunsupported_ARG;
commands[134].optional_opt_args[15].opt = ignorelocal_ARG;
commands[134].optional_opt_args[16].opt = list_ARG;
commands[134].optional_opt_args[17].opt = mergedconfig_ARG;
commands[134].optional_opt_args[18].opt = metadataprofile_ARG;
commands[134].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_opt_args[19].opt = sinceversion_ARG;
commands[134].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_opt_args[20].opt = showdeprecated_ARG;
commands[134].optional_opt_args[21].opt = showunsupported_ARG;
commands[134].optional_opt_args[22].opt = validate_ARG;
commands[134].optional_opt_args[23].opt = withsummary_ARG;
commands[134].optional_opt_args[24].opt = withcomments_ARG;
commands[134].optional_opt_args[25].opt = withspaces_ARG;
commands[134].optional_opt_args[26].opt = unconfigured_ARG;
commands[134].optional_opt_args[27].opt = withversions_ARG;
commands[134].optional_pos_args[0].pos = 1;
commands[134].optional_pos_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[134].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[135].name = "dumpconfig";
commands[135].command_line_id = "lvmconfig_general";
commands[135].command_line_enum = lvmconfig_general_CMD;
commands[135].fn = dumpconfig;
commands[135].ro_count = 0;
commands[135].rp_count = 0;
commands[135].oo_count = 28;
commands[135].op_count = 1;
commands[135].desc = "";
commands[135].usage = "dumpconfig"
" [ --atversion String, --typeconfig String, --file String, --ignoreadvanced, --ignoreunsupported, --ignorelocal, --list, --mergedconfig, --metadataprofile String, --sinceversion String, --showdeprecated, --showunsupported, --validate, --withsummary, --withcomments, --withspaces, --unconfigured, --withversions, COMMON_OPTIONS ]"
" [ String ... ]";
...
commands[136].name = "devtypes";
commands[136].command_line_id = "devtypes_general";
commands[136].command_line_enum = devtypes_general_CMD;
commands[136].fn = devtypes;
commands[136].ro_count = 0;
commands[136].rp_count = 0;
commands[136].oo_count = 23;
commands[136].op_count = 0;
commands[136].desc = "";
commands[136].usage = "devtypes"
" [ --aligned, --binary, --nameprefixes, --noheadings, --nosuffix, --options String, --reportformat String, --rows, --select String, --separator String, --sort String, --unbuffered, --unquoted, COMMON_OPTIONS ]";
...
commands[136].optional_opt_args[10].opt = aligned_ARG;
commands[136].optional_opt_args[11].opt = binary_ARG;
commands[136].optional_opt_args[12].opt = nameprefixes_ARG;
commands[136].optional_opt_args[13].opt = noheadings_ARG;
commands[136].optional_opt_args[14].opt = nosuffix_ARG;
commands[136].optional_opt_args[15].opt = options_ARG;
commands[136].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[136].optional_opt_args[16].opt = reportformat_ARG;
commands[136].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[136].optional_opt_args[17].opt = rows_ARG;
commands[136].optional_opt_args[18].opt = select_ARG;
commands[136].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[136].optional_opt_args[19].opt = separator_ARG;
commands[136].optional_opt_args[19].def.val_bits = val_enum_to_bit(string_VAL);
commands[136].optional_opt_args[20].opt = sort_ARG;
commands[136].optional_opt_args[20].def.val_bits = val_enum_to_bit(string_VAL);
commands[136].optional_opt_args[21].opt = unbuffered_ARG;
commands[136].optional_opt_args[22].opt = unquoted_ARG;

commands[137].name = "fullreport";
commands[137].command_line_id = "fullreport_general";
commands[137].command_line_enum = fullreport_general_CMD;
commands[137].fn = fullreport;
commands[137].ro_count = 0;
commands[137].rp_count = 0;
commands[137].oo_count = 35;
commands[137].op_count = 1;
commands[137].desc = "";
commands[137].usage = "fullreport"
" [ --aligned, --all, --binary, --configreport String, --foreign, --ignorelockingfailure, --ignoreskippedcluster, --logonly, --nameprefixes, --noheadings, --nolocking, --nosuffix, --options String, --partial, --readonly, --reportformat String, --rows, --select String, --separator String, --shared, --sort String, --trustcache, --unbuffered, --units hHbBsSkKmMgGtTpPeE, --unquoted, COMMON_OPTIONS ]"
" [ VG ... ]";
...
commands[137].optional_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
commands[137].optional_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;

commands[138].name = "lastlog";
commands[138].command_line_id = "lastlog_general";
commands[138].command_line_enum = lastlog_general_CMD;
commands[138].fn = lastlog;
commands[138].ro_count = 0;
commands[138].rp_count = 0;
commands[138].oo_count = 12;
commands[138].op_count = 0;
commands[138].desc = "";
commands[138].usage = "lastlog"
" [ --reportformat String, --select String, COMMON_OPTIONS ]";
...
commands[138].optional_opt_args[10].opt = reportformat_ARG;
commands[138].optional_opt_args[10].def.val_bits = val_enum_to_bit(string_VAL);
commands[138].optional_opt_args[11].opt = select_ARG;
commands[138].optional_opt_args[11].def.val_bits = val_enum_to_bit(string_VAL);

commands[139].name = "lvpoll";
commands[139].command_line_id = "lvpoll_general";
commands[139].command_line_enum = lvpoll_general_CMD;
commands[139].fn = lvpoll;
commands[139].ro_count = 1;
commands[139].rp_count = 1;
commands[139].oo_count = 15;
commands[139].op_count = 0;
commands[139].desc = "";
commands[139].usage = "lvpoll --polloperation String LV ..."
" [ --abort, --autobackup y|n, --handlemissingpvs, --interval Number, COMMON_OPTIONS ]";
commands[139].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[139].required_opt_args[0].opt = polloperation_ARG;
commands[139].required_opt_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[139].required_pos_args[0].pos = 1;
commands[139].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[139].required_pos_args[0].def.flags = ARG_DEF_FLAG_MAY_REPEAT;
...
commands[139].optional_opt_args[10].opt = abort_ARG;
commands[139].optional_opt_args[11].opt = autobackup_ARG;
commands[139].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[139].optional_opt_args[12].opt = handlemissingpvs_ARG;
commands[139].optional_opt_args[13].opt = interval_ARG;
commands[139].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
commands[139].optional_opt_args[14].opt = test_ARG;

commands[140].name = "formats";
commands[140].command_line_id = "formats_general";
commands[140].command_line_enum = formats_general_CMD;
commands[140].fn = formats;
commands[140].ro_count = 0;
commands[140].rp_count = 0;
commands[140].oo_count = 10;
commands[140].op_count = 0;
commands[140].desc = "";
commands[140].usage = "formats"
" [ COMMON_OPTIONS ]";
...
commands[141].name = "help";
commands[141].command_line_id = "help_general";
commands[141].command_line_enum = help_general_CMD;
commands[141].fn = help;
commands[141].ro_count = 0;
commands[141].rp_count = 0;
commands[141].oo_count = 10;
commands[141].op_count = 0;
commands[141].desc = "";
commands[141].usage = "help"
" [ COMMON_OPTIONS ]";
...
commands[142].name = "version";
commands[142].command_line_id = "version_general";
commands[142].command_line_enum = version_general_CMD;
commands[142].fn = version;
commands[142].ro_count = 0;
commands[142].rp_count = 0;
commands[142].oo_count = 10;
commands[142].op_count = 0;
commands[142].desc = "";
commands[142].usage = "version"
" [ COMMON_OPTIONS ]";
...
commands[143].name = "pvdata";
commands[143].command_line_id = "pvdata_general";
commands[143].command_line_enum = pvdata_general_CMD;
commands[143].fn = pvdata;
commands[143].ro_count = 0;
commands[143].rp_count = 0;
commands[143].oo_count = 10;
commands[143].op_count = 0;
commands[143].desc = "";
commands[143].usage = "pvdata"
" [ COMMON_OPTIONS ]";
...
commands[144].name = "segtypes";
commands[144].command_line_id = "segtypes_general";
commands[144].command_line_enum = segtypes_general_CMD;
commands[144].fn = segtypes;
commands[144].ro_count = 0;
commands[144].rp_count = 0;
commands[144].oo_count = 10;
commands[144].op_count = 0;
commands[144].desc = "";
commands[144].usage = "segtypes"
" [ COMMON_OPTIONS ]";
...
commands[145].name = "systemid";
commands[145].command_line_id = "systemid_general";
commands[145].command_line_enum = systemid_general_CMD;
commands[145].fn = systemid;
commands[145].ro_count = 0;
commands[145].rp_count = 0;
commands[145].oo_count = 10;
commands[145].op_count = 0;
commands[145].desc = "";
commands[145].usage = "systemid"
" [ COMMON_OPTIONS ]";
...
commands[146].name = "tags";
commands[146].command_line_id = "tags_general";
commands[146].command_line_enum = tags_general_CMD;
commands[146].fn = tags;
commands[146].ro_count = 0;
commands[146].rp_count = 0;
commands[146].oo_count = 10;
commands[146].op_count = 0;
commands[146].desc = "";
commands[146].usage = "tags"
" [ COMMON_OPTIONS ]";
...
commands[147].name = "lvmchange";
commands[147].command_line_id = "lvmchange_general";
commands[147].command_line_enum = lvmchange_general_CMD;
commands[147].fn = lvmchange;
commands[147].ro_count = 0;
commands[147].rp_count = 0;
commands[147].oo_count = 10;
commands[147].op_count = 0;
commands[147].desc = "";
commands[147].usage = "lvmchange"
" [ COMMON_OPTIONS ]";
...
commands[148].name = "lvmdiskscan";
commands[148].command_line_id = "lvmdiskscan_general";
commands[148].command_line_enum = lvmdiskscan_general_CMD;
commands[148].fn = lvmdiskscan;
commands[148].ro_count = 0;
commands[148].rp_count = 0;
commands[148].oo_count = 12;
commands[148].op_count = 0;
commands[148].desc = "";
commands[148].usage = "lvmdiskscan"
" [ --lvmpartition, --readonly, COMMON_OPTIONS ]";
...
commands[148].optional_opt_args[10].opt = lvmpartition_ARG;
commands[148].optional_opt_args[11].opt = readonly_ARG;

commands[149].name = "lvmsadc";
commands[149].command_line_id = "lvmsadc_general";
commands[149].command_line_enum = lvmsadc_general_CMD;
commands[149].fn = lvmsadc;
commands[149].ro_count = 0;
commands[149].rp_count = 0;
commands[149].oo_count = 10;
commands[149].op_count = 0;
commands[149].desc = "";
commands[149].usage = "lvmsadc"
" [ COMMON_OPTIONS ]";
...
commands[150].name = "lvmsar";
commands[150].command_line_id = "lvmsar_general";
commands[150].command_line_enum = lvmsar_general_CMD;
commands[150].fn = lvmsar;
commands[150].ro_count = 0;
commands[150].rp_count = 0;
commands[150].oo_count = 12;
commands[150].op_count = 0;
commands[150].desc = "";
commands[150].usage = "lvmsar"
" [ --full, --stdin, COMMON_OPTIONS ]";
...
commands[150].optional_opt_args[10].opt = full_ARG;
commands[150].optional_opt_args[11].opt = stdin_ARG;
