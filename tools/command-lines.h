...
commands[51].optional_opt_args[13].opt = discards_ARG;
commands[51].optional_opt_args[13].def.val_bits = val_enum_to_bit(discards_VAL);
commands[51].optional_opt_args[14].opt = errorwhenfull_ARG;
commands[51].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[15].opt = addtag_ARG;
commands[51].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[51].optional_opt_args[16].opt = alloc_ARG;
commands[51].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[51].optional_opt_args[17].opt = autobackup_ARG;
commands[51].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[18].opt = activate_ARG;
commands[51].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[51].optional_opt_args[19].opt = contiguous_ARG;
commands[51].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[51].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[51].optional_opt_args[22].opt = major_ARG;
commands[51].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[51].optional_opt_args[23].opt = metadataprofile_ARG;
commands[51].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[24].opt = minor_ARG;
commands[51].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[51].optional_opt_args[25].opt = monitor_ARG;
commands[51].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[26].opt = name_ARG;
commands[51].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[27].opt = nosync_ARG;
commands[51].optional_opt_args[28].opt = noudevsync_ARG;
commands[51].optional_opt_args[29].opt = permission_ARG;
commands[51].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[51].optional_opt_args[30].opt = persistent_ARG;
commands[51].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[31].opt = readahead_ARG;
commands[51].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[51].optional_opt_args[32].opt = reportformat_ARG;
commands[51].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[51].optional_opt_args[33].opt = setactivationskip_ARG;
commands[51].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[34].opt = test_ARG;
commands[51].optional_opt_args[35].opt = wipesignatures_ARG;
commands[51].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[51].optional_opt_args[36].opt = zero_ARG;
...
commands[52].optional_opt_args[16].opt = addtag_ARG;
commands[52].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[52].optional_opt_args[17].opt = alloc_ARG;
commands[52].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[52].optional_opt_args[18].opt = autobackup_ARG;
commands[52].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[19].opt = activate_ARG;
commands[52].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[52].optional_opt_args[20].opt = contiguous_ARG;
commands[52].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[52].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[52].optional_opt_args[23].opt = major_ARG;
commands[52].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[52].optional_opt_args[24].opt = metadataprofile_ARG;
commands[52].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[25].opt = minor_ARG;
commands[52].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[52].optional_opt_args[26].opt = monitor_ARG;
commands[52].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[27].opt = name_ARG;
commands[52].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[28].opt = nosync_ARG;
commands[52].optional_opt_args[29].opt = noudevsync_ARG;
commands[52].optional_opt_args[30].opt = permission_ARG;
commands[52].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[52].optional_opt_args[31].opt = persistent_ARG;
commands[52].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[32].opt = readahead_ARG;
commands[52].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[52].optional_opt_args[33].opt = reportformat_ARG;
commands[52].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[52].optional_opt_args[34].opt = setactivationskip_ARG;
commands[52].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[35].opt = test_ARG;
commands[52].optional_opt_args[36].opt = wipesignatures_ARG;
commands[52].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[52].optional_opt_args[37].opt = zero_ARG;
...
commands[53].optional_opt_args[17].opt = addtag_ARG;
commands[53].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[53].optional_opt_args[18].opt = alloc_ARG;
commands[53].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[53].optional_opt_args[19].opt = autobackup_ARG;
commands[53].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[20].opt = activate_ARG;
commands[53].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[53].optional_opt_args[21].opt = contiguous_ARG;
commands[53].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[53].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[53].optional_opt_args[24].opt = major_ARG;
commands[53].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[53].optional_opt_args[25].opt = metadataprofile_ARG;
commands[53].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[26].opt = minor_ARG;
commands[53].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[53].optional_opt_args[27].opt = monitor_ARG;
commands[53].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[28].opt = name_ARG;
commands[53].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[29].opt = nosync_ARG;
commands[53].optional_opt_args[30].opt = noudevsync_ARG;
commands[53].optional_opt_args[31].opt = permission_ARG;
commands[53].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[53].optional_opt_args[32].opt = persistent_ARG;
commands[53].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[33].opt = readahead_ARG;
commands[53].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[53].optional_opt_args[34].opt = reportformat_ARG;
commands[53].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[53].optional_opt_args[35].opt = setactivationskip_ARG;
commands[53].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[36].opt = test_ARG;
commands[53].optional_opt_args[37].opt = wipesignatures_ARG;
commands[53].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[53].optional_opt_args[38].opt = zero_ARG;
...
commands[54].command_line_id = "lvcreate_thinpool";
commands[54].command_line_enum = lvcreate_thinpool_CMD;
commands[54].fn = lvcreate;
commands[54].ro_count = 2;
commands[54].rp_count = 0;
commands[54].oo_count = 39;
commands[54].op_count = 1;
commands[54].desc = "DESC: Create a thin pool named by the --thinpool arg  DESC: (variant, infers --type thin-pool, also specify VG).";
commands[54].usage = "lvcreate --size Number[m|unit] --thinpool LV_new"
" [ --thin, --type thin-pool, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[54].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[54].required_opt_args[0].opt = size_ARG;
...
commands[54].required_opt_args[1].def.flags = ARG_DEF_FLAG_NEW;
...
commands[54].optional_opt_args[10].opt = thin_ARG;
commands[54].optional_opt_args[11].opt = type_ARG;
commands[54].optional_opt_args[11].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[54].optional_opt_args[11].def.str = "thin-pool";
commands[54].optional_opt_args[12].opt = poolmetadatasize_ARG;
commands[54].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[54].optional_opt_args[13].opt = poolmetadataspare_ARG;
commands[54].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[14].opt = chunksize_ARG;
commands[54].optional_opt_args[14].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[54].optional_opt_args[15].opt = discards_ARG;
commands[54].optional_opt_args[15].def.val_bits = val_enum_to_bit(discards_VAL);
commands[54].optional_opt_args[16].opt = errorwhenfull_ARG;
commands[54].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[17].opt = addtag_ARG;
commands[54].optional_opt_args[17].def.val_bits = val_enum_to_bit(tag_VAL);
commands[54].optional_opt_args[18].opt = alloc_ARG;
commands[54].optional_opt_args[18].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[54].optional_opt_args[19].opt = autobackup_ARG;
commands[54].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[20].opt = activate_ARG;
commands[54].optional_opt_args[20].def.val_bits = val_enum_to_bit(activation_VAL);
commands[54].optional_opt_args[21].opt = contiguous_ARG;
commands[54].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[22].opt = ignoreactivationskip_ARG;
commands[54].optional_opt_args[23].opt = ignoremonitoring_ARG;
commands[54].optional_opt_args[24].opt = major_ARG;
commands[54].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[54].optional_opt_args[25].opt = metadataprofile_ARG;
commands[54].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[26].opt = minor_ARG;
commands[54].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[54].optional_opt_args[27].opt = monitor_ARG;
commands[54].optional_opt_args[27].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[28].opt = name_ARG;
commands[54].optional_opt_args[28].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[29].opt = nosync_ARG;
commands[54].optional_opt_args[30].opt = noudevsync_ARG;
commands[54].optional_opt_args[31].opt = permission_ARG;
commands[54].optional_opt_args[31].def.val_bits = val_enum_to_bit(permission_VAL);
commands[54].optional_opt_args[32].opt = persistent_ARG;
commands[54].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[33].opt = readahead_ARG;
commands[54].optional_opt_args[33].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[54].optional_opt_args[34].opt = reportformat_ARG;
commands[54].optional_opt_args[34].def.val_bits = val_enum_to_bit(string_VAL);
commands[54].optional_opt_args[35].opt = setactivationskip_ARG;
commands[54].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[36].opt = test_ARG;
commands[54].optional_opt_args[37].opt = wipesignatures_ARG;
commands[54].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_opt_args[38].opt = zero_ARG;
commands[54].optional_opt_args[38].def.val_bits = val_enum_to_bit(bool_VAL);
commands[54].optional_pos_args[0].pos = 1;
...
commands[55].oo_count = 38;
commands[55].op_count = 1;
commands[55].desc = "DESC: Create a cache pool.";
commands[55].usage = "lvcreate --type cache-pool --size Number[m|unit] VG"
...
commands[55].required_opt_args[0].def.str = "cache-pool";
...
commands[55].optional_opt_args[13].opt = cachemode_ARG;
commands[55].optional_opt_args[13].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[55].optional_opt_args[14].opt = cachepolicy_ARG;
commands[55].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[55].optional_opt_args[15].opt = cachesettings_ARG;
commands[55].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[55].optional_opt_args[16].opt = addtag_ARG;
commands[55].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[55].optional_opt_args[17].opt = alloc_ARG;
commands[55].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[55].optional_opt_args[18].opt = autobackup_ARG;
commands[55].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[19].opt = activate_ARG;
commands[55].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[55].optional_opt_args[20].opt = contiguous_ARG;
commands[55].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[55].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[55].optional_opt_args[23].opt = major_ARG;
commands[55].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[55].optional_opt_args[24].opt = metadataprofile_ARG;
commands[55].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[55].optional_opt_args[25].opt = minor_ARG;
commands[55].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[55].optional_opt_args[26].opt = monitor_ARG;
commands[55].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[27].opt = name_ARG;
commands[55].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[55].optional_opt_args[28].opt = nosync_ARG;
commands[55].optional_opt_args[29].opt = noudevsync_ARG;
commands[55].optional_opt_args[30].opt = permission_ARG;
commands[55].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[55].optional_opt_args[31].opt = persistent_ARG;
commands[55].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[32].opt = readahead_ARG;
commands[55].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[55].optional_opt_args[33].opt = reportformat_ARG;
commands[55].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[55].optional_opt_args[34].opt = setactivationskip_ARG;
commands[55].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[35].opt = test_ARG;
commands[55].optional_opt_args[36].opt = wipesignatures_ARG;
commands[55].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[55].optional_opt_args[37].opt = zero_ARG;
...
commands[56].rp_count = 0;
commands[56].oo_count = 38;
commands[56].op_count = 1;
commands[56].desc = "DESC: Create a cache pool (variant, also specify VG).";
commands[56].usage = "lvcreate --type cache-pool --size Number[m|unit] --name LV_new"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[56].required_opt_args[2].opt = name_ARG;
...
commands[56].optional_pos_args[0].pos = 1;
...
commands[57].command_line_id = "lvcreate_cachepool";
commands[57].command_line_enum = lvcreate_cachepool_CMD;
commands[57].fn = lvcreate;
commands[57].ro_count = 2;
commands[57].rp_count = 1;
commands[57].oo_count = 39;
commands[57].op_count = 1;
commands[57].desc = "DESC: Create a cache pool (variant, infers --type cache-pool).";
commands[57].usage = "lvcreate --cache --size Number[m|unit] VG"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[57].required_opt_args[0].opt = cache_ARG;
commands[57].required_opt_args[1].opt = size_ARG;
...
commands[57].optional_opt_args[10].opt = type_ARG;
commands[57].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[57].optional_opt_args[10].def.str = "cache-pool";
...
commands[57].optional_opt_args[14].opt = cachemode_ARG;
commands[57].optional_opt_args[14].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[57].optional_opt_args[15].opt = cachepolicy_ARG;
commands[57].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[57].optional_opt_args[16].opt = cachesettings_ARG;
commands[57].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[58].command_line_id = "lvcreate_cachepool";
commands[58].command_line_enum = lvcreate_cachepool_CMD;
commands[58].fn = lvcreate;
commands[58].ro_count = 3;
commands[58].rp_count = 1;
commands[58].oo_count = 38;
commands[58].op_count = 1;
commands[58].desc = "DESC: Create a cache pool named by the --cachepool arg  DESC: (variant, also use --name).";
commands[58].usage = "lvcreate --type cache-pool --size Number[m|unit] --cachepool LV_new VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[58].required_opt_args[0].def.str = "cache-pool";
commands[58].required_opt_args[1].opt = size_ARG;
commands[58].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[58].required_opt_args[2].opt = cachepool_ARG;
commands[58].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[58].required_opt_args[2].def.flags = ARG_DEF_FLAG_NEW;
commands[58].required_pos_args[0].pos = 1;
commands[58].required_pos_args[0].def.val_bits = val_enum_to_bit(vg_VAL);
...
commands[59].op_count = 0;
commands[59].desc = "DESC: Create a thin LV in a thin pool.";
commands[59].usage = "lvcreate --type thin --virtualsize Number[m|unit] --thinpool LV_thinpool"
" [ --thin, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
...
commands[59].required_opt_args[2].opt = thinpool_ARG;
commands[59].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[59].required_opt_args[2].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[59].optional_opt_args[10].opt = thin_ARG;
commands[59].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[59].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[59].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[59].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[59].optional_opt_args[13].opt = chunksize_ARG;
commands[59].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[59].optional_opt_args[14].opt = discards_ARG;
commands[59].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[59].optional_opt_args[15].opt = errorwhenfull_ARG;
commands[59].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[60].ro_count = 2;
commands[60].rp_count = 0;
commands[60].oo_count = 36;
commands[60].op_count = 0;
commands[60].desc = "DESC: Create a thin LV in a thin pool (variant, infers --type thin).";
commands[60].usage = "lvcreate --virtualsize Number[m|unit] --thinpool LV_thinpool"
" [ --type thin, --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
...
commands[60].required_opt_args[1].opt = thinpool_ARG;
commands[60].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[60].required_opt_args[1].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[60].optional_opt_args[14].opt = addtag_ARG;
commands[60].optional_opt_args[14].def.val_bits = val_enum_to_bit(tag_VAL);
commands[60].optional_opt_args[15].opt = alloc_ARG;
commands[60].optional_opt_args[15].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[60].optional_opt_args[16].opt = autobackup_ARG;
commands[60].optional_opt_args[16].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[17].opt = activate_ARG;
commands[60].optional_opt_args[17].def.val_bits = val_enum_to_bit(activation_VAL);
commands[60].optional_opt_args[18].opt = contiguous_ARG;
commands[60].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[19].opt = ignoreactivationskip_ARG;
commands[60].optional_opt_args[20].opt = ignoremonitoring_ARG;
commands[60].optional_opt_args[21].opt = major_ARG;
commands[60].optional_opt_args[21].def.val_bits = val_enum_to_bit(number_VAL);
commands[60].optional_opt_args[22].opt = metadataprofile_ARG;
commands[60].optional_opt_args[22].def.val_bits = val_enum_to_bit(string_VAL);
commands[60].optional_opt_args[23].opt = minor_ARG;
commands[60].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[60].optional_opt_args[24].opt = monitor_ARG;
commands[60].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[25].opt = name_ARG;
commands[60].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[60].optional_opt_args[26].opt = nosync_ARG;
commands[60].optional_opt_args[27].opt = noudevsync_ARG;
commands[60].optional_opt_args[28].opt = permission_ARG;
commands[60].optional_opt_args[28].def.val_bits = val_enum_to_bit(permission_VAL);
commands[60].optional_opt_args[29].opt = persistent_ARG;
commands[60].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[30].opt = readahead_ARG;
commands[60].optional_opt_args[30].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[60].optional_opt_args[31].opt = reportformat_ARG;
commands[60].optional_opt_args[31].def.val_bits = val_enum_to_bit(string_VAL);
commands[60].optional_opt_args[32].opt = setactivationskip_ARG;
commands[60].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[33].opt = test_ARG;
commands[60].optional_opt_args[34].opt = wipesignatures_ARG;
commands[60].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[60].optional_opt_args[35].opt = zero_ARG;
commands[60].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);

commands[61].name = "lvcreate";
commands[61].command_line_id = "lvcreate_thin_vol";
commands[61].command_line_enum = lvcreate_thin_vol_CMD;
commands[61].fn = lvcreate;
commands[61].ro_count = 1;
commands[61].rp_count = 1;
commands[61].oo_count = 36;
commands[61].op_count = 0;
commands[61].desc = "DESC: Create a thin LV in the thin pool named in arg pos 1  DESC: (variant, infers --type thin).";
commands[61].usage = "lvcreate --virtualsize Number[m|unit] LV_thinpool"
" [ --type thin, --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
commands[61].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[61].required_opt_args[0].opt = virtualsize_ARG;
commands[61].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[61].required_pos_args[0].pos = 1;
commands[61].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[61].required_pos_args[0].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[61].optional_opt_args[10].def.str = "thin";
commands[61].optional_opt_args[11].opt = thin_ARG;
commands[61].optional_opt_args[12].opt = discards_ARG;
commands[61].optional_opt_args[12].def.val_bits = val_enum_to_bit(discards_VAL);
commands[61].optional_opt_args[13].opt = errorwhenfull_ARG;
commands[61].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[62].oo_count = 35;
commands[62].op_count = 0;
commands[62].desc = "DESC: Create a thin LV that is a snapshot of an existing thin LV.";
commands[62].usage = "lvcreate --type thin LV_thin"
" [ --thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
commands[62].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[62].required_opt_args[0].opt = type_ARG;
commands[62].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[62].required_opt_args[0].def.str = "thin";
...
commands[62].optional_opt_args[10].opt = thin_ARG;
...
commands[62].optional_opt_args[13].opt = addtag_ARG;
commands[62].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[62].optional_opt_args[14].opt = alloc_ARG;
commands[62].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[62].optional_opt_args[15].opt = autobackup_ARG;
commands[62].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[16].opt = activate_ARG;
commands[62].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[62].optional_opt_args[17].opt = contiguous_ARG;
commands[62].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[62].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[62].optional_opt_args[20].opt = major_ARG;
commands[62].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[62].optional_opt_args[21].opt = metadataprofile_ARG;
commands[62].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[62].optional_opt_args[22].opt = minor_ARG;
commands[62].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[62].optional_opt_args[23].opt = monitor_ARG;
commands[62].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[24].opt = name_ARG;
commands[62].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[62].optional_opt_args[25].opt = nosync_ARG;
commands[62].optional_opt_args[26].opt = noudevsync_ARG;
commands[62].optional_opt_args[27].opt = permission_ARG;
commands[62].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[62].optional_opt_args[28].opt = persistent_ARG;
commands[62].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[29].opt = readahead_ARG;
commands[62].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[62].optional_opt_args[30].opt = reportformat_ARG;
commands[62].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[62].optional_opt_args[31].opt = setactivationskip_ARG;
commands[62].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[32].opt = test_ARG;
commands[62].optional_opt_args[33].opt = wipesignatures_ARG;
commands[62].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[62].optional_opt_args[34].opt = zero_ARG;
...
commands[63].optional_opt_args[13].opt = addtag_ARG;
commands[63].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[63].optional_opt_args[14].opt = alloc_ARG;
commands[63].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[63].optional_opt_args[15].opt = autobackup_ARG;
commands[63].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[16].opt = activate_ARG;
commands[63].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[63].optional_opt_args[17].opt = contiguous_ARG;
commands[63].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[63].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[63].optional_opt_args[20].opt = major_ARG;
commands[63].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[63].optional_opt_args[21].opt = metadataprofile_ARG;
commands[63].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[22].opt = minor_ARG;
commands[63].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[63].optional_opt_args[23].opt = monitor_ARG;
commands[63].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[24].opt = name_ARG;
commands[63].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[25].opt = nosync_ARG;
commands[63].optional_opt_args[26].opt = noudevsync_ARG;
commands[63].optional_opt_args[27].opt = permission_ARG;
commands[63].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[63].optional_opt_args[28].opt = persistent_ARG;
commands[63].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[29].opt = readahead_ARG;
commands[63].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[63].optional_opt_args[30].opt = reportformat_ARG;
commands[63].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[63].optional_opt_args[31].opt = setactivationskip_ARG;
commands[63].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[32].opt = test_ARG;
commands[63].optional_opt_args[33].opt = wipesignatures_ARG;
commands[63].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[63].optional_opt_args[34].opt = zero_ARG;
commands[63].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);

commands[64].name = "lvcreate";
commands[64].command_line_id = "lvcreate_thin_snapshot";
commands[64].command_line_enum = lvcreate_thin_snapshot_CMD;
commands[64].fn = lvcreate;
commands[64].ro_count = 1;
commands[64].rp_count = 1;
commands[64].oo_count = 35;
commands[64].op_count = 0;
commands[64].desc = "DESC: Create a thin LV that is a snapshot of an existing thin LV  DESC: (infers --type thin).";
commands[64].usage = "lvcreate --snapshot LV_thin"
" [ --type thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
commands[64].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[64].required_opt_args[0].opt = snapshot_ARG;
commands[64].required_pos_args[0].pos = 1;
commands[64].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
commands[64].required_pos_args[0].def.lv_types = ARG_DEF_LV_THIN;
...
commands[64].optional_opt_args[11].opt = discards_ARG;
commands[64].optional_opt_args[11].def.val_bits = val_enum_to_bit(discards_VAL);
commands[64].optional_opt_args[12].opt = errorwhenfull_ARG;
commands[64].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[13].opt = addtag_ARG;
commands[64].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[64].optional_opt_args[14].opt = alloc_ARG;
commands[64].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[64].optional_opt_args[15].opt = autobackup_ARG;
commands[64].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[16].opt = activate_ARG;
commands[64].optional_opt_args[16].def.val_bits = val_enum_to_bit(activation_VAL);
commands[64].optional_opt_args[17].opt = contiguous_ARG;
commands[64].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[18].opt = ignoreactivationskip_ARG;
commands[64].optional_opt_args[19].opt = ignoremonitoring_ARG;
commands[64].optional_opt_args[20].opt = major_ARG;
commands[64].optional_opt_args[20].def.val_bits = val_enum_to_bit(number_VAL);
commands[64].optional_opt_args[21].opt = metadataprofile_ARG;
commands[64].optional_opt_args[21].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[22].opt = minor_ARG;
commands[64].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[64].optional_opt_args[23].opt = monitor_ARG;
commands[64].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[24].opt = name_ARG;
commands[64].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[25].opt = nosync_ARG;
commands[64].optional_opt_args[26].opt = noudevsync_ARG;
commands[64].optional_opt_args[27].opt = permission_ARG;
commands[64].optional_opt_args[27].def.val_bits = val_enum_to_bit(permission_VAL);
commands[64].optional_opt_args[28].opt = persistent_ARG;
commands[64].optional_opt_args[28].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[29].opt = readahead_ARG;
commands[64].optional_opt_args[29].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[64].optional_opt_args[30].opt = reportformat_ARG;
commands[64].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[64].optional_opt_args[31].opt = setactivationskip_ARG;
commands[64].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[32].opt = test_ARG;
commands[64].optional_opt_args[33].opt = wipesignatures_ARG;
commands[64].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[64].optional_opt_args[34].opt = zero_ARG;
...
commands[65].oo_count = 37;
commands[65].op_count = 0;
commands[65].desc = "DESC: Create a thin LV that is a snapshot of an external origin LV.";
commands[65].usage = "lvcreate --type thin --thinpool LV_thinpool LV"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
...
commands[65].required_opt_args[0].def.str = "thin";
...
commands[65].optional_opt_args[13].opt = discards_ARG;
commands[65].optional_opt_args[13].def.val_bits = val_enum_to_bit(discards_VAL);
commands[65].optional_opt_args[14].opt = errorwhenfull_ARG;
commands[65].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[15].opt = addtag_ARG;
commands[65].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[65].optional_opt_args[16].opt = alloc_ARG;
commands[65].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[65].optional_opt_args[17].opt = autobackup_ARG;
commands[65].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[18].opt = activate_ARG;
commands[65].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[65].optional_opt_args[19].opt = contiguous_ARG;
commands[65].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[65].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[65].optional_opt_args[22].opt = major_ARG;
commands[65].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[65].optional_opt_args[23].opt = metadataprofile_ARG;
commands[65].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[65].optional_opt_args[24].opt = minor_ARG;
commands[65].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[65].optional_opt_args[25].opt = monitor_ARG;
commands[65].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[26].opt = name_ARG;
commands[65].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[65].optional_opt_args[27].opt = nosync_ARG;
commands[65].optional_opt_args[28].opt = noudevsync_ARG;
commands[65].optional_opt_args[29].opt = permission_ARG;
commands[65].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[65].optional_opt_args[30].opt = persistent_ARG;
commands[65].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[31].opt = readahead_ARG;
commands[65].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[65].optional_opt_args[32].opt = reportformat_ARG;
commands[65].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[65].optional_opt_args[33].opt = setactivationskip_ARG;
commands[65].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[34].opt = test_ARG;
commands[65].optional_opt_args[35].opt = wipesignatures_ARG;
commands[65].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[65].optional_opt_args[36].opt = zero_ARG;
commands[65].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);

commands[66].name = "lvcreate";
commands[66].command_line_id = "lvcreate_thin_snapshot_of_external";
commands[66].command_line_enum = lvcreate_thin_snapshot_of_external_CMD;
commands[66].fn = lvcreate;
commands[66].ro_count = 2;
commands[66].rp_count = 1;
commands[66].oo_count = 35;
commands[66].op_count = 0;
commands[66].desc = "DESC: Create a thin LV that is a snapshot of an external origin LV  DESC: (infers --type thin).";
commands[66].usage = "lvcreate --snapshot --thinpool LV_thinpool LV"
" [ --type thin, --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]";
commands[66].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[66].required_opt_args[0].opt = snapshot_ARG;
commands[66].required_opt_args[1].opt = thinpool_ARG;
commands[66].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[66].required_opt_args[1].def.lv_types = ARG_DEF_LV_THINPOOL;
...
commands[67].oo_count = 37;
commands[67].op_count = 1;
commands[67].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named by the --thinpool arg.";
commands[67].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] --thinpool LV_new"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[67].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[67].required_opt_args[0].opt = type_ARG;
commands[67].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[67].required_opt_args[0].def.str = "thin";
...
commands[67].optional_opt_args[10].opt = poolmetadatasize_ARG;
commands[67].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[67].optional_opt_args[11].opt = poolmetadataspare_ARG;
commands[67].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[12].opt = chunksize_ARG;
commands[67].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[67].optional_opt_args[13].opt = discards_ARG;
commands[67].optional_opt_args[13].def.val_bits = val_enum_to_bit(discards_VAL);
commands[67].optional_opt_args[14].opt = errorwhenfull_ARG;
commands[67].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[15].opt = addtag_ARG;
commands[67].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[67].optional_opt_args[16].opt = alloc_ARG;
commands[67].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[67].optional_opt_args[17].opt = autobackup_ARG;
commands[67].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[18].opt = activate_ARG;
commands[67].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[67].optional_opt_args[19].opt = contiguous_ARG;
commands[67].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[67].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[67].optional_opt_args[22].opt = major_ARG;
commands[67].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[67].optional_opt_args[23].opt = metadataprofile_ARG;
commands[67].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[24].opt = minor_ARG;
commands[67].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[67].optional_opt_args[25].opt = monitor_ARG;
commands[67].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[26].opt = name_ARG;
commands[67].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[27].opt = nosync_ARG;
commands[67].optional_opt_args[28].opt = noudevsync_ARG;
commands[67].optional_opt_args[29].opt = permission_ARG;
commands[67].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[67].optional_opt_args[30].opt = persistent_ARG;
commands[67].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[31].opt = readahead_ARG;
commands[67].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[67].optional_opt_args[32].opt = reportformat_ARG;
commands[67].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[67].optional_opt_args[33].opt = setactivationskip_ARG;
commands[67].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[34].opt = test_ARG;
commands[67].optional_opt_args[35].opt = wipesignatures_ARG;
commands[67].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[67].optional_opt_args[36].opt = zero_ARG;
commands[67].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[68].ro_count = 4;
commands[68].rp_count = 0;
commands[68].oo_count = 38;
commands[68].op_count = 1;
commands[68].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named by the --thinpool arg,  DESC: (variant, infers --type thin).";
commands[68].usage = "lvcreate --thin --virtualsize Number[m|unit] --size Number[m|unit] --thinpool LV_new"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[68].required_opt_args[0].opt = thin_ARG;
...
commands[68].required_opt_args[3].opt = thinpool_ARG;
commands[68].required_opt_args[3].def.val_bits = val_enum_to_bit(lv_VAL);
commands[68].required_opt_args[3].def.flags = ARG_DEF_FLAG_NEW;
...
commands[68].optional_opt_args[11].opt = poolmetadatasize_ARG;
commands[68].optional_opt_args[11].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[68].optional_opt_args[12].opt = poolmetadataspare_ARG;
commands[68].optional_opt_args[12].def.val_bits = val_enum_to_bit(bool_VAL);
commands[68].optional_opt_args[13].opt = chunksize_ARG;
commands[68].optional_opt_args[13].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[68].optional_opt_args[14].opt = discards_ARG;
commands[68].optional_opt_args[14].def.val_bits = val_enum_to_bit(discards_VAL);
commands[68].optional_opt_args[15].opt = errorwhenfull_ARG;
...
commands[69].oo_count = 37;
commands[69].op_count = 1;
commands[69].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named in arg pos 1.";
commands[69].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] LV_new"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[69].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[69].required_opt_args[0].opt = type_ARG;
commands[69].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[69].required_opt_args[0].def.str = "thin";
...
commands[69].optional_opt_args[10].opt = poolmetadatasize_ARG;
commands[69].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[69].optional_opt_args[11].opt = poolmetadataspare_ARG;
commands[69].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[12].opt = chunksize_ARG;
commands[69].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[69].optional_opt_args[13].opt = discards_ARG;
commands[69].optional_opt_args[13].def.val_bits = val_enum_to_bit(discards_VAL);
commands[69].optional_opt_args[14].opt = errorwhenfull_ARG;
commands[69].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[15].opt = addtag_ARG;
commands[69].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[69].optional_opt_args[16].opt = alloc_ARG;
commands[69].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[69].optional_opt_args[17].opt = autobackup_ARG;
commands[69].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[18].opt = activate_ARG;
commands[69].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[69].optional_opt_args[19].opt = contiguous_ARG;
commands[69].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[69].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[69].optional_opt_args[22].opt = major_ARG;
commands[69].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[69].optional_opt_args[23].opt = metadataprofile_ARG;
commands[69].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[24].opt = minor_ARG;
commands[69].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[69].optional_opt_args[25].opt = monitor_ARG;
commands[69].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[26].opt = name_ARG;
commands[69].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[27].opt = nosync_ARG;
commands[69].optional_opt_args[28].opt = noudevsync_ARG;
commands[69].optional_opt_args[29].opt = permission_ARG;
commands[69].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[69].optional_opt_args[30].opt = persistent_ARG;
commands[69].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[31].opt = readahead_ARG;
commands[69].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[69].optional_opt_args[32].opt = reportformat_ARG;
commands[69].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[69].optional_opt_args[33].opt = setactivationskip_ARG;
commands[69].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[34].opt = test_ARG;
commands[69].optional_opt_args[35].opt = wipesignatures_ARG;
commands[69].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[69].optional_opt_args[36].opt = zero_ARG;
commands[69].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[70].desc = "DESC: Create a thin LV, first creating a thin pool for it,  DESC: where the new thin pool is named in arg pos 1,  DESC: (variant, infers --type thin).";
commands[70].usage = "lvcreate --thin --virtualsize Number[m|unit] --size Number[m|unit] LV_new"
" [ --type thin, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[70].required_pos_args[0].def.flags = ARG_DEF_FLAG_NEW;
...
commands[71].command_line_id = "lvcreate_thin_vol_with_thinpool";
commands[71].command_line_enum = lvcreate_thin_vol_with_thinpool_CMD;
commands[71].fn = lvcreate;
commands[71].ro_count = 3;
commands[71].rp_count = 1;
commands[71].oo_count = 37;
commands[71].op_count = 1;
commands[71].desc = "DESC: Create a thin LV, first creating a thin pool for it.";
commands[71].usage = "lvcreate --type thin --virtualsize Number[m|unit] --size Number[m|unit] VG"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[71].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[71].required_opt_args[0].opt = type_ARG;
commands[71].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[71].required_opt_args[0].def.str = "thin";
...
commands[71].optional_opt_args[10].opt = poolmetadatasize_ARG;
commands[71].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[71].optional_opt_args[11].opt = poolmetadataspare_ARG;
commands[71].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[12].opt = chunksize_ARG;
commands[71].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[71].optional_opt_args[13].opt = discards_ARG;
commands[71].optional_opt_args[13].def.val_bits = val_enum_to_bit(discards_VAL);
commands[71].optional_opt_args[14].opt = errorwhenfull_ARG;
commands[71].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[15].opt = addtag_ARG;
commands[71].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[71].optional_opt_args[16].opt = alloc_ARG;
commands[71].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[71].optional_opt_args[17].opt = autobackup_ARG;
commands[71].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[18].opt = activate_ARG;
commands[71].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[71].optional_opt_args[19].opt = contiguous_ARG;
commands[71].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[71].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[71].optional_opt_args[22].opt = major_ARG;
commands[71].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[23].opt = metadataprofile_ARG;
commands[71].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[24].opt = minor_ARG;
commands[71].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[71].optional_opt_args[25].opt = monitor_ARG;
commands[71].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[26].opt = name_ARG;
commands[71].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[27].opt = nosync_ARG;
commands[71].optional_opt_args[28].opt = noudevsync_ARG;
commands[71].optional_opt_args[29].opt = permission_ARG;
commands[71].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[71].optional_opt_args[30].opt = persistent_ARG;
commands[71].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[31].opt = readahead_ARG;
commands[71].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[71].optional_opt_args[32].opt = reportformat_ARG;
commands[71].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[71].optional_opt_args[33].opt = setactivationskip_ARG;
commands[71].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[34].opt = test_ARG;
commands[71].optional_opt_args[35].opt = wipesignatures_ARG;
commands[71].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[71].optional_opt_args[36].opt = zero_ARG;
...
commands[72].command_line_id = "lvcreate_thin_vol_with_thinpool_or_sparse_snapshot";
commands[72].command_line_enum = lvcreate_thin_vol_with_thinpool_or_sparse_snapshot_CMD;
commands[72].fn = lvcreate;
commands[72].ro_count = 2;
commands[72].rp_count = 1;
commands[72].oo_count = 41;
commands[72].op_count = 1;
commands[72].desc = "DESC: Create a thin LV, first creating a thin pool for it  DESC: (infers --type thin).  DESC: Create a sparse snapshot of a virtual origin LV  DESC: (infers --type snapshot).  DESC: Infers --type thin or --type snapshot according to  DESC: confing setting sparse_segtype_default.";
commands[72].usage = "lvcreate --size Number[m|unit] --virtualsize Number[m|unit] VG"
" [ --type thin, --type snapshot, --thin, --snapshot, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --discards passdown|nopassdown|ignore, --errorwhenfull y|n, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
...
commands[72].optional_opt_args[14].opt = poolmetadatasize_ARG;
commands[72].optional_opt_args[14].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[72].optional_opt_args[15].opt = poolmetadataspare_ARG;
commands[72].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[16].opt = chunksize_ARG;
commands[72].optional_opt_args[16].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[72].optional_opt_args[17].opt = discards_ARG;
commands[72].optional_opt_args[17].def.val_bits = val_enum_to_bit(discards_VAL);
commands[72].optional_opt_args[18].opt = errorwhenfull_ARG;
commands[72].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[19].opt = addtag_ARG;
commands[72].optional_opt_args[19].def.val_bits = val_enum_to_bit(tag_VAL);
commands[72].optional_opt_args[20].opt = alloc_ARG;
commands[72].optional_opt_args[20].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[72].optional_opt_args[21].opt = autobackup_ARG;
commands[72].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[22].opt = activate_ARG;
commands[72].optional_opt_args[22].def.val_bits = val_enum_to_bit(activation_VAL);
commands[72].optional_opt_args[23].opt = contiguous_ARG;
commands[72].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[24].opt = ignoreactivationskip_ARG;
commands[72].optional_opt_args[25].opt = ignoremonitoring_ARG;
commands[72].optional_opt_args[26].opt = major_ARG;
commands[72].optional_opt_args[26].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[27].opt = metadataprofile_ARG;
commands[72].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[28].opt = minor_ARG;
commands[72].optional_opt_args[28].def.val_bits = val_enum_to_bit(number_VAL);
commands[72].optional_opt_args[29].opt = monitor_ARG;
commands[72].optional_opt_args[29].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[30].opt = name_ARG;
commands[72].optional_opt_args[30].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[31].opt = nosync_ARG;
commands[72].optional_opt_args[32].opt = noudevsync_ARG;
commands[72].optional_opt_args[33].opt = permission_ARG;
commands[72].optional_opt_args[33].def.val_bits = val_enum_to_bit(permission_VAL);
commands[72].optional_opt_args[34].opt = persistent_ARG;
commands[72].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[35].opt = readahead_ARG;
commands[72].optional_opt_args[35].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[72].optional_opt_args[36].opt = reportformat_ARG;
commands[72].optional_opt_args[36].def.val_bits = val_enum_to_bit(string_VAL);
commands[72].optional_opt_args[37].opt = setactivationskip_ARG;
commands[72].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[38].opt = test_ARG;
commands[72].optional_opt_args[39].opt = wipesignatures_ARG;
commands[72].optional_opt_args[39].def.val_bits = val_enum_to_bit(bool_VAL);
commands[72].optional_opt_args[40].opt = zero_ARG;
...
commands[73].command_line_id = "lvcreate_convert_to_cache_vol_with_cachepool";
commands[73].command_line_enum = lvcreate_convert_to_cache_vol_with_cachepool_CMD;
commands[73].fn = lvcreate;
commands[73].ro_count = 2;
commands[73].rp_count = 1;
commands[73].oo_count = 38;
commands[73].op_count = 1;
commands[73].desc = "DESC: Convert the specified LV to type cache after creating a new  DESC: cache pool LV to use.";
commands[73].usage = "lvcreate --type cache --size Number[m|unit] LV"
" [ --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --chunksize Number[k|unit], --cachemode writethrough|writeback, --cachepolicy String, --cachesettings String, --addtag Tag, --alloc contiguous|cling|normal|anywhere|inherit, --autobackup y|n, --activate y|n|ay, --contiguous y|n, --ignoreactivationskip, --ignoremonitoring, --major Number, --metadataprofile String, --minor Number, --monitor y|n, --name String, --nosync, --permission rw|r, --persistent y|n, --readahead auto|none|NumberSectors, --reportformat String, --setactivationskip y|n, --wipesignatures y|n, --zero y|n ]"
" [ PV ... ]";
commands[73].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[73].required_opt_args[0].opt = type_ARG;
commands[73].required_opt_args[0].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[73].required_opt_args[0].def.str = "cache";
commands[73].required_opt_args[1].opt = size_ARG;
commands[73].required_opt_args[1].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[73].required_pos_args[0].pos = 1;
commands[73].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[73].optional_opt_args[10].opt = poolmetadatasize_ARG;
commands[73].optional_opt_args[10].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[73].optional_opt_args[11].opt = poolmetadataspare_ARG;
commands[73].optional_opt_args[11].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[12].opt = chunksize_ARG;
commands[73].optional_opt_args[12].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[73].optional_opt_args[13].opt = cachemode_ARG;
commands[73].optional_opt_args[13].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[73].optional_opt_args[14].opt = cachepolicy_ARG;
commands[73].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[15].opt = cachesettings_ARG;
commands[73].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[16].opt = addtag_ARG;
commands[73].optional_opt_args[16].def.val_bits = val_enum_to_bit(tag_VAL);
commands[73].optional_opt_args[17].opt = alloc_ARG;
commands[73].optional_opt_args[17].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[73].optional_opt_args[18].opt = autobackup_ARG;
commands[73].optional_opt_args[18].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[19].opt = activate_ARG;
commands[73].optional_opt_args[19].def.val_bits = val_enum_to_bit(activation_VAL);
commands[73].optional_opt_args[20].opt = contiguous_ARG;
commands[73].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[21].opt = ignoreactivationskip_ARG;
commands[73].optional_opt_args[22].opt = ignoremonitoring_ARG;
commands[73].optional_opt_args[23].opt = major_ARG;
commands[73].optional_opt_args[23].def.val_bits = val_enum_to_bit(number_VAL);
commands[73].optional_opt_args[24].opt = metadataprofile_ARG;
commands[73].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[25].opt = minor_ARG;
commands[73].optional_opt_args[25].def.val_bits = val_enum_to_bit(number_VAL);
commands[73].optional_opt_args[26].opt = monitor_ARG;
commands[73].optional_opt_args[26].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[27].opt = name_ARG;
commands[73].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[28].opt = nosync_ARG;
commands[73].optional_opt_args[29].opt = noudevsync_ARG;
commands[73].optional_opt_args[30].opt = permission_ARG;
commands[73].optional_opt_args[30].def.val_bits = val_enum_to_bit(permission_VAL);
commands[73].optional_opt_args[31].opt = persistent_ARG;
commands[73].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[32].opt = readahead_ARG;
commands[73].optional_opt_args[32].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[73].optional_opt_args[33].opt = reportformat_ARG;
commands[73].optional_opt_args[33].def.val_bits = val_enum_to_bit(string_VAL);
commands[73].optional_opt_args[34].opt = setactivationskip_ARG;
commands[73].optional_opt_args[34].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[35].opt = test_ARG;
commands[73].optional_opt_args[36].opt = wipesignatures_ARG;
commands[73].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[73].optional_opt_args[37].opt = zero_ARG;
commands[73].optional_opt_args[37].def.val_bits = val_enum_to_bit(bool_VAL);
...
commands[74].ro_count = 3;
commands[74].rp_count = 0;
commands[74].oo_count = 39;
commands[74].op_count = 1;
commands[74].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool in arg pos 1.";
commands[74].usage = "lvcreate --type cache --size Number[m|unit] --cachepool LV_cachepool"
...
commands[74].required_opt_args[2].opt = cachepool_ARG;
commands[74].required_opt_args[2].def.val_bits = val_enum_to_bit(lv_VAL);
commands[74].required_opt_args[2].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[74].optional_pos_args[0].pos = 1;
...
commands[75].command_line_id = "lvcreate_cache_vol_with_new_origin";
commands[75].command_line_enum = lvcreate_cache_vol_with_new_origin_CMD;
commands[75].fn = lvcreate;
commands[75].ro_count = 2;
commands[75].rp_count = 0;
commands[75].oo_count = 37;
commands[75].op_count = 1;
commands[75].desc = "DESC: Create a cache LV, first creating a new origin LV,  DESC: then combining it with the existing cache pool in arg pos 1.  DESC: (variant, infers --type cache).";
commands[75].usage = "lvcreate --size Number[m|unit] --cachepool LV_cachepool"
...
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[75].required_opt_args[0].opt = size_ARG;
commands[75].required_opt_args[0].def.val_bits = val_enum_to_bit(sizemb_VAL);
commands[75].required_opt_args[1].opt = cachepool_ARG;
commands[75].required_opt_args[1].def.val_bits = val_enum_to_bit(lv_VAL);
commands[75].required_opt_args[1].def.lv_types = ARG_DEF_LV_CACHEPOOL;
...
commands[75].optional_opt_args[10].opt = type_ARG;
commands[75].optional_opt_args[10].def.val_bits = val_enum_to_bit(conststr_VAL);
commands[75].optional_opt_args[10].def.str = "cache";
commands[75].optional_opt_args[11].opt = cache_ARG;
commands[75].optional_opt_args[12].opt = cachemode_ARG;
commands[75].optional_opt_args[12].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[75].optional_opt_args[13].opt = cachepolicy_ARG;
commands[75].optional_opt_args[13].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[14].opt = cachesettings_ARG;
commands[75].optional_opt_args[14].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[15].opt = addtag_ARG;
commands[75].optional_opt_args[15].def.val_bits = val_enum_to_bit(tag_VAL);
commands[75].optional_opt_args[16].opt = alloc_ARG;
commands[75].optional_opt_args[16].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[75].optional_opt_args[17].opt = autobackup_ARG;
commands[75].optional_opt_args[17].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[18].opt = activate_ARG;
commands[75].optional_opt_args[18].def.val_bits = val_enum_to_bit(activation_VAL);
commands[75].optional_opt_args[19].opt = contiguous_ARG;
commands[75].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[20].opt = ignoreactivationskip_ARG;
commands[75].optional_opt_args[21].opt = ignoremonitoring_ARG;
commands[75].optional_opt_args[22].opt = major_ARG;
commands[75].optional_opt_args[22].def.val_bits = val_enum_to_bit(number_VAL);
commands[75].optional_opt_args[23].opt = metadataprofile_ARG;
commands[75].optional_opt_args[23].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[24].opt = minor_ARG;
commands[75].optional_opt_args[24].def.val_bits = val_enum_to_bit(number_VAL);
commands[75].optional_opt_args[25].opt = monitor_ARG;
commands[75].optional_opt_args[25].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[26].opt = name_ARG;
commands[75].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[27].opt = nosync_ARG;
commands[75].optional_opt_args[28].opt = noudevsync_ARG;
commands[75].optional_opt_args[29].opt = permission_ARG;
commands[75].optional_opt_args[29].def.val_bits = val_enum_to_bit(permission_VAL);
commands[75].optional_opt_args[30].opt = persistent_ARG;
commands[75].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[31].opt = readahead_ARG;
commands[75].optional_opt_args[31].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[75].optional_opt_args[32].opt = reportformat_ARG;
commands[75].optional_opt_args[32].def.val_bits = val_enum_to_bit(string_VAL);
commands[75].optional_opt_args[33].opt = setactivationskip_ARG;
commands[75].optional_opt_args[33].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[34].opt = test_ARG;
commands[75].optional_opt_args[35].opt = wipesignatures_ARG;
commands[75].optional_opt_args[35].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_opt_args[36].opt = zero_ARG;
commands[75].optional_opt_args[36].def.val_bits = val_enum_to_bit(bool_VAL);
commands[75].optional_pos_args[0].pos = 1;
