...
commands[1].optional_opt_args[10].opt = addtag_ARG;
commands[1].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[1].optional_opt_args[11].opt = deltag_ARG;
commands[1].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[1].optional_opt_args[12].opt = alloc_ARG;
commands[1].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[1].optional_opt_args[13].opt = contiguous_ARG;
commands[1].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[1].optional_opt_args[14].opt = detachprofile_ARG;
commands[1].optional_opt_args[15].opt = metadataprofile_ARG;
commands[1].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[1].optional_opt_args[16].opt = profile_ARG;
commands[1].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[1].optional_opt_args[17].opt = permission_ARG;
commands[1].optional_opt_args[17].def.val_bits = val_enum_to_bit(permission_VAL);
commands[1].optional_opt_args[18].opt = readahead_ARG;
commands[1].optional_opt_args[18].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[1].optional_opt_args[19].opt = setactivationskip_ARG;
commands[1].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[1].optional_opt_args[20].opt = errorwhenfull_ARG;
commands[1].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[1].optional_opt_args[21].opt = discards_ARG;
commands[1].optional_opt_args[21].def.val_bits = val_enum_to_bit(discards_VAL);
commands[1].optional_opt_args[22].opt = zero_ARG;
commands[1].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[1].optional_opt_args[23].opt = cachemode_ARG;
commands[1].optional_opt_args[23].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[1].optional_opt_args[24].opt = cachepolicy_ARG;
commands[1].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[1].optional_opt_args[25].opt = cachesettings_ARG;
commands[1].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[1].optional_opt_args[26].opt = minrecoveryrate_ARG;
commands[1].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[1].optional_opt_args[27].opt = maxrecoveryrate_ARG;
commands[1].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[1].optional_opt_args[28].opt = writebehind_ARG;
commands[1].optional_opt_args[28].def.val_bits = val_enum_to_bit(number_VAL);
commands[1].optional_opt_args[29].opt = writemostly_ARG;
commands[1].optional_opt_args[29].def.val_bits = val_enum_to_bit(pv_VAL);
commands[1].optional_opt_args[30].opt = autobackup_ARG;
commands[1].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[1].optional_opt_args[31].opt = force_ARG;
commands[1].optional_opt_args[32].opt = ignorelockingfailure_ARG;
commands[1].optional_opt_args[33].opt = ignoremonitoring_ARG;
commands[1].optional_opt_args[34].opt = ignoreskippedcluster_ARG;
commands[1].optional_opt_args[35].opt = noudevsync_ARG;
commands[1].optional_opt_args[36].opt = reportformat_ARG;
commands[1].optional_opt_args[36].def.val_bits = val_enum_to_bit(string_VAL);
commands[1].optional_opt_args[37].opt = sysinit_ARG;
commands[1].optional_opt_args[38].opt = test_ARG;
commands[1].optional_opt_args[39].opt = select_ARG;
commands[1].optional_opt_args[39].def.val_bits = val_enum_to_bit(string_VAL);

commands[2].name = "lvchange";
commands[2].fn = lvchange;
commands[2].ro_count = 1;
commands[2].rp_count = 1;
commands[2].oo_count = 40;
...
commands[2].optional_opt_args[10].opt = addtag_ARG;
commands[2].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[2].optional_opt_args[11].opt = deltag_ARG;
commands[2].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[2].optional_opt_args[12].opt = alloc_ARG;
commands[2].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[2].optional_opt_args[13].opt = contiguous_ARG;
commands[2].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[2].optional_opt_args[14].opt = detachprofile_ARG;
commands[2].optional_opt_args[15].opt = metadataprofile_ARG;
commands[2].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[2].optional_opt_args[16].opt = profile_ARG;
commands[2].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[2].optional_opt_args[17].opt = permission_ARG;
commands[2].optional_opt_args[17].def.val_bits = val_enum_to_bit(permission_VAL);
commands[2].optional_opt_args[18].opt = readahead_ARG;
commands[2].optional_opt_args[18].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[2].optional_opt_args[19].opt = setactivationskip_ARG;
commands[2].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[2].optional_opt_args[20].opt = errorwhenfull_ARG;
commands[2].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[2].optional_opt_args[21].opt = discards_ARG;
commands[2].optional_opt_args[21].def.val_bits = val_enum_to_bit(discards_VAL);
commands[2].optional_opt_args[22].opt = zero_ARG;
commands[2].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[2].optional_opt_args[23].opt = cachemode_ARG;
commands[2].optional_opt_args[23].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[2].optional_opt_args[24].opt = cachepolicy_ARG;
commands[2].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[2].optional_opt_args[25].opt = cachesettings_ARG;
commands[2].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[2].optional_opt_args[26].opt = minrecoveryrate_ARG;
commands[2].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[2].optional_opt_args[27].opt = maxrecoveryrate_ARG;
commands[2].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[2].optional_opt_args[28].opt = writebehind_ARG;
commands[2].optional_opt_args[28].def.val_bits = val_enum_to_bit(number_VAL);
commands[2].optional_opt_args[29].opt = writemostly_ARG;
commands[2].optional_opt_args[29].def.val_bits = val_enum_to_bit(pv_VAL);
commands[2].optional_opt_args[30].opt = autobackup_ARG;
commands[2].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[2].optional_opt_args[31].opt = force_ARG;
commands[2].optional_opt_args[32].opt = ignorelockingfailure_ARG;
commands[2].optional_opt_args[33].opt = ignoremonitoring_ARG;
commands[2].optional_opt_args[34].opt = ignoreskippedcluster_ARG;
commands[2].optional_opt_args[35].opt = noudevsync_ARG;
commands[2].optional_opt_args[36].opt = reportformat_ARG;
commands[2].optional_opt_args[36].def.val_bits = val_enum_to_bit(string_VAL);
commands[2].optional_opt_args[37].opt = sysinit_ARG;
commands[2].optional_opt_args[38].opt = test_ARG;
commands[2].optional_opt_args[39].opt = select_ARG;
commands[2].optional_opt_args[39].def.val_bits = val_enum_to_bit(string_VAL);

commands[3].name = "lvchange";
commands[3].fn = lvchange;
commands[3].ro_count = 1;
commands[3].rp_count = 1;
commands[3].oo_count = 40;
...
commands[3].optional_opt_args[10].opt = addtag_ARG;
commands[3].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[3].optional_opt_args[11].opt = deltag_ARG;
commands[3].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[3].optional_opt_args[12].opt = alloc_ARG;
commands[3].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[3].optional_opt_args[13].opt = contiguous_ARG;
commands[3].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[3].optional_opt_args[14].opt = detachprofile_ARG;
commands[3].optional_opt_args[15].opt = metadataprofile_ARG;
commands[3].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[3].optional_opt_args[16].opt = profile_ARG;
commands[3].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[3].optional_opt_args[17].opt = permission_ARG;
commands[3].optional_opt_args[17].def.val_bits = val_enum_to_bit(permission_VAL);
commands[3].optional_opt_args[18].opt = readahead_ARG;
commands[3].optional_opt_args[18].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[3].optional_opt_args[19].opt = setactivationskip_ARG;
commands[3].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[3].optional_opt_args[20].opt = errorwhenfull_ARG;
commands[3].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[3].optional_opt_args[21].opt = discards_ARG;
commands[3].optional_opt_args[21].def.val_bits = val_enum_to_bit(discards_VAL);
commands[3].optional_opt_args[22].opt = zero_ARG;
commands[3].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[3].optional_opt_args[23].opt = cachemode_ARG;
commands[3].optional_opt_args[23].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[3].optional_opt_args[24].opt = cachepolicy_ARG;
commands[3].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[3].optional_opt_args[25].opt = cachesettings_ARG;
commands[3].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[3].optional_opt_args[26].opt = minrecoveryrate_ARG;
commands[3].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[3].optional_opt_args[27].opt = maxrecoveryrate_ARG;
commands[3].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[3].optional_opt_args[28].opt = writebehind_ARG;
commands[3].optional_opt_args[28].def.val_bits = val_enum_to_bit(number_VAL);
commands[3].optional_opt_args[29].opt = writemostly_ARG;
commands[3].optional_opt_args[29].def.val_bits = val_enum_to_bit(pv_VAL);
commands[3].optional_opt_args[30].opt = autobackup_ARG;
commands[3].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[3].optional_opt_args[31].opt = force_ARG;
commands[3].optional_opt_args[32].opt = ignorelockingfailure_ARG;
commands[3].optional_opt_args[33].opt = ignoremonitoring_ARG;
commands[3].optional_opt_args[34].opt = ignoreskippedcluster_ARG;
commands[3].optional_opt_args[35].opt = noudevsync_ARG;
commands[3].optional_opt_args[36].opt = reportformat_ARG;
commands[3].optional_opt_args[36].def.val_bits = val_enum_to_bit(string_VAL);
commands[3].optional_opt_args[37].opt = sysinit_ARG;
commands[3].optional_opt_args[38].opt = test_ARG;
commands[3].optional_opt_args[39].opt = select_ARG;
commands[3].optional_opt_args[39].def.val_bits = val_enum_to_bit(string_VAL);
...
commands[5].optional_opt_args[10].opt = addtag_ARG;
commands[5].optional_opt_args[10].def.val_bits = val_enum_to_bit(tag_VAL);
commands[5].optional_opt_args[11].opt = deltag_ARG;
commands[5].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[5].optional_opt_args[12].opt = alloc_ARG;
commands[5].optional_opt_args[12].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[5].optional_opt_args[13].opt = contiguous_ARG;
commands[5].optional_opt_args[13].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[14].opt = detachprofile_ARG;
commands[5].optional_opt_args[15].opt = metadataprofile_ARG;
commands[5].optional_opt_args[15].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[16].opt = profile_ARG;
commands[5].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[17].opt = permission_ARG;
commands[5].optional_opt_args[17].def.val_bits = val_enum_to_bit(permission_VAL);
commands[5].optional_opt_args[18].opt = readahead_ARG;
commands[5].optional_opt_args[18].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[5].optional_opt_args[19].opt = setactivationskip_ARG;
commands[5].optional_opt_args[19].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[20].opt = errorwhenfull_ARG;
commands[5].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[21].opt = discards_ARG;
commands[5].optional_opt_args[21].def.val_bits = val_enum_to_bit(discards_VAL);
commands[5].optional_opt_args[22].opt = zero_ARG;
commands[5].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[23].opt = cachemode_ARG;
commands[5].optional_opt_args[23].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[5].optional_opt_args[24].opt = cachepolicy_ARG;
commands[5].optional_opt_args[24].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[25].opt = cachesettings_ARG;
commands[5].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[26].opt = minrecoveryrate_ARG;
commands[5].optional_opt_args[26].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[5].optional_opt_args[27].opt = maxrecoveryrate_ARG;
commands[5].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[5].optional_opt_args[28].opt = writebehind_ARG;
commands[5].optional_opt_args[28].def.val_bits = val_enum_to_bit(number_VAL);
commands[5].optional_opt_args[29].opt = writemostly_ARG;
commands[5].optional_opt_args[29].def.val_bits = val_enum_to_bit(pv_VAL);
commands[5].optional_opt_args[30].opt = autobackup_ARG;
commands[5].optional_opt_args[30].def.val_bits = val_enum_to_bit(bool_VAL);
commands[5].optional_opt_args[31].opt = force_ARG;
commands[5].optional_opt_args[32].opt = ignorelockingfailure_ARG;
commands[5].optional_opt_args[33].opt = ignoremonitoring_ARG;
commands[5].optional_opt_args[34].opt = ignoreskippedcluster_ARG;
commands[5].optional_opt_args[35].opt = noudevsync_ARG;
commands[5].optional_opt_args[36].opt = reportformat_ARG;
commands[5].optional_opt_args[36].def.val_bits = val_enum_to_bit(string_VAL);
commands[5].optional_opt_args[37].opt = sysinit_ARG;
commands[5].optional_opt_args[38].opt = test_ARG;
commands[5].optional_opt_args[39].opt = select_ARG;
commands[5].optional_opt_args[39].def.val_bits = val_enum_to_bit(string_VAL);

commands[6].name = "lvchange";
commands[6].fn = lvchange;
commands[6].ro_count = 1;
commands[6].rp_count = 1;
commands[6].oo_count = 41;
...
commands[6].optional_opt_args[11].opt = addtag_ARG;
commands[6].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[6].optional_opt_args[12].opt = deltag_ARG;
commands[6].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[6].optional_opt_args[13].opt = alloc_ARG;
commands[6].optional_opt_args[13].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[6].optional_opt_args[14].opt = contiguous_ARG;
commands[6].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[6].optional_opt_args[15].opt = detachprofile_ARG;
commands[6].optional_opt_args[16].opt = metadataprofile_ARG;
commands[6].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[6].optional_opt_args[17].opt = profile_ARG;
commands[6].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);
commands[6].optional_opt_args[18].opt = permission_ARG;
commands[6].optional_opt_args[18].def.val_bits = val_enum_to_bit(permission_VAL);
commands[6].optional_opt_args[19].opt = readahead_ARG;
commands[6].optional_opt_args[19].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[6].optional_opt_args[20].opt = setactivationskip_ARG;
commands[6].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[6].optional_opt_args[21].opt = errorwhenfull_ARG;
commands[6].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[6].optional_opt_args[22].opt = discards_ARG;
commands[6].optional_opt_args[22].def.val_bits = val_enum_to_bit(discards_VAL);
commands[6].optional_opt_args[23].opt = zero_ARG;
commands[6].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[6].optional_opt_args[24].opt = cachemode_ARG;
commands[6].optional_opt_args[24].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[6].optional_opt_args[25].opt = cachepolicy_ARG;
commands[6].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[6].optional_opt_args[26].opt = cachesettings_ARG;
commands[6].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[6].optional_opt_args[27].opt = minrecoveryrate_ARG;
commands[6].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[6].optional_opt_args[28].opt = maxrecoveryrate_ARG;
commands[6].optional_opt_args[28].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[6].optional_opt_args[29].opt = writebehind_ARG;
commands[6].optional_opt_args[29].def.val_bits = val_enum_to_bit(number_VAL);
commands[6].optional_opt_args[30].opt = writemostly_ARG;
commands[6].optional_opt_args[30].def.val_bits = val_enum_to_bit(pv_VAL);
commands[6].optional_opt_args[31].opt = autobackup_ARG;
commands[6].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[6].optional_opt_args[32].opt = force_ARG;
commands[6].optional_opt_args[33].opt = ignorelockingfailure_ARG;
commands[6].optional_opt_args[34].opt = ignoremonitoring_ARG;
commands[6].optional_opt_args[35].opt = ignoreskippedcluster_ARG;
commands[6].optional_opt_args[36].opt = noudevsync_ARG;
commands[6].optional_opt_args[37].opt = reportformat_ARG;
commands[6].optional_opt_args[37].def.val_bits = val_enum_to_bit(string_VAL);
commands[6].optional_opt_args[38].opt = sysinit_ARG;
commands[6].optional_opt_args[39].opt = test_ARG;
commands[6].optional_opt_args[40].opt = select_ARG;
commands[6].optional_opt_args[40].def.val_bits = val_enum_to_bit(string_VAL);

commands[7].name = "lvchange";
commands[7].fn = lvchange;
commands[7].ro_count = 1;
commands[7].rp_count = 1;
commands[7].oo_count = 41;
...
commands[7].optional_opt_args[11].opt = addtag_ARG;
commands[7].optional_opt_args[11].def.val_bits = val_enum_to_bit(tag_VAL);
commands[7].optional_opt_args[12].opt = deltag_ARG;
commands[7].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[7].optional_opt_args[13].opt = alloc_ARG;
commands[7].optional_opt_args[13].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[7].optional_opt_args[14].opt = contiguous_ARG;
commands[7].optional_opt_args[14].def.val_bits = val_enum_to_bit(bool_VAL);
commands[7].optional_opt_args[15].opt = detachprofile_ARG;
commands[7].optional_opt_args[16].opt = metadataprofile_ARG;
commands[7].optional_opt_args[16].def.val_bits = val_enum_to_bit(string_VAL);
commands[7].optional_opt_args[17].opt = profile_ARG;
commands[7].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);
commands[7].optional_opt_args[18].opt = permission_ARG;
commands[7].optional_opt_args[18].def.val_bits = val_enum_to_bit(permission_VAL);
commands[7].optional_opt_args[19].opt = readahead_ARG;
commands[7].optional_opt_args[19].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[7].optional_opt_args[20].opt = setactivationskip_ARG;
commands[7].optional_opt_args[20].def.val_bits = val_enum_to_bit(bool_VAL);
commands[7].optional_opt_args[21].opt = errorwhenfull_ARG;
commands[7].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[7].optional_opt_args[22].opt = discards_ARG;
commands[7].optional_opt_args[22].def.val_bits = val_enum_to_bit(discards_VAL);
commands[7].optional_opt_args[23].opt = zero_ARG;
commands[7].optional_opt_args[23].def.val_bits = val_enum_to_bit(bool_VAL);
commands[7].optional_opt_args[24].opt = cachemode_ARG;
commands[7].optional_opt_args[24].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[7].optional_opt_args[25].opt = cachepolicy_ARG;
commands[7].optional_opt_args[25].def.val_bits = val_enum_to_bit(string_VAL);
commands[7].optional_opt_args[26].opt = cachesettings_ARG;
commands[7].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[7].optional_opt_args[27].opt = minrecoveryrate_ARG;
commands[7].optional_opt_args[27].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[7].optional_opt_args[28].opt = maxrecoveryrate_ARG;
commands[7].optional_opt_args[28].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[7].optional_opt_args[29].opt = writebehind_ARG;
commands[7].optional_opt_args[29].def.val_bits = val_enum_to_bit(number_VAL);
commands[7].optional_opt_args[30].opt = writemostly_ARG;
commands[7].optional_opt_args[30].def.val_bits = val_enum_to_bit(pv_VAL);
commands[7].optional_opt_args[31].opt = autobackup_ARG;
commands[7].optional_opt_args[31].def.val_bits = val_enum_to_bit(bool_VAL);
commands[7].optional_opt_args[32].opt = force_ARG;
commands[7].optional_opt_args[33].opt = ignorelockingfailure_ARG;
commands[7].optional_opt_args[34].opt = ignoremonitoring_ARG;
commands[7].optional_opt_args[35].opt = ignoreskippedcluster_ARG;
commands[7].optional_opt_args[36].opt = noudevsync_ARG;
commands[7].optional_opt_args[37].opt = reportformat_ARG;
commands[7].optional_opt_args[37].def.val_bits = val_enum_to_bit(string_VAL);
commands[7].optional_opt_args[38].opt = sysinit_ARG;
commands[7].optional_opt_args[39].opt = test_ARG;
commands[7].optional_opt_args[40].opt = select_ARG;
commands[7].optional_opt_args[40].def.val_bits = val_enum_to_bit(string_VAL);

commands[8].name = "lvchange";
commands[8].fn = lvchange;
commands[8].ro_count = 1;
commands[8].rp_count = 1;
commands[8].oo_count = 42;
...
commands[8].optional_opt_args[12].opt = addtag_ARG;
commands[8].optional_opt_args[12].def.val_bits = val_enum_to_bit(tag_VAL);
commands[8].optional_opt_args[13].opt = deltag_ARG;
commands[8].optional_opt_args[13].def.val_bits = val_enum_to_bit(tag_VAL);
commands[8].optional_opt_args[14].opt = alloc_ARG;
commands[8].optional_opt_args[14].def.val_bits = val_enum_to_bit(alloc_VAL);
commands[8].optional_opt_args[15].opt = contiguous_ARG;
commands[8].optional_opt_args[15].def.val_bits = val_enum_to_bit(bool_VAL);
commands[8].optional_opt_args[16].opt = detachprofile_ARG;
commands[8].optional_opt_args[17].opt = metadataprofile_ARG;
commands[8].optional_opt_args[17].def.val_bits = val_enum_to_bit(string_VAL);
commands[8].optional_opt_args[18].opt = profile_ARG;
commands[8].optional_opt_args[18].def.val_bits = val_enum_to_bit(string_VAL);
commands[8].optional_opt_args[19].opt = permission_ARG;
commands[8].optional_opt_args[19].def.val_bits = val_enum_to_bit(permission_VAL);
commands[8].optional_opt_args[20].opt = readahead_ARG;
commands[8].optional_opt_args[20].def.val_bits = val_enum_to_bit(readahead_VAL);
commands[8].optional_opt_args[21].opt = setactivationskip_ARG;
commands[8].optional_opt_args[21].def.val_bits = val_enum_to_bit(bool_VAL);
commands[8].optional_opt_args[22].opt = errorwhenfull_ARG;
commands[8].optional_opt_args[22].def.val_bits = val_enum_to_bit(bool_VAL);
commands[8].optional_opt_args[23].opt = discards_ARG;
commands[8].optional_opt_args[23].def.val_bits = val_enum_to_bit(discards_VAL);
commands[8].optional_opt_args[24].opt = zero_ARG;
commands[8].optional_opt_args[24].def.val_bits = val_enum_to_bit(bool_VAL);
commands[8].optional_opt_args[25].opt = cachemode_ARG;
commands[8].optional_opt_args[25].def.val_bits = val_enum_to_bit(cachemode_VAL);
commands[8].optional_opt_args[26].opt = cachepolicy_ARG;
commands[8].optional_opt_args[26].def.val_bits = val_enum_to_bit(string_VAL);
commands[8].optional_opt_args[27].opt = cachesettings_ARG;
commands[8].optional_opt_args[27].def.val_bits = val_enum_to_bit(string_VAL);
commands[8].optional_opt_args[28].opt = minrecoveryrate_ARG;
commands[8].optional_opt_args[28].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[8].optional_opt_args[29].opt = maxrecoveryrate_ARG;
commands[8].optional_opt_args[29].def.val_bits = val_enum_to_bit(sizekb_VAL);
commands[8].optional_opt_args[30].opt = writebehind_ARG;
commands[8].optional_opt_args[30].def.val_bits = val_enum_to_bit(number_VAL);
commands[8].optional_opt_args[31].opt = writemostly_ARG;
commands[8].optional_opt_args[31].def.val_bits = val_enum_to_bit(pv_VAL);
commands[8].optional_opt_args[32].opt = autobackup_ARG;
commands[8].optional_opt_args[32].def.val_bits = val_enum_to_bit(bool_VAL);
commands[8].optional_opt_args[33].opt = force_ARG;
commands[8].optional_opt_args[34].opt = ignorelockingfailure_ARG;
commands[8].optional_opt_args[35].opt = ignoremonitoring_ARG;
commands[8].optional_opt_args[36].opt = ignoreskippedcluster_ARG;
commands[8].optional_opt_args[37].opt = noudevsync_ARG;
commands[8].optional_opt_args[38].opt = reportformat_ARG;
commands[8].optional_opt_args[38].def.val_bits = val_enum_to_bit(string_VAL);
commands[8].optional_opt_args[39].opt = sysinit_ARG;
commands[8].optional_opt_args[40].opt = test_ARG;
commands[8].optional_opt_args[41].opt = select_ARG;
commands[8].optional_opt_args[41].def.val_bits = val_enum_to_bit(string_VAL);
...
" [ --thin, --originname LV_new, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --background, --usepolicies ]";
...
" [ --cache, --cachepolicy String, --cachesettings String, --poolmetadata LV, --poolmetadatasize Number[m|unit], --poolmetadataspare y|n, --readahead auto|none|NumberSectors, --chunksize Number[k|unit], --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --background, --usepolicies ]";
...
" [ --type raid1, --type mirror, --mirrors [+|-]Number, --stripes Number, --stripesize Number[k|unit], --regionsize Number[m|unit], --alloc contiguous|cling|cling_by_tags|normal|anywhere|inherit, --background, --usepolicies ]"
" [ PV ... ]";
...
commands[28].desc = "DESC: Split images from a raid1 LV and use them to create a new LV.";
...
commands[40].desc = "DESC: Create a linear LV, --name is usually specified (default --type linear).";
...
commands[64].desc = "DESC: Create a thin LV, first creating a thin pool for it (infers --type thin).  DESC: Create a sparse snapshot of a virtual origin LV (infers --type snapshot).  DESC: Infers --type thin or --type snapshot according to sparse_segtype_default.";
...
commands[67].desc = "DESC: Create a new origin LV, combining it with an existing  DESC: cache pool to create a new cache LV (infers --type cache).";
...
commands[91].name = "lvpoll";
commands[91].fn = lvpoll;
commands[91].ro_count = 1;
commands[91].rp_count = 1;
commands[91].oo_count = 15;
commands[91].op_count = 0;
commands[91].desc = "";
commands[91].usage = "lvpoll --polloperation String LV ..."
" [ --abort, --autobackup y|n, --handlemissingpvs, --interval Number ]";
commands[91].usage_common = 
" [ --commandprofile String, --config String, --debug, --driverloaded y|n, --help, --profile String, --quiet, --verbose, --version, --yes, --force, --test, --noudevsync ]";
commands[91].required_opt_args[0].opt = polloperation_ARG;
commands[91].required_opt_args[0].def.val_bits = val_enum_to_bit(string_VAL);
commands[91].required_pos_args[0].pos = 1;
commands[91].required_pos_args[0].def.val_bits = val_enum_to_bit(lv_VAL);
...
commands[91].optional_opt_args[12].opt = handlemissingpvs_ARG;
commands[91].optional_opt_args[13].opt = interval_ARG;
commands[91].optional_opt_args[13].def.val_bits = val_enum_to_bit(number_VAL);
