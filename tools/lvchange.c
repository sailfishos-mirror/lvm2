...
int lvchange_properties_cmd(struct cmd_context *cmd, int argc, char **argv)
{
	...
	return process_each_lv(cmd, argc, argv, NULL, NULL, READ_FOR_UPDATE,
			       NULL, NULL, _lvchange_properties_single);
}
...
int lvchange_activate_cmd(struct cmd_context *cmd, int argc, char **argv)
{
	...
	return process_each_lv(cmd, argc, argv, NULL, NULL, 0,
			       NULL, NULL, _lvchange_activate_single);
}
...
int lvchange_refresh_cmd(struct cmd_context *cmd, int argc, char **argv)
{
	...
	return process_each_lv(cmd, argc, argv, NULL, NULL, 0,
			       NULL, NULL, _lvchange_refresh_single);
}
...
{
	return process_each_lv(cmd, argc, argv, NULL, NULL, READ_FOR_UPDATE,
			       NULL, NULL, _lvchange_resync_single);
}
...
{
	return process_each_lv(cmd, argc, argv, NULL, NULL, READ_FOR_UPDATE,
			       NULL, NULL, _lvchange_syncaction_single);
}
...
{
	return process_each_lv(cmd, argc, argv, NULL, NULL, READ_FOR_UPDATE,
			       NULL, NULL, _lvchange_rebuild_single);
}
...
int lvchange_monitor_poll_cmd(struct cmd_context *cmd, int argc, char **argv)
{
	cmd->handles_missing_pvs = 1;
	return process_each_lv(cmd, argc, argv, NULL, NULL, 0,
			       NULL, NULL, _lvchange_monitor_poll_single);
}
...
int lvchange_persistent_cmd(struct cmd_context *cmd, int argc, char **argv)
{
	cmd->handles_missing_pvs = 1;
	return process_each_lv(cmd, argc, argv, NULL, NULL, READ_FOR_UPDATE,
			       NULL, NULL, _lvchange_persistent_single);
}
