...
static int do_kill(void)
{
	...
	/*
	 * If kill command completes successfully, call do_drop() afterward.
	 * (The drop step may not always be necessary if the lvm commands run
	 * while shutting things down release all the leases.)
	 */
