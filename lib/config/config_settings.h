...
cfg(local_pr_key_CFG, "pr_key", local_CFG_SECTION, CFG_DEFAULT_COMMENTED, CFG_TYPE_STRING, 0, vsn(2, 3, 32), NULL, 0, NULL,
	"The local persistent reservation key.\n"
	"The value must be unique among all hosts using the same VG.\n"
	"The max length is 16 hex characters (8 bytes).\n"
	"The value can be entered as \"0xABCD1234\" or \"ABCD1234\".\n"
	"If pr_key is not set, host_id will be used to create a key.\n")
