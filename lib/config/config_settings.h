...
cfg(activation_use_async_ioctl_CFG, "use_async_ioctl", activation_CFG_SECTION, CFG_DEFAULT_COMMENTED, CFG_TYPE_BOOL, DEFAULT_USE_ASYNC_IOCTL, vsn(2, 3, 40), NULL, 0, NULL,
	"Use async DM ioctls for bulk operations.\n"
	"When enabled, eligible LVs are deactivated asynchronously using\n"
