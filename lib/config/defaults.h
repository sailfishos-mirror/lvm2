...
#define DEFAULT_LVMLOCKD_LOCK_RETRIES 6
...
#define DEFAULT_CACHE_POLICY "smq"
...
/* VDO defaults */
#define DEFAULT_VDO_USE_COMPRESSION	1
#define DEFAULT_VDO_USE_DEDUPLICATION	1
#define DEFAULT_VDO_USE_METADATA_HINTS	1
...
#define DEFAULT_CONFIG_FILE_BACKUP_LIMIT 50
