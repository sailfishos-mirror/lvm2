...
/*
 * check: check our key and reservation on all devices
 ...
 *
 * check_all: check that all keys and reservations match on all devices
 * success if all devs have the same keys and reservations.
 *
